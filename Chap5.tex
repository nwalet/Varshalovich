...
(a) The solution of the Laplace equation
...
(b) The solutions of the Helmholtz wave equation
...
5.2.4. $Y_{\text {im }}(\vartheta, \varphi)$ and the Hypergeometric Functions with Arguments Expressed in Terms of Trigonometric Functions of $\vartheta / 2$
...
5.2.5. $Y_{l m}(\vartheta, \varphi)$ and the Hypergeometric Functions with Arguments Expressed in Terms of Trigonometric Functions of $\vartheta$
...
5.2.6. $Y_{l m}(\vartheta, \varphi)$ and the Hypergeometric Functions with Arguments Expressed in Terms of Exponential Functions
...
(a) The relation between $Y_{l m}(\vartheta, \varphi)$ and the Wigner D-function (Chap. 4) is given by
...
(b) $Y_{l m}(\vartheta, \varphi)$ can be related to the Jacobi polynomials $P_{n}^{(\alpha, \beta)}(x)$,
...
(c) $Y_{l m}(\vartheta, \varphi)$ can be expressed in terms of Gegenbauer polynomials $C_{\nu}^{\lambda}(x)$,
...
5.3.1. $Y_{l m}(\vartheta, \varphi)$ in the Form of Indefinite Integrals\\
(a)
...
(b) The Mehler-Dirichlet formulas
...
(c) $\left|Y_{I m}(\vartheta, \varphi)\right|^{2}$ may be represented as
...
(c) "Mirror" symmetry (replacement $l$ by $l=-l-1$ ):
...
(d) Replacement $\vartheta \rightarrow \pi-\vartheta$ and $\varphi=\pi+\varphi$ :
...
(a) Rotation about the coordinate axes through the angle $\pi$
...
(b) Rotation about the $z$ axis through an arbitrary angle $\chi$
...
(c) Rotation about an arbitrary direction $\mathbf{n}(\boldsymbol{\Theta}, \Phi)$ through a small angle $\omega(\omega \ll \pi / 2)$
...
(d) Reflection of the coordinate system with respect to the equatorial plane, $\vartheta=\pi / 2$
...
(e) Reflection of the coordinate system with respect to a meridian plane, $\varphi=\varphi_{0}$ and $\varphi=\pi+\varphi_{0}$
...
5.8.1. Action of the Operator of Orbital Angular Momentum on $Y_{\text {Im }}(\vartheta, \varphi)$ Spherical components of the operator $\overline{\mathbf{L}}$ (Eq. $2.2(18)$ ) act on $\mathbf{Y}_{\text {Im }}(\mathcal{\vartheta}, \varphi)$ according to
...
5.9.2 Fourier Transformations for Some Functions Which Contain $Y_{\text {Im }}(\vartheta, \varphi)$
...
5.10.1. Sums over $m$ (with fixed $l$ )
...
5.14. $Y_{l m}(\vartheta, \varphi)$ AND $\frac{\partial}{\partial \vartheta} Y_{l m}(\vartheta, \varphi)$ FOR SPECIAL $\vartheta$\\
(a)
