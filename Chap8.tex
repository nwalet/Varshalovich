...
\end{equation}
(Regge [94], Shelepin [106]). Here $R_{i k}$ are the elements of the $R$-symbol (see Sec. 8.1.3). The $R$-symbols and the Clebsch-Gordan coefficients are related by Eqs.~\eqref{eq:8:1:14} and \eqref{eq:8:1:11}.
