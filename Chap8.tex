...
\section{Generating functions of the Clebsch-Gordan coeeficients}\label{sec:8.8}\index{Clebsch-Gordan coefficient!generating functions}\index{generating functions!for the Clebsch-Gordan coefficients}
