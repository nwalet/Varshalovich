...
The Clebsch-Gordan coefficients can be presented in the form of quasi-binomials $(u \pm v)^{(k)}\cite{ref048}^{2}$
\begin{equation}
...
\end{equation}
Equations (24)-(31) were obtained by Stone \cite{ref107}.
...
Equation (1) may be rewritten by the use of quasi-powers in the form \cite{ref045}
\begin{align}
...
\]
The algebraic tables of the Clebsch-Gordan coefficients are also available in Ref. \cite{ref010} for $b=1 / 2,1,3 / 2,2$; in Ref. $[121,125]$ for $b=5 / 2$; in Refs. $[117,130]$ with $b=3$; and in Ref. $\cite{ref126}$ with $b=7 / 2,4,9 / 2,5$.
...
\]
Numerical values of the Clebsch-Gordan coefficients are also given in Refs. [126, 127]. Reference \cite{ref127} presents the Clebsch-Gordan coefficients for $\frac{1}{2} \leq a \leq 4, \frac{1}{2} \leq b, c \leq 9 / 2$ in decimals. Reference \cite{ref126} gives the Clebsch-Gordan coefficients for $\frac{1}{2} \leq b \leq 6, a=5,11 / 2,6$ in the form of rational fractions. Numerical values of the $3 j m$ symbols are also available in Ref. \cite{ref113}.
