...
\subsection*{4.1. DEFINITION OF $D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)$}
...
\begin{equation*}
\langle J M| \hat{D}(\alpha, \beta, \gamma)\left|J^{\prime} M^{\prime}\right\rangle=\delta_{J J^{\prime}} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma) \tag{1}
\end{equation*}
...
& \Psi_{J M^{\prime}}^{*}\left(\vartheta^{\prime}, \varphi^{\prime}, \sigma^{\prime}\right)=\sum_{M=-J}^{J} \Psi_{J M}^{*}(\vartheta, \varphi, \sigma) D_{M M^{\prime}}^{J *}(\alpha, \beta, \gamma) . \tag{2}
\end{align*}
...
\begin{equation*}
\widehat{D}^{-1}(\alpha, \beta, \gamma)=\widehat{D}^{+}(\alpha, \beta, \gamma) \tag{3}
\end{equation*}
...
\begin{equation*}
\left|\hat{D}^{-1}(\alpha, \beta, \gamma)\right|_{M M^{\prime}}^{J}=D_{M^{\prime} M}^{J *}(\alpha, \beta, \gamma) . \tag{4}
\end{equation*}
...
& \Psi_{J M}^{*}(\vartheta, \varphi, \sigma)=\sum_{M^{\prime}=-J}^{J} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma) \Psi_{J M^{\prime}}^{*}\left(\vartheta^{\prime}, \varphi^{\prime}, \sigma^{\prime}\right) . \tag{5}
\end{align*}
...
\caption{Table 4.1. Effect of the Operator $\hat{D}(\alpha, \beta, \gamma)$}
...
& \sum_{M^{\prime}=-J}^{J} D_{M M^{\prime}}^{J^{*}}(\alpha, \beta, \gamma) D_{\tilde{M}^{\prime}}^{J}(\alpha, \beta, \gamma)=\delta_{M \tilde{M}} . \tag{6}
\end{align*}
...
\begin{equation*}
\operatorname{det}\left\|D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)\right\|=+1 . \tag{7}
\end{equation*}
...
\begin{equation*}
\Psi_{J}(\vartheta, \varphi)=\sum_{M=-J}^{J} C_{J}^{M} \Psi_{J M}(\vartheta, \varphi)=\left(\mathbf{C}_{J} \cdot \Psi_{J}\right) . \tag{8}
\end{equation*}
...
\begin{equation*}
\{\widehat{D}(\alpha, \beta, \gamma)\}_{\text {phys. body }} \cdot\{\widehat{D}(\alpha, \beta, \gamma)\}_{\text {coord. system }}=1 \tag{10}
\end{equation*}
...
\begin{equation*}
\left\{\widehat{D}_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)\right\}_{\text {phys. body }}=\left\{\left[\widehat{D}^{-1}(\alpha, \beta, \gamma)\right]_{M M^{\prime}}^{J}\right\}_{\text {coord. system }} \tag{11}
\end{equation*}
...
Thus, any transformation of wave functions described by Eq. (2) can be treated in four different ways (Table 4.1).

The Wigner $D$-functions are complex. They depend on three real arguments $\alpha, \beta, \gamma$ and are defined in the domain


\begin{equation*}
0 \leq a<2 \pi, \quad 0 \leq \beta \leq \pi, \quad 0 \leq \gamma<2 \pi \tag{12}
\end{equation*}


These functions, as well as their derivatives, are single-valued, finite and continuous. Sometimes it is convenient to change the domain (12). This can be done using the symmetries of $D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)$ (Sec. 4.4). For example, the matrix of the inverse rotation satisfies the equation


\begin{equation*}
\left[\left.D^{-1}(\alpha, \beta, \gamma)\right|_{M M^{\prime}} ^{J}=D_{M M^{\prime}}^{J}(\pi-\gamma, \beta,-\pi-\alpha)=D_{M M^{\prime}}^{J}(-\gamma,-\beta,-\alpha) .\right. \tag{13}
\end{equation*}
...
\begin{equation*}
\alpha^{\prime}=\pi-\gamma, \quad \beta^{\prime}=\beta, \quad \gamma^{\prime}=-\pi-\alpha \tag{14}
\end{equation*}
...
\begin{equation*}
\alpha^{\prime}=-\gamma, \quad \beta^{\prime}=-\beta, \quad \gamma^{\prime}=-\alpha \tag{15}
\end{equation*}


\subsection*{4.2 DIFFERENTIAL EQUATIONS FOR $D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)$}
(a) The Wigner $D$-functions represent wave functions of a rigid symmetric top. They are eigenfunctions of three operators


\begin{equation*}
\hat{J}_{z}=-i \frac{\partial}{\partial \alpha}, \quad \hat{J}_{z^{\prime}}=-i \frac{\partial}{\partial \gamma}, \quad \hat{J}^{2}=-\left[\frac{\partial^{2}}{\partial \beta^{2}}+\cot \beta \frac{\dot{\partial}}{\partial \beta}+\frac{1}{\sin ^{2} \beta}\left(\frac{\partial^{2}}{\partial \alpha^{2}}-2 \cos \beta \frac{\partial^{2}}{\partial \alpha \partial \gamma}+\frac{\partial^{2}}{\partial \gamma^{2}}\right)\right] \tag{1}
\end{equation*}


where $\widehat{J}$ is the operator of angular momentum of the top; $\widehat{J}_{z^{\prime}}$ and $\widehat{J}_{z}$ are projections of $\widehat{J}$ onto the $z$-axis of the rotating (body-fixed) and non-rotating (lab-fixed) coordinate systems, respectively. The eigenvalues of the operators (1) are defined by the equations
...
\widehat{J}^{2} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma) & =\left\{-\frac{1}{\sin \beta} \cdot \frac{\partial}{\partial \beta}\left(\sin \beta \frac{\partial}{\partial \beta}\right)+\frac{M^{2}-2 M M^{\prime} \cos \beta+M^{\prime 2}}{\sin ^{2} \beta}\right\} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)  \tag{2}\\
...
& D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma \pm 2 k \pi)=D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)  \tag{3}\\
...
\pm \sqrt{\frac{J(J+1)-M^{\prime}\left(M^{\prime} \pm 1\right)}{2}} D_{M M^{\prime} \pm 1}^{J}(\alpha, \beta, \gamma), & \nu= \pm 1\end{cases} \tag{5}
\end{gather*}


Here $\widehat{J_{\nu}}$ is a covariant spherical component of $\widehat{\mathbf{J}}$ in the non-rotating (lab-fixed) system


\begin{gather*}
\hat{J}_{ \pm 1}=\frac{i}{\sqrt{2}} e^{ \pm i \alpha}\left[\mp \cot \beta \frac{\partial}{\partial \alpha}+i \frac{\partial}{\partial \beta} \pm \frac{1}{\sin \beta} \cdot \frac{\partial}{\partial \gamma}\right]  \tag{6}\\
\hat{J}_{0}=-i \frac{\partial}{\partial \alpha}
\end{gather*}


and $\widehat{J}^{\nu}$ is a contravariant component of $\widehat{\mathbf{J}}$ in the rotating (body-fixed) system


\begin{gather*}
\widehat{J}^{ \pm 1}=\frac{i}{\sqrt{2}} e^{\mp i \gamma}\left[ \pm \cot \beta \frac{\partial}{\partial \gamma}+i \frac{\partial}{\partial \beta} \mp \frac{1}{\sin \beta} \cdot \frac{\partial}{\partial \alpha}\right]  \tag{7}\\
\hat{J}^{0}=-i \frac{\partial}{\partial \gamma}
\end{gather*}


The operator $\widehat{\mathbf{J}}^{2}$ can be expressed in terms of $\widehat{J}_{\nu}$ or $\widehat{J}^{\nu}$ as


\begin{align*}
\hat{\mathbf{J}}^{2} & =-\hat{J}_{-1} \hat{J}_{+1}+\hat{J}_{0} \hat{J}_{0}-\hat{J}_{+1} \hat{J}_{-1}=-\hat{J}^{-1} \hat{J}^{+1}+\hat{J}^{0} \hat{J}^{0}-\hat{J}^{+1} \hat{J}^{-1}=\hat{J}_{0}\left(\hat{J}_{0}+1\right)-2 \hat{J}_{-1} \hat{J}_{+1} \\
& =\hat{J}^{0}\left(\hat{J}^{0}-1\right)-2 \hat{J}^{-1} \hat{J}^{+1}=\hat{J}_{0}\left(\hat{J}_{0}-1\right)-2 \hat{J}_{+1} \hat{J}_{-1}=\hat{J}^{0}\left(\hat{J}^{0}+1\right)-2 \hat{J}^{+1} \hat{J}^{-1} \tag{8}
\end{align*}
...
\hat{J}_{\nu}(\alpha, \beta, \gamma) & =\sum_{\mu} D_{\nu \mu}^{1 *}(\alpha, \beta, \gamma) \hat{J}^{\mu}(\alpha, \beta, \gamma) \tag{9}
\end{align*}
...
& {\left[\hat{J}_{i}, \hat{J}_{k}\right]=i \varepsilon_{i k l}, \hat{J}_{l},}  \tag{12}\\
& {\left[\hat{J}_{i}, \hat{J}_{k}\right]=0,}
\end{align*}


The operator of orbital angular momentum $\hat{\mathbf{L}}(\vartheta, \varphi)$ (Sec. 2.2) may be regarded as a special case of $\hat{\mathbf{J}}(\alpha, \beta, \gamma)$, viz. at $\alpha=\varphi, \beta=\vartheta, \gamma=0$


\begin{align*}
\hat{J}_{\nu}(\varphi, \vartheta, 0) & =\hat{L}_{\nu}(\vartheta, \varphi), & \nu & =-1,0,1 \\
\hat{J}_{i}(\varphi, \vartheta, 0) & =\hat{L}_{i}(\vartheta, \varphi), & i & =x, y, z \tag{13}
\end{align*}
...
\hat{J}_{i}(0, \vartheta, \varphi) & =\hat{L}_{i}^{\prime}(\vartheta, \varphi), & & i=x, y, z \tag{14}
\end{align*}
...
\begin{equation*}
D_{M M^{\prime}}^{J}(0,0,0)=\delta_{M M^{\prime}} \tag{15}
\end{equation*}


As for non-diagonal elements, they are determined by Eqs. (4) and (5) which relate the $D_{M M}^{J}$, of different $M$ and $M^{\prime}$. This phase convention corresponds to the condition


\begin{equation*}
D_{M M^{\prime}}^{J}(0, \pi, 0)=(-1)^{J+M} \delta_{M,-M^{\prime}}=(-1)^{J-M^{\prime}} \delta_{-M, M^{\prime}} \tag{16}
\end{equation*}


\subsection*{4.3. EXPLICIT FORMS OF THE WIGNER D-FUNCTIONS}
...
\begin{equation*}
D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)=e^{-i M \alpha} d_{M M^{\prime}}^{J}(\beta) e^{-i M^{\prime} \gamma} \tag{1}
\end{equation*}


where $d_{M M^{\prime}}^{J}(\beta)$ is a real function whose explicit forms are given below.

\subsection*{4.3.1. Expressions for $d_{M M^{\prime}}^{J}(\beta)$ Involving Trigonometric Functions}

\begin{gather*}
d_{M M^{\prime}}^{J}(\beta)=(-1)^{J-M^{\prime}}\left[(J+M)!(J-M)!\left(J+M^{\prime}\right)!\left(J-M^{\prime}\right)!\right]^{\frac{1}{2}} \\
\times \sum_{k}(-1)^{k} \frac{\left(\cos \frac{\beta}{2}\right)^{M+M^{\prime}+2 k}\left(\sin \frac{\beta}{2}\right)^{2 J-M-M^{\prime}-2 k}}{k!(J-M-k)!\left(J-M^{\prime}-k\right)!\left(M+M^{\prime}+k\right)!}  \tag{2}\\
d_{M M^{\prime}}^{J}(\beta)=(-1)^{J+M^{\prime}}\left[(J+M)!(J-M)!\left(J+M^{\prime}\right)!\left(J-M^{\prime}\right)!\right]^{\frac{1}{2}} \\
\times \sum_{k}(-1)^{k} \frac{\left(\cos \frac{\beta}{2}\right)^{2 k-M-M^{\prime}}\left(\sin \frac{\beta}{2}\right)^{2 J+M+M^{\prime}-2 k}}{k!(J+M-k)!\left(J+M^{\prime}-k\right)!\left(k-M-M^{\prime}\right)!}  \tag{3}\\
d_{M M^{\prime}}^{J}(\beta)=\left[(J+M)!(J-M)!\left(J+M^{\prime}\right)!\left(J-M^{\prime}\right)!\right]^{\frac{1}{2}} \\
\times \sum_{k}(-1)^{k} \frac{\left(\cos \frac{\beta}{2}\right)^{2 J-2 k+M-M^{\prime}}\left(\sin \frac{\beta}{2}\right)^{2 k-M+M^{\prime}}}{k!(J+M-k)!\left(J-M^{\prime}-k\right)!\left(M^{\prime}-M+k\right)!} \tag{4}
\end{gather*}
...
& \quad \times \sum_{k}(-1)^{k} \frac{\left(\cos \frac{\beta}{2}\right)^{2 J-2 k-M+M^{\prime}}\left(\sin \frac{\beta}{2}\right)^{2 k+M-M^{\prime}}}{k!(J-M-k)!\left(J+M^{\prime}-k\right)!\left(M-M^{\prime}+k\right)!} \tag{5}
\end{align*}


In Eqs. (2)-(5) $k$ runs over all integer values for which the factorial arguments are non-negative. Each of these sums contains $(N+1)$ terms, where $N$ is the minimum of $J+M, J-M, J+M^{\prime}$ and $J-M^{\prime}$. Equations (2)-(5) are not independent, but may be transformed into one another by changing summation variables.

Equations (2)-(5) may be regarded as special cases of the more general expression
...
\left(m_{1}+m_{2}=M\right)}}(-1)^{J_{2}+m_{2}} C_{J_{1} m_{1} J_{2} m_{2}}^{J M} \frac{\left(\cos \frac{\beta}{2}\right)^{J_{1}+J_{2}+m_{1}-m_{2}}\left(\sin \frac{\beta}{2}\right)^{J_{1}+J_{2}-m_{1}+m_{2}}}{\left[\left(J_{1}+m_{1}\right)!\left(J_{1}-m_{1}\right)!\left(J_{2}+m_{2}\right)!\left(J_{2}-m_{2}\right)!\right]^{\frac{1}{2}}} \tag{6}
\end{gather*}


where $J_{1}$ and $J_{2}$ are arbitrary integer or half-integer numbers which satisfy the conditions $J_{1}-J_{2}=M^{\prime}$ and $\left|J_{1}-J_{2}\right| \leq J \leq J_{1}+J_{2}$. The sum in Eq. (6) is over all possible (positive and negative) values of $m_{1}$ and $m_{2}$ which correspond to nonzero Clebsch-Gordan coefficients. In particular, Eq. (6) reduces to Eq. (2), when $J_{1}=\left(J+M^{\prime}\right) / 2, J_{2}=\left(J-M^{\prime}\right) / 2, m_{1}=M+k-\left(J-M^{\prime}\right) / 2$ and $m_{2}=-k+\left(J-M^{\prime}\right) / 2$.

\subsection*{4.3.2. Differential Representations of $d_{M M^{\prime}}^{J}(\beta)$}
...
& \times \frac{d^{J-M}}{(d \cos \beta)^{J-M}}\left[(1-\cos \beta)^{J-M^{\prime}}(1+\cos \beta)^{J+M^{\prime}}\right]  \tag{7}\\
...
& \times \frac{d^{J+M}}{(d \cos \beta)^{J+M}}\left[(1-\cos \beta)^{J+M^{\prime}}(1+\cos \beta)^{J-M^{\prime}}\right]  \tag{8}\\
...
& \times \frac{d^{J-M^{\prime}}}{(d \cos \beta)^{J-M^{\prime}}}\left[(1-\cos \beta)^{J-M^{\prime}}(1+\cos \beta)^{J+M^{\prime}}\right]  \tag{9}\\
...
& \times \frac{d^{J+M^{\prime}}}{(d \cos \beta)^{J+M^{\prime}}}\left[(1-\cos \beta)^{J+M^{\prime}}(1+\cos \beta)^{J-M^{\prime}}\right] \tag{10}
\end{align*}


In practice it is convenient to use such equation from Eqs. (7)-(10) in which the order of derivative is the lowest.

\subsection*{4.3.3. Integral Representations of $d_{M M^{\prime}}^{J}(\beta)$}
...
\times \int_{0}^{2 \pi}\left(e^{i \frac{\phi}{2}} \cos \frac{\beta}{2}+i e^{-i \frac{\phi}{2}} \sin \frac{\beta}{2}\right)^{J-M^{\prime}}\left(e^{-i \frac{\phi}{2}} \cos \frac{\beta}{2}+i e^{i \frac{\phi}{2}} \sin \frac{\beta}{2}\right)^{J+M^{\prime}} e^{i M \phi} d \phi \tag{11}
\end{gather*}


Equation (11) can be rewritten as a contour integral
...
& \times\left(i z \sin \frac{\beta}{2}+\cos \frac{\beta}{2}\right)^{J+M^{\prime}} z^{M-J-1} d z \tag{12}
\end{align*}


The integration contour in Eq. (12) is a circle of unit radius about the origin of the $z$-plane.

\subsection*{4.3.4. Relation Between $d_{M M^{\prime}}^{J}(\beta)$ and the Jacobi Polynomials}
...
\[
\xi_{M M^{\prime}}= \begin{cases}1 & \text { if } M^{\prime} \geq M  \tag{15}\\ (-1)^{M^{\prime}-M} & \text { if } M^{\prime}<M\end{cases}
\]
...
d_{M M^{\prime}}^{J}(\beta \pm 2 \pi n) & =(-1)^{2 J n} d_{M M^{\prime}}^{J}(\beta),  \tag{1}\\
d_{M M^{\prime}}^{J}(\beta \pm(2 n+1) \pi) & =(-1)^{ \pm(2 n+1) J-M^{\prime}} d_{M-M^{\prime}}^{J}(\beta),
\end{array}\right\} n \text { is integer }
\]

(b) Equations (1) imply the following symmetry properties of $D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)$
...
\begin{equation*}
\varepsilon=(-1)^{M^{\prime}-M}, \quad \eta=e^{-i 2 M \alpha-i 2 M^{\prime} \gamma} \tag{3}
\end{equation*}
...
D_{M M^{\prime}}^{J}(\alpha, \beta \pm(2 n+1) \pi, \gamma)=(-1)^{ \pm(2 n+1) J-M^{\prime}} D_{M-M^{\prime}}^{J}(\alpha, \beta,-\gamma)  \tag{4}\\
...
\begin{equation*}
D_{M M^{\prime}}^{J}(\tilde{\alpha}, \beta, \tilde{\gamma})=e^{i M(\alpha-\tilde{\alpha})} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma) e^{i M^{\prime}(\gamma-\tilde{\gamma})} \tag{5}
\end{equation*}
...
& =(-1)^{J} D_{M-M^{\prime}}^{J}(\alpha, \beta, \gamma) \tag{6}
\end{align*}
...
& =(-1)^{J+M^{\prime}} D_{M-M^{\prime}}^{J}(\alpha, \beta, \gamma) \tag{7}
\end{align*}
...
\begin{equation*}
D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma-\pi)=\hat{R}_{z^{\prime}} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)=\sum_{M^{\prime \prime}} D_{M M^{\prime \prime}}^{J}(\alpha, \beta, \gamma) D_{M^{\prime \prime} M^{\prime}}^{J}(0,0,-\pi)=(-1)^{M^{\prime}} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma) \tag{8}
\end{equation*}
...
\subsection*{4.5. ROTATION MATRIX $U_{M M}^{J}$, IN TERMS OF ANGLES $\omega, \Theta, \Phi$}
\subsection*{4.5.1. Deflnition}
...
\begin{equation*}
U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi) \equiv\langle J M| e^{-i \omega n \cdot \hat{J}}\left|J M^{\prime}\right\rangle \tag{1}
\end{equation*}
...
\begin{equation*}
\mathfrak{M}_{J M^{\prime}}\left(\vartheta^{\prime}, \varphi^{\prime}\right)=\sum_{M} \mathfrak{M}_{J M}(\vartheta, \varphi) U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi) \tag{2}
\end{equation*}
...
\subsection*{4.5.2 Explicit form}
...
(i) $R_{1}\left(\alpha_{1}=\Phi, \beta_{1}=\Theta, \gamma_{1}=-\Phi\right)$, i.e., the rotation which turns the $z$-axis to the direction of $\mathbf{n}(\Theta, \Phi)$;\\
(ii) $R_{2}\left(\alpha_{2}=\omega, \beta_{2}=0, \gamma_{2}=0\right)$, i.e., the rotation about $\mathbf{n}(\Theta, \Phi)$ through an angle $\omega$;\\
...
\begin{equation*}
U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi)=\sum_{M^{\prime \prime}} D_{M M^{\prime \prime}}^{J}(\Phi, \Theta,-\Phi) e^{-i M^{\prime \prime} \omega} D_{M^{\prime \prime} M^{\prime}}^{J}(\Phi,-\Theta,-\Phi) \tag{3}
\end{equation*}


Equation (3) enables one to find an explicit form for $U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi)$ for particular $J, M$ and $M^{\prime}$.\\
(b) According to Eq. 4.6(10) the functions $U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi)$ may be directly constructed from the matrix elements $U_{m m^{\prime}}^{\frac{1}{2}}$ which represent the Cayley-Klein parameters (see Eqs. 4.6(12)). This gives the expression

\[
U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi)=\left\{\begin{array}{cc}
(-i v)^{2 J}\left(\frac{u}{-i v}\right)^{\left(M+M^{\prime}\right)} e^{-i\left(M-M^{\prime}\right) \Phi} \sum_{v} \frac{\sqrt{(J+M)!(J-M)!\left(J+M^{\prime}\right)!\left(J-M^{\prime}\right)!}}{s!\left(s+M+M^{\prime}\right)!(J-M-s)!\left(J-M^{\prime}-s\right)!}\left(1-v^{-2}\right)^{s}  \tag{4}\\
& M+M^{\prime} \geq 0 \\
...
\begin{equation*}
v=\sin \frac{\omega}{2} \sin \Theta, \quad u=\cos \frac{\omega}{2}-i \sin \frac{\omega}{2} \cos \Theta \tag{5}
\end{equation*}


In Eqs. (4) the summation index $s$ runs over all integer values which do not lead to negative factorial arguments.\\
...
\begin{equation*}
U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi)=i^{M-M^{\prime}} e^{-i\left(M-M^{\prime}\right) \Phi}\left(\frac{1-i \tan \frac{\omega}{2} \cos \Theta}{\sqrt{1+\tan ^{2} \frac{\omega}{2} \cos ^{2} \Theta}}\right)^{M+M^{\prime}} d_{M M^{\prime}}^{J}(\xi) \tag{6}
\end{equation*}
...
\begin{equation*}
\sin \frac{\xi}{2}=\sin \frac{\omega}{2} \sin \Theta . \tag{7}
\end{equation*}
...
\begin{equation*}
U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi)=\sum_{\lambda \mu}(-i)^{\lambda} \frac{2 \lambda+1}{2 J+1} \chi_{\lambda}^{J}(\omega) C_{J M \lambda \mu}^{J M^{\prime}} \sqrt{\frac{4 \pi}{2 \lambda+1}} Y_{\lambda \mu}(\Theta, \Phi) \tag{8}
\end{equation*}
...
Equation (8) shows that $U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi)$ depends on $M$ and $M^{\prime}$ only through the Clebsch-Gordan coefficients $C_{J M \lambda \mu}^{J M^{\prime}}$.

\subsection*{4.5.3. Differential Equations}
...
\begin{align*}
& \hat{J}_{z}=-i\left[\cos \Theta \frac{\partial}{\partial \omega}-\frac{1}{2} \cot \frac{\omega}{2} \sin \Theta \frac{\partial}{\partial \Theta}+\frac{1}{2} \cdot \frac{\partial}{\partial \Phi}\right]  \tag{9}\\
& \hat{J}_{z}=-i\left[\cos \Theta \frac{\partial}{\partial \omega}-\frac{1}{2} \cot \frac{\omega}{2} \sin \Theta \frac{\partial}{\partial \Theta}-\frac{1}{2} \cdot \frac{\partial}{\partial \Phi}\right]  \tag{10}\\
& \hat{J}^{2}=-\left[\frac{\partial^{2}}{\partial \omega^{2}}+\cot \frac{\omega}{2} \frac{\partial}{\partial \omega}+\frac{1}{4 \sin ^{2} \frac{\omega}{2}}\left(\frac{\partial^{2}}{\partial \Theta^{2}}+\cot \Theta \frac{\partial}{\partial \Theta}+\frac{1}{\sin ^{2} \Theta} \frac{\partial^{2}}{\partial \Phi^{2}}\right)\right] \tag{11}
\end{align*}
...
\begin{align*}
{\left[\widehat{\mathbf{J}}^{2}-J(J+1)\right] U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi) } & =0 \\
{\left[\widehat{J}_{z}+M\right] U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi) } & =0  \tag{12}\\
...
\left.\frac{\partial}{\partial \Phi} U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi)\right|_{\Theta=0}=\left.\frac{\partial}{\partial \Phi} U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi)\right|_{\Theta=\pi}=0 . \tag{13}
\end{gather*}


\subsection*{4.5.4. Orthogonality and Completeness}
...
\begin{equation*}
0 \leq \theta \leq \pi, \quad 0 \leq \Phi<2 \pi, \quad 0 \leq \omega<2 \pi \tag{14}
\end{equation*}


whose total volume is equal to $16 \pi^{2}$.\\
(a) Orthogonality and Normalization


\begin{equation*}
4 \int_{0}^{2 \pi} d \omega \sin ^{2} \frac{\omega}{2} \int_{0}^{\pi} d \Theta \sin \Theta \int_{0}^{2 \pi} d \Phi U_{M_{1} M_{1}^{\prime}}^{J_{1} *}(\omega ; \Theta, \Phi) U_{M_{2} M_{2}^{\prime}}^{J_{2}}(\omega ; \Theta, \Phi)=\frac{16 \pi^{2}}{2 J_{1}+1} \delta_{J_{1} J_{2}} \delta_{M_{1} M_{2}} \delta_{M_{1}^{\prime} M_{2}^{\prime}} \tag{15}
\end{equation*}
...
\begin{equation*}
\sum_{J=0,1 / 2,1 \ldots}^{\infty} \frac{2 J+1}{16 \pi^{2}} \sum_{M M^{\prime}} U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi) U_{M M^{\prime}}^{J *}(\tilde{\omega} ; \tilde{\Theta}, \tilde{\Phi})=\frac{\delta(\Phi-\tilde{\Phi}) \delta(\Theta-\tilde{\Theta}) \delta(\omega-\tilde{\omega})}{4 \sin \Theta \sin ^{2} \frac{\omega}{2}} \tag{16}
\end{equation*}


\subsection*{4.5.5. Principal Properties}
(a) Inverse transformation


\begin{equation*}
\left[U^{-1}(\omega ; \Theta, \Phi)\right]_{M M^{\prime}}^{J}=U_{M M^{\prime}}^{J}(-\omega ; \Theta, \Phi)=U_{M M^{\prime}}^{J}(\omega ; \pi-\Theta, \pi+\Phi) \tag{17}
\end{equation*}
...
\begin{equation*}
U_{M M^{\prime}}^{J *}(\omega ; \Theta, \Phi)=U_{M^{\prime} M}^{J}(\omega ; \pi-\Theta, \pi+\Phi)=U_{M^{\prime} M}^{J}(-\omega ; \Theta, \Phi) \tag{18}
\end{equation*}


(c) Reversal of argument signs


\begin{gather*}
U_{M M^{\prime}}^{J}(-\omega ; \Theta, \Phi)=(-1)^{M-M^{\prime}} U_{-M^{\prime}-M}^{J}(\omega ; \Theta \\
U_{M M^{\prime}}^{J}(\omega ;-\Theta, \Phi)=(-1)^{M-M^{\prime}} U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi)  \tag{19}\\
...
U_{M M^{\prime}}^{J}(\omega ; \Theta+2 \pi, \Phi)=U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi)  \tag{20}\\
U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi+2 \pi)=U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi)
\end{gather*}


Half-period Shift of Arguments
...
U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi+\pi) & =(-1)^{M-M^{\prime}} U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi), & U_{M M^{\prime}}^{J}(\omega ; \Theta, \pi-\Phi) & =(-1)^{M-M^{\prime}} U_{M^{\prime} M}^{J}(\omega ; \Theta, \Phi) \tag{21}
\end{align*}
...
U_{-M-M^{\prime}}^{J}(\omega ; \Theta, \Phi) & =(-1)^{M-M^{\prime}} U_{M M^{\prime}}^{J}(\omega ; \pi-\Theta, \pi+\Phi)  \tag{22}\\
...
\sin \frac{\omega_{1}}{2} \cos \Theta_{1}=-\sin \frac{\omega}{2} \sin \Theta \cos \Phi  \tag{23}\\
\cot \Phi_{1}=-\tan \frac{\omega}{2} \cos \Theta \\
\cos \frac{\omega}{2}=\sin \frac{\omega_{1}}{2} \sin \Theta_{1} \sin \Phi_{1} \\
\sin \frac{\omega}{2} \cos \Theta=-\sin \frac{\omega_{1}}{2} \sin \Theta_{1} \cos \Phi_{1}  \tag{24}\\
...
\begin{equation*}
\sin ^{2} \frac{\omega_{1}}{2} \sin ^{2} \Theta_{1}+\sin ^{2} \frac{\omega}{2} \sin ^{2} \Theta=1 \tag{25}
\end{equation*}
...
\begin{equation*}
U_{M_{1} M_{1}^{\prime}}^{J_{1}}(\omega ; \Theta, \Phi) U_{M_{2} M_{2}^{\prime}}^{J_{2}}(\omega ; \Theta, \Phi)=\sum_{J M} C_{J_{1} M_{1} J_{2} M_{2}}^{J M} U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi) C_{J_{1} M_{1}^{\prime} J_{2} M_{2}^{\prime}}^{J M^{\prime}} \tag{26}
\end{equation*}


is equivalent to Eq. 4.6(1), and the addition theorem


\begin{equation*}
\sum_{M^{\prime \prime}} U_{M M^{\prime \prime}}^{J}\left(\omega_{2} ; \Theta_{2}, \Phi_{2}\right) U_{M^{\prime \prime} M^{\prime}}^{J}\left(\omega_{1} ; \Theta_{1}, \Phi_{1}\right)=U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi) \tag{27}
\end{equation*}


is equivalent to Eq. 4.7(1). The angles $\omega_{1}, \Theta_{1}, \Phi_{1}, \omega_{2}, \Theta_{2}, \Phi_{2}$ and $\omega, \Theta, \Phi$ are related by Eqs. 1.4(76).

\subsection*{4.5.6. Special Cases}
(a) The rotation axis $\mathrm{n}(\theta, \Phi)$ coincides with one of the coordinate axes:\\
(i) The $x$-axis $\left(\Theta=\frac{\pi}{2}, \Phi=0\right)$


\begin{equation*}
U_{M M^{\prime}}^{J}\left(\omega ; \frac{\pi}{2}, 0\right)=D_{M M^{\prime}}^{J}\left(\frac{\pi}{2}, \omega,-\frac{\pi}{2}\right)=(-i)^{M-M^{\prime}} d_{M M^{\prime}}^{J}(\omega) \tag{28}
\end{equation*}
...
\begin{equation*}
U_{M M^{\prime}}^{J}\left(\omega ; \frac{\pi}{2}, \frac{\pi}{2}\right)=D_{M M^{\prime}}^{J}(0, \omega, 0)=d_{M M^{\prime}}^{J}(\omega) \tag{29}
\end{equation*}
...
\begin{equation*}
U_{M M^{\prime}}^{J}(\omega ; 0, \Phi)=\delta_{M M^{\prime}} e^{-i M \omega} \tag{30}
\end{equation*}


(b) Rotation about $\mathrm{n}(\Theta, \Phi)$ through a small angle $\omega \ll \pi / 2$.
...
-\frac{i \omega}{2} e^{i \Phi} \sqrt{(J-M)\left(J+M^{\prime}\right)} \delta_{M M^{\prime}-1} \tag{31}
\end{gather*}


(c) Explicit forms of $U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi)$ at $M= \pm J$ and/or $M^{\prime}= \pm J$
...
U_{J-J}^{J}(\omega ; \Theta, \Phi)=\left(-i \sin \frac{\omega}{2} \sin \Theta e^{-i \Phi}\right)^{2 J}, U_{-J J}^{J}(\omega ; \Theta, \Phi)=\left(-i \sin \frac{\omega}{2} \sin \Theta e^{i \Phi}\right)^{2 J} \tag{32}
\end{gather*}


(d) Explicit forms of $U_{M M^{\prime}}^{J}(\omega ; \theta, \Phi)$ for $J=\frac{1}{2}, 1, \frac{3}{2}, 2$ are given below in Tables 4.23-4.26.

\subsection*{4.6. SUMS INVOLVING $D$-FUNCTIONS}
\subsection*{4.6.1. The Clebsch-Gordan Series}
The product of two $D$-functions with the same arguments may be expanded in the following series


\begin{equation*}
D_{M_{1} N_{1}}^{J_{1}}(\alpha, \beta, \gamma) D_{M_{2} N_{2}}^{J_{2}}(\alpha, \beta, \gamma)=\sum_{J=\left|J_{1}-J_{2}\right|}^{J_{1}+J_{2}} \sum_{M N} C_{J_{1} M_{1} J_{2} M_{2}}^{J M} D_{M N}^{J}(\alpha, \beta, \gamma) C_{J_{1} N_{1} J_{2} N_{2}}^{J N}, \tag{1}
\end{equation*}


Here $C_{J_{1} M_{1} J_{2} M_{2}}^{J M}$ is a Clebsch-Gordan coefficient (Chap. 8). The sum in Eq. (1) has $2 j+1$ terms, where $j=\min \left(J_{1}, J_{2}\right)$. Equation (1) may be regarded as a particular case of the expansion of an arbitrary function in a series of the $D$-functions (Sec. 4.10).

\subsection*{4.6.2. Some Applications of the Clebsch-Gordan Expansion}
The Clebsch-Gordan expansion, Eq. (1), together with the orthogonality condition of the Clebsch-Gordan coefficients, Eq. 8.1(8), enable one to calculate sums of products of the $D$-functions with identical arguments. Hereafter we introduce the $3 j$-symbol $\left\{j_{1} j_{2} j_{3}\right\}$ defined by

\[
\left\{j_{1} j_{2} j_{3}\right\}= \begin{cases}1 & \text { if } j_{1}+j_{2}+j_{3} \text { is integer and }\left|j_{1}-j_{2}\right| \leq j_{3} \leq j_{1}+j_{2},  \tag{2}\\ 0 & \text { otherwise },\end{cases}
\]

$\left\{j_{1} j_{2} j_{3}\right\}$ is invariant with respect to permutations of $j_{1}, j_{2}, j_{3}$. Using Eqs. 4.6(1) and 8.1(8), one obtains


\begin{align*}
& \quad \sum_{\substack{M_{1} M_{2} \\
N_{1} N_{2}}} C_{J_{1} M_{1} J_{2} M_{2}}^{J M} D_{M_{1} N_{1}}^{J_{1}}(\alpha, \beta, \gamma) D_{M_{2} N_{2}}^{J_{2}}(\alpha, \beta, \gamma) C_{J_{1} N_{1} J_{2} N_{2}}^{J^{\prime} N}=\delta_{J J^{\prime}}\left\{J_{1} J_{2} J\right\} D_{M N}^{J}(\alpha, \beta, \gamma)  \tag{3}\\
& \quad \sum_{J=\left|J_{1}-J_{2}\right|}^{J_{1}+J_{2}} \sum_{M_{1} M} C_{J_{1} M_{1} J_{2} M_{2}}^{J M} D_{M_{1} N_{1}}^{J_{1} *}(\alpha, \beta, \gamma) D_{M N}^{J}(\alpha, \beta, \gamma) C_{J_{1} N_{1}^{\prime} J_{2} N_{2}}^{J N}=\delta_{N_{1} N_{1}^{\prime}} D_{M_{2} N_{2}}^{J_{2}}(\alpha, \beta, \gamma)  \tag{4}\\
& \quad \sum_{N_{1} N_{2}} D_{M_{1} N_{1}}^{J_{1}}(\alpha, \beta, \gamma) D_{M_{2} N_{2}}^{J_{2}}(\alpha, \beta, \gamma) C_{J_{1} N_{1} J_{2} N_{2}}^{J N}=C_{J_{1} M_{1} J_{2} M_{3}}^{J M} D_{M N}^{J}(\alpha, \beta, \gamma)  \tag{5}\\
& \quad \sum_{\substack{N_{1} N_{2} N \\
M_{1} M_{2} M}} D_{M_{N} N}^{J *}(\alpha, \beta, \gamma) D_{M_{1} N_{1}}^{J_{1}}(\alpha, \beta, \gamma) D_{M_{2} N_{2}}^{J_{2}}(\alpha, \beta, \gamma) C_{J_{1} N_{1} J_{2} N_{2}}^{J N}=C_{J_{1} M_{1} J_{2} M_{2}}^{J M} N_{J_{1} M_{1} J_{2} M_{2}}^{J *} D_{M N}^{J *}(\alpha, \beta, \gamma) D_{M_{1} N_{1}}^{J_{1}}(\alpha, \beta, \gamma) D_{M_{2} N_{2}}^{J_{2}}(\alpha, \beta, \gamma) C_{J_{1} N_{1} J_{2} N_{2}}^{J^{\prime} N^{\prime}}=\delta_{J J^{\prime}} \delta_{N N^{\prime}}\left\{J_{1} J_{2} J\right\} \tag{6}
\end{align*}


\subsection*{4.6.3. Generalization of the Clebsch-Gordan Expansion}
The Clebsch-Gordan expansion can be generalized to the case of an arbitrary number of $D$-functions of identical arguments by successive use of Eq. (3). For instance, the summation of products of three $D$-functions yields


\begin{gather*}
\sum_{\substack{M_{1} M_{2} M_{3} \\
N_{1} N_{2} N_{3}}} C_{J_{12} M_{12} J_{3} M_{3}}^{J M} C_{J_{1} M_{1} J_{2} M_{2}}^{J_{12} M_{12}} D_{M_{1} N_{1}}^{J_{1}}(\alpha, \beta, \gamma) D_{M_{2} N_{2}}^{J_{2}}(\alpha, \beta, \gamma) D_{M_{3} N_{3}}^{J_{3}}(\alpha, \beta, \gamma) C_{J_{1} N_{1} J_{2} N_{2}}^{J_{12}^{\prime} N_{12}} C_{J_{12}^{\prime} N_{12} J_{3} N_{3}}^{J^{\prime} N} \\
=\delta_{J J^{\prime}} \delta_{J_{12} J_{12}^{\prime}}\left\{J_{1} J_{2} J_{12}\right\}\left\{J_{12} J_{3} J\right\} D_{M N}^{J}(\alpha, \beta, \gamma) . \tag{8}
\end{gather*}


In particular, for the case when $J_{3}=0$, Eq. (8) is reduced to Eq. (3).\\
In general, the sum of products of $k D$-functions is given by


\begin{equation*}
\sum_{\substack{m_{1}, \ldots, m_{k} \\ n_{1}, \ldots, n_{k}}} \prod_{i=1}^{k} C_{J_{i-1} M_{i-1} j_{i} m_{i}}^{J_{i} M_{i}} D_{m_{i} n_{i}}^{j_{i}}(\alpha, \beta, \gamma) C_{J_{i-1}^{\prime} N_{i-1} j_{i} n_{i}}^{J_{i}^{\prime} N_{i}}=D_{M_{k} N_{k}}^{J_{k}}(\alpha, \beta, \gamma) \prod_{i=1}^{k} \delta_{J_{i} J_{i}^{\prime}}\left\{j_{i} J_{i-1} J_{i}\right\} \tag{9}
\end{equation*}
...
$$
\mathbf{J}_{i}=\mathbf{j}_{1}+\mathbf{j}_{2}+\cdots+\mathbf{j}_{i}, \quad M_{i}=m_{1}+m_{2}+\cdots+m_{i}, \quad N_{i}=n_{1}+n_{2}+\cdots+n_{i}
$$

It is assumed in Eq. (9) that $J_{0}=J_{0}^{\prime}=M_{0}=N_{0}=0$.\\
...
& =\frac{(2 J)!}{\sqrt{(J+M)!(J-M)!(J+N)!(J-N)!}} D_{M N}^{J}(\alpha, \beta, \gamma) \tag{10}
\end{align*}
...
=\frac{(2 J)!}{\sqrt{(J+M)!(J-M)!(J+N)!(J-N)!}} D_{M N}^{J}(\alpha, \beta, \gamma) \tag{11}
\end{gather*}


where $J \equiv J_{k}=k$ is integer.\\
Equations (10) and (11) are useful for evaluating the Wigner $D$-functions. For example, Eq. (10) gives an explicit form of the $D$-functions in terms of the Cayley-Klein parameters (Sec. 1.4.3.) defined by

\[
\left.\begin{array}{lc}
D_{\frac{1}{2} \frac{1}{2}}^{\frac{1}{2}}(\alpha, \beta, \gamma) \equiv a, & D_{\frac{1}{2}-\frac{1}{2}}^{\frac{1}{2}}(\alpha, \beta, \gamma) \equiv-b^{*}  \tag{12}\\
...
\begin{equation*}
D_{M N}^{J}(\alpha, \beta, \gamma)=\sqrt{(J+M)!(J-M)!(J+N)!(J-N)!} \sum_{p, q, r, s} \frac{(a)^{p}(b)^{q}\left(a^{*}\right)^{r}\left(-b^{*}\right)^{s}}{p!q!r!s!} \tag{13}
\end{equation*}
...
According to Eqs. (14), only one parameter from $p, q, r$ and $s$ is independent, i.e., in fact, Eq. (13) represents a single sum. The independent summation index may be chosen in different ways. This yields different explicit forms for the $D$-functions, Eqs. 4.3(2)-4.3(5). For example, if $r$ is taken to be independent, Eq. (13) reduces to Eq. 4.3(2).

\subsection*{4.6.4. Determinant of Matrix $D_{M M^{\prime}}^{J}$}
The determinant $\left\|D_{M M^{\prime}}^{J}\right\|$ of the rotation matrix is an invariant sum of products of $2 J+1 D$-functions. According to Eq. 4.1(7), this matrix is unimodular, i.e.,


\begin{equation*}
\sum_{P}(-1)^{P} D_{-J M_{1}}^{J}(\alpha, \beta, \gamma) D_{-J+1 M_{2}}^{J}(\alpha, \beta, \gamma) \ldots D_{J M_{2 J+1}}^{J}(\alpha, \beta, \gamma)=1 \tag{15}
\end{equation*}
...
\subsection*{4.7. ADDITION OF ROTATIONS}
\subsection*{4.7.1. The Addition Theorem for $D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)$}
...
\begin{equation*}
\sum_{M^{\prime \prime}=-J}^{J} D_{M M^{\prime \prime}}^{J}\left(\alpha_{2}, \beta_{2}, \gamma_{2}\right) D_{M^{\prime \prime} M^{\prime}}^{J}\left(\alpha_{1}, \beta_{1}, \gamma_{1}\right)=D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma) \tag{1}
\end{equation*}
...
\begin{equation*}
\sum_{M^{\prime \prime}=-J}^{J} D_{M M^{\prime \prime}}^{J}\left(\alpha_{1}, \beta_{1}, \gamma_{1}\right) D_{M^{\prime \prime} M^{\prime}}^{J}\left(\alpha_{2}, \beta_{2}, \gamma_{2}\right)=D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma) \tag{2}
\end{equation*}
...
\begin{equation*}
\sum_{M^{\prime \prime}=-J}^{J} D_{M M^{\prime \prime}}^{J}\left(\alpha, \beta_{1}, \varphi\right) D_{M^{\prime \prime} M^{\prime}}^{J}\left(-\varphi, \beta_{2}, \gamma\right)=D_{M M^{\prime}}^{J}\left(\alpha, \beta_{1}+\beta_{2}, \gamma\right), \tag{3}
\end{equation*}
...
& =D_{M M^{\prime}}^{J}(0,0,0)=\delta_{M M^{\prime}} \tag{4}
\end{align*}


\subsection*{4.7.2 The Addition Theorem for $d_{M M^{\prime}}^{J}(\beta)$}
Equation (2) may be rewritten as


\begin{equation*}
\sum_{M^{\prime \prime}=-J}^{J} d_{M M^{\prime \prime}}^{J}\left(\beta_{1}\right) d_{M^{\prime \prime} M^{\prime}}^{J}\left(\beta_{2}\right) e^{-i M^{\prime \prime} \varphi}=e^{-i M \alpha} d_{M M^{\prime}}^{J}(\beta) e^{-i M^{\prime} \gamma} \tag{5}
\end{equation*}
...
& \cos \beta=\cos \beta_{1} \cos \beta_{2}-\sin \beta_{1} \sin \beta_{2} \cos \varphi  \tag{6}\\
& \cot \gamma=\cos \beta_{2} \cot \varphi+\cot \beta_{1} \frac{\sin \beta_{2}}{\sin \varphi}
\end{align*}


Equation (5) is simplified in the following particular cases. If $\varphi=0$ and $\beta_{1}+\beta_{2} \leq \pi$, then $\alpha=0, \beta=\beta_{1}+\beta_{2}$ and $\gamma=0$,


\begin{equation*}
\sum_{M^{\prime \prime}=-J}^{J} d_{M M^{\prime \prime}}^{J}\left(\beta_{1}\right) d_{M^{\prime \prime} M^{\prime}}^{J}\left(\beta_{2}\right)=d_{M M^{\prime}}^{J}\left(\beta_{1}+\beta_{2}\right) \tag{7}
\end{equation*}
...
\begin{equation*}
\sum_{M^{\prime \prime}=-J}^{J} d_{M M^{\prime \prime}}^{J}\left(\beta_{1}\right) d_{M^{\prime \prime} M^{\prime}}^{J}\left(\beta_{2}\right)=(-1)^{M+M^{\prime}} d_{M M^{\prime}}^{J}\left(2 \pi-\beta_{1}-\beta_{2}\right) \tag{8}
\end{equation*}
...
\begin{equation*}
\sum_{M^{\prime \prime}=-J}^{J}(-1)^{M^{\prime \prime}-M^{\prime}} d_{M M^{\prime \prime}}^{J}\left(\beta_{1}\right) d_{M^{\prime \prime} M^{\prime}}^{J}\left(\beta_{2}\right)=d_{M M^{\prime}}^{J}\left(\beta_{1}-\beta_{2}\right) \tag{9}
\end{equation*}
...
\begin{equation*}
\sum_{M^{\prime \prime}=-J}^{J}(-1)^{M^{\prime \prime}-M^{\prime}} d_{M M^{\prime \prime}}^{J}(\beta) d_{M^{\prime \prime} M^{\prime}}^{J}(\beta)=\delta_{M M^{\prime}} \tag{10}
\end{equation*}
...
\begin{equation*}
\sum_{M^{\prime \prime}=-J}^{J}(-i)^{M^{\prime \prime}} d_{M M^{\prime \prime}}^{J}\left(\beta_{1}\right) d_{M^{\prime \prime} M^{\prime}}^{J}\left(\beta_{2}\right)=e^{-i M \alpha} d_{M M^{\prime}}^{J}(\beta) e^{-i M^{\prime} \gamma} \tag{11}
\end{equation*}
...
& \cos \beta=\cos \beta_{1} \cos \beta_{2}  \tag{12}\\
& \cot \gamma=\cot \beta_{1} \sin \beta_{2}
\end{align*}


\subsection*{4.7.3. Addition of Two Identical Rotations}
When $\alpha_{1}=\alpha_{2}, \beta_{1}=\beta_{2}$ and $\gamma_{1}=\gamma_{2}$ the addition theorem, Eq. (1), together with the Clebsch-Gordan expansion, Eq. 4.6(1), yield


\begin{equation*}
\sum_{J=0,1, \ldots}^{2 j} \sum_{m^{\prime \prime}} C_{j m j m^{\prime \prime}}^{J m+m^{\prime \prime}} D_{m+m^{\prime \prime} m^{\prime \prime}+m^{\prime}}^{J}(\alpha, \beta, \gamma) C_{j m^{\prime \prime} j m^{\prime}}^{J m^{\prime \prime}+m^{\prime}}=D_{m m^{\prime}}^{j}(\bar{\alpha}, \bar{\beta}, \bar{\gamma}) \tag{13}
\end{equation*}
...
\tan (\bar{\alpha}-\alpha)=\tan (\bar{\gamma}-\gamma)=\frac{\tan \frac{\alpha+\gamma}{2}}{\cos \beta} \tag{14}
\end{gather*}
...
\begin{equation*}
\sum_{J=0,1, \ldots}^{2 j} \sum_{m^{\prime \prime}} C_{j m j m^{\prime \prime}}^{J m+m^{\prime \prime}} d_{m+m^{\prime \prime} m^{\prime \prime}+m^{\prime}}^{J}(\beta) C_{j m^{\prime \prime} j m^{\prime}}^{J m^{\prime \prime}+m^{\prime}}=d_{m m^{\prime}}^{j}(2 \beta) \tag{15}
\end{equation*}


\subsection*{4.7.4. The Multiplication Theorem for $d_{M M^{\prime}}^{J}(\beta)$}
Equation (5) leads to a representation of products of two $d_{M M^{\prime}}^{J}(\beta)$ functions


\begin{equation*}
d_{M M^{\prime \prime}}^{J}\left(\beta_{1}\right) d_{M^{\prime \prime} M^{\prime}}^{J}\left(\beta_{2}\right)=\frac{1}{4 \pi} \int_{-2 \pi}^{2 \pi} e^{i\left(M^{\prime \prime} \varphi-M \alpha-M^{\prime} \gamma\right)} d_{M M^{\prime}}^{J}(\beta) d \varphi \tag{16}
\end{equation*}


Here $\alpha, \beta, \gamma$ are related to $\beta_{1}, \beta_{2}$ and $\varphi$ by means of Eq. (6).

\subsection*{4.7.5. Sums Involving the D-Functions of Different Arguments}
In addition to Eqs. (1) or (2) one can derive the following invariant sums which are equivalent to the characters of irreducible representations of rotation group for two rotations (Sec. 4.14):\\
(a)


\begin{equation*}
\sum_{M M^{\prime}} D_{M M^{\prime}}^{J}\left(\alpha_{1}, \beta_{1}, \gamma_{1}\right) D_{M^{\prime} M}^{J}\left(\alpha_{2}, \beta_{2}, \gamma_{2}\right) \equiv \chi^{J}\left(R_{1} R_{2}\right)=\chi^{J}\left(R_{2} R_{1}\right)=\frac{\sin \left[(2 J+1) \frac{\omega}{2}\right]}{\sin \frac{\omega}{2}} \tag{17}
\end{equation*}
...
& =\cos \frac{\beta_{1}+\beta_{2}}{2} \cos \frac{\alpha_{1}+\gamma_{2}}{2} \cos \frac{\gamma_{1}+\alpha_{2}}{2}-\cos \frac{\beta_{1}-\beta_{2}}{2} \sin \frac{\alpha_{1}+\gamma_{2}}{2} \sin \frac{\gamma_{1}+\alpha_{2}}{2} \tag{18}
\end{align*}
...
\begin{equation*}
\sum_{M M^{\prime}} D_{M M^{\prime}}^{J}\left(\alpha_{1}, \beta_{1}, \gamma_{1}\right) D_{M M^{\prime}}^{J *}\left(\alpha_{2}, \beta_{2}, \gamma_{2}\right) \equiv \chi^{J}\left(R_{1} R_{2}^{-\mathbf{r}}\right)=\chi^{J}\left(R_{1}^{-1} R_{2}\right)=\frac{\sin \left[(2 J+1) \frac{\omega^{\prime}}{2}\right]}{\sin \frac{\omega^{\prime}}{2}} \tag{19}
\end{equation*}
...
& =\cos \frac{\beta_{1}-\beta_{2}}{2} \cos \frac{\alpha_{1}-\alpha_{2}}{2} \cos \frac{\gamma_{1}-\gamma_{2}}{2}-\cos \frac{\beta_{1}+\beta_{2}}{2} \sin \frac{\alpha_{1}-\alpha_{2}}{2} \sin \frac{\gamma_{1}-\gamma_{2}}{2} \tag{20}
\end{align*}


Equation (20) may be obtained from Eq. (18) by replacing $\left(\alpha_{2}, \beta_{2}, \gamma_{2}\right) \rightarrow\left(-\gamma_{2},-\beta_{2},-\alpha_{2}\right)$.\\
...
\subsection*{4.7.6. The Ponzano-Regge sum}
...
\begin{equation*}
\sum_{J=J_{\mathrm{min}}}^{\infty}(2 J+1) d_{M_{1} M_{2}}^{J}\left(\beta_{3}\right) d_{M_{2} M_{3}}^{J}\left(\beta_{1}\right) d_{M_{3} M_{1}}^{J}\left(\beta_{2}\right)=\frac{2 \Theta(B)}{\pi \sqrt{B}} \cos \left(\sum_{i=1}^{3} M_{i} \delta_{i}\right) \tag{21}
\end{equation*}
...
\captionsetup{labelformat=empty}
\caption{Fig. 4.1. Geometrical interpretation of the angles in Eq. 4.7(21)}
\end{center}
\end{figure}
...
\frac{\sin \beta_{i}}{\sin \delta_{i}}=\frac{\sin \beta_{j}}{\sin \delta_{j}}, \quad(i, j=1,2,3) . \tag{25}
\end{gather*}


These relations may be easily obtained by using spherical trigonometry (see Fig. 4.1).

\subsection*{4.8. RECURSION RELATIONS FOR $D_{M M^{\prime}}^{J}$}
\subsection*{4.8.1. Relations between $D^{J}$ and $D^{J \pm 1}$}
...
+ & \frac{\sqrt{\left((J+1)^{2}-M^{2}\right]\left[(J+1)^{2}-M^{\prime 2}\right]}}{(J+1)(2 J+1)} D_{M M^{\prime}}^{J+1}(\alpha, \beta, \gamma)  \tag{1}\\
...
+ & \frac{\sqrt{\left.(J-M)(J-M+1)[J+1)^{2}-M^{\prime 2}\right]}}{(J+1)(2 J+1)} D_{M M^{\prime}}^{J+1}(\alpha, \beta, \gamma)  \tag{2}\\
\sin \beta e^{-i \alpha} D_{M-1 M^{\prime}}^{J}(\alpha, \beta, \gamma)= & \frac{\sqrt{(J-M)(J-M+1)\left(J^{2}-M^{\prime 2}\right)}}{J(2 J+1)} D_{M M^{\prime}}^{J-1}(\alpha, \beta, \gamma)  \tag{3}\\
& +\frac{M^{\prime} \sqrt{(J+M)(J-M+1)}}{J(J+1)} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma) \\
...
&- \frac{\sqrt{\left((J+1)^{2}-M^{2}\right)\left(J-M^{\prime}\right)\left(J-M^{\prime}+1\right)}}{(J+1)(2 J+1)} D_{M^{\prime}+1}^{J(\alpha, \beta, \gamma)},  \tag{4}\\
...
&+ \frac{\sqrt{\left.(J+1)^{2}-M^{2}\right)\left(J+M^{\prime}\right)\left(J+M^{\prime}+1\right)} D_{M^{\prime}}^{J+1}(\alpha, \beta, \gamma)}{(J+1)(2 J+1)}  \tag{5}\\
...
&+\frac{\sqrt{(J-M)(J-M+1)\left(J-M^{\prime}\right)\left(J-M^{\prime}+1\right)}}{(J+1)(2 J+1)} D_{M M^{\prime}}^{J+1}(\alpha, \beta, \gamma),(6)  \tag{6}\\
...
&+\frac{\sqrt{(J+M)(J-M+1)\left(J+M^{\prime}\right)\left(J-M^{\prime}+1\right)}}{J(J+1)} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma) \\
&+\frac{\sqrt{\left(J+M^{\prime}\right)\left(J+M^{\prime}+1\right)\left(J+M^{\prime}\right)(J+M+1)}}{(J+1)(2 J+1)} D_{M M^{\prime}}^{J+1}(\alpha, \beta, \gamma),(7)  \tag{7}\\
&(1-\cos \beta) e^{i(\alpha-\gamma)} D_{M+1 M^{\prime}-1}^{J(\alpha, \beta, \gamma)=} \frac{\sqrt{(J+M)(J+M+1)\left(J-M^{\prime}\right)\left(J-M^{\prime}+1\right)}}{J(2 J+1)} D_{M M^{\prime}}^{J-1}(\alpha, \beta, \gamma) \\
&-\frac{\sqrt{(J-M)(J+M+1)\left(J+M^{\prime}\right)\left(J-M^{\prime}+1\right)}}{J(J+1)} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma) \\
&+\frac{\sqrt{(J-M)(J-M+1)\left(J+M^{\prime}\right)\left(J+M^{\prime}+1\right)}}{(J+1)(2 J+1)} D_{M M^{\prime}}^{J+1}(\alpha, \beta, \gamma),(8)  \tag{8}\\
&(1-\cos \beta) e^{-i(\alpha-\gamma)} D_{M-1 M^{\prime}+1}^{J}(\alpha, \beta, \gamma)= \frac{\sqrt{(J-M)(J-M+1)\left(J+M^{\prime}\right)\left(J+M^{\prime}+1\right)}}{J(2 J+1)} D_{M M^{\prime}}^{J-1}(\alpha, \beta, \gamma) \\
&-\frac{\sqrt{(J+M)(J-M+1)\left(J-M^{\prime}\right)\left(J+M^{\prime}+1\right)}}{J(J+1)} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma) \\
&+\frac{\sqrt{(J+M)(J+M+1)\left(J-M^{\prime}\right)\left(J-M^{\prime}+1\right)}}{(J+1)(2 J+1)} D_{M M^{\prime}}^{J+1}(\alpha, \beta, \gamma)  \tag{9}\\
&(9)
\end{align*}


Equations (1)-(9) may be obtained from the Clebsch-Gordan series, Eq. 4.6(1) with $J_{1}=1$.

\subsection*{4.8.2. Relations Between $D^{J}$ and $D^{J \pm 1 / 2}$}
...
& +\frac{\sqrt{\left(J-M+\frac{1}{2}\right)\left(J-M^{\prime}+\frac{1}{2}\right)}}{2 J+1} D_{M M^{\prime}}^{J+\frac{1}{2}}(\alpha, \beta, \gamma),  \tag{10}\\
...
& +\frac{\sqrt{\left(J-M+\frac{1}{2}\right)\left(J+M^{\prime}+\frac{1}{2}\right)}}{2 J+1} D_{M M^{\prime}}^{J+\frac{1}{2}}(\alpha, \beta, \gamma),  \tag{11}\\
\cos \frac{\beta}{2} e^{-i \frac{\alpha+\alpha}{2}} D_{M-\frac{1}{2} M^{\prime}-\frac{1}{2}}^{J}(\alpha, \beta, \gamma)= & \frac{\sqrt{\left(J-M+\frac{1}{2}\right)\left(J-M^{\prime}+\frac{1}{2}\right)}}{2 J+1} D_{M M^{\prime}}^{J-\frac{1}{2}}(\alpha, \beta, \gamma) \\
& +\frac{\sqrt{\left(J+M+\frac{1}{2}\right)\left(J+M^{\prime}+\frac{1}{2}\right)}}{2 J+1} D_{M M^{\prime}}^{J+\frac{1}{2}}(\alpha, \beta, \gamma),  \tag{12}\\
\sin \frac{\beta}{2} e^{-i \frac{\alpha-\alpha}{2}} D_{M-\frac{1}{2} M^{\prime}+\frac{1}{2}}^{J}(\alpha, \beta, \gamma)= & \frac{\sqrt{\left(J-M+\frac{1}{2}\right)\left(J+M^{\prime}+\frac{1}{2}\right)}}{2 J+1} D_{M M^{\prime}}^{J-\frac{1}{2}}(\alpha, \beta, \gamma) \\
& -\frac{\sqrt{\left(J+M+\frac{1}{2}\right)\left(J-M^{\prime}+\frac{1}{2}\right)}}{2 J+1} D_{M M^{\prime}}^{J+\frac{1}{2}}(\alpha, \beta, \gamma) . \tag{13}
\end{align*}


Equations (10)-(13) may be obtained from Eq. 4.6(1) with $J_{1}=\frac{1}{2}$. They yield
...
\subsection*{4.9. DIFFERENTIAL RELATIONS FOR $D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)$}
...
+\frac{\left.J \sqrt{\left.(J+1)^{2}-M^{2}\right](J+1)^{2}-M^{\prime 2}}\right]}{(J+1)(2 J+1)} D_{M M^{\prime}}^{J+1}(\alpha, \beta, \gamma)  \tag{1}\\
\begin{aligned}
...
\end{aligned} \\
\frac{\partial}{\partial \beta} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)=\frac{1}{2} \sqrt{\left(J+M^{\prime}\right)\left(J-M^{\prime}+1\right)} e^{-i \gamma} D_{M M^{\prime}-1}^{J}(\alpha, \beta, \gamma)  \tag{2}\\
\\
-\frac{1}{2} \sqrt{\left(J-M^{\prime}\right)\left(J+M^{\prime}+1\right)} e^{i \gamma} D_{M M^{\prime}+1}^{J}(\alpha, \beta, \gamma)  \tag{3}\\
\frac{\partial}{\partial \beta} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)=\frac{M^{\prime}-M \cos \beta}{\sin \beta} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)-\sqrt{(J+M)(J-M+1)} e^{-i \alpha} D_{M-1 M^{\prime}}^{J}(\alpha, \beta, \gamma)  \tag{4}\\
\frac{\partial}{\partial \beta} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)=-\frac{M^{\prime}-M \cos \beta}{\sin \beta} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)+\sqrt{(J-M)(J+M+1)} e^{i \alpha} D_{M+1 M^{\prime}}^{J}(\alpha, \beta, \gamma)  \tag{5}\\
\frac{\partial}{\partial \beta} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)=\frac{M-M^{\prime} \cos \beta}{\sin \beta} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)+\sqrt{\left(J+M^{\prime}\right)\left(J-M^{\prime}+1\right)} e^{-i \gamma} D_{M M^{\prime}-1}^{J}(\alpha, \beta, \gamma)  \tag{6}\\
\frac{\partial}{\partial \beta} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)=-\frac{M-M^{\prime} \cos \beta}{\sin \beta} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)-\sqrt{\left(J-M^{\prime}\right)\left(J+M^{\prime}+1\right)} e^{i \gamma} D_{M M^{\prime}+1}^{J}(\alpha, \beta, \gamma)  \tag{7}\\
\frac{\partial}{\partial \alpha} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)=-i M D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)  \tag{8}\\
\frac{\partial}{\partial \gamma} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)=-i M^{\prime} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma) \tag{9}
\end{gather*}


See also Eqs. 4.2(1) and 4.2(2).

\subsection*{4.10. ORTHOGONALITY AND COMPLETENESS OF THE $D$-FUNCTIONS}
...
V_{2}: & 0 \leq \alpha<\gamma<2 \pi  \tag{2}\\
...
=\int_{0}^{2 \pi} d \alpha \int_{0}^{\pi} d \beta \sin \beta \int_{0}^{4 \pi} d \gamma D_{M_{2} M_{2}^{\prime}}^{J_{2} *}(\alpha, \beta, \gamma) D_{M_{1} M_{1}^{\prime}}^{J_{1}}(\alpha, \beta, \gamma)=\frac{16 \pi^{2}}{2 J_{1}+1} \delta_{J_{1} J_{2}} \delta_{M_{1} M_{2}} \delta_{M_{1}^{\prime} M_{2}^{\prime}} \tag{3}
\end{gather*}
...
\begin{equation*}
V: \quad 0 \leq \alpha<2 \pi, \quad 0 \leq \beta \leq \pi, \quad 0 \leq \gamma<2 \pi . \tag{4}
\end{equation*}


The total volume of the domain $V$ is equal to $8 \pi^{2}$. Hence, the orthogonality condition (3) is reduced to


\begin{equation*}
\int_{0}^{2 \pi} d \alpha \int_{0}^{\pi} d \beta \sin \beta \int_{0}^{2 \pi} d \gamma D_{M_{2} M_{2}^{\prime}}^{J_{2} *}(\alpha, \beta, \gamma) D_{M_{1} M_{1}^{\prime}}^{J_{1}}(\alpha, \beta, \gamma)=\frac{8 \pi^{2}}{2 J_{1}+1} \delta_{J_{1} J_{2}} \delta_{M_{1} M_{2}} \delta_{M_{1}^{\prime} M_{2}^{\prime}} \tag{5}
\end{equation*}


In physical applications Eq. (5) is used more often than Eq. (3).\\
The orthonormality of $D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)$ may be rewritten in terms of $d_{M M^{\prime}}^{J}(\beta)$


\begin{equation*}
\int_{0}^{\pi} d \beta \sin \beta d_{M M^{\prime}}^{J}(\beta) d_{M M^{\prime}}^{J^{\prime}}(\beta)=\frac{2}{2 J+1} \delta_{J J^{\prime}} \tag{6}
\end{equation*}
...
& \quad=\delta\left(\alpha_{1}-\alpha_{2}\right) \delta\left(\cos \beta_{1}-\cos \beta_{2}\right) \delta\left(\gamma_{1}-\gamma_{2}\right) \tag{7}
\end{align*}
...
\begin{equation*}
\iiint_{V_{1}\left(V_{2}\right)} d \alpha d \beta \sin \beta d \gamma|f(\alpha, \beta, \gamma)|^{2}<\infty \tag{8}
\end{equation*}
...
\begin{equation*}
f(\alpha, \beta, \gamma)=\sum_{J=0, \frac{1}{2}, 1, \ldots}^{\infty} \sum_{M=-J}^{J} \sum_{M^{\prime}=-J}^{J} a_{M M^{\prime}}^{J} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma) \tag{9}
\end{equation*}
...
\begin{equation*}
a_{M M^{\prime}}^{J}=\frac{2 J+1}{16 \pi^{2}} \iint_{V_{1}\left(V_{2}\right)} d \alpha d \beta \sin \beta d \gamma f(\alpha, \beta, \gamma) D_{M M^{\prime}}^{J *}(\alpha, \beta, \gamma) \tag{10}
\end{equation*}
...
\begin{equation*}
\sum_{J=0, \frac{1}{2}, 1, \ldots}^{\infty} \frac{16 \pi^{2}}{2 J+1} \sum_{M=-J}^{J} \sum_{M^{\prime}=-J}^{J}\left|a_{M M^{\prime}}^{J}\right|^{2}=\iint_{V_{1}\left(V_{2}\right)} d \alpha d \beta \sin \beta d \gamma|f(\alpha, \beta, \gamma)|^{2} \tag{11}
\end{equation*}
...
\begin{equation*}
f(\alpha, \beta, \gamma)=\sum_{\substack{J \text { integer } \\ \text { or halk-integer }}} \sum_{M=-J}^{J} \sum_{M^{\prime}=-J}^{J} b_{M M^{\prime}}^{J} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma) \tag{12}
\end{equation*}
...
\begin{equation*}
b_{M M^{\prime}}^{J}=\frac{2 J+1}{8 \pi^{2}} \int_{0}^{2 \pi} d \alpha \int_{0}^{\pi} d \beta \sin \beta \int_{0}^{2 \pi} d \gamma f(\alpha, \beta, \gamma) D_{M M^{\prime}}^{J *}(\alpha, \beta, \gamma) \tag{13}
\end{equation*}


for both cases of integer and half-integer $J$. A difference between the expansions of $f(\alpha, \beta, \gamma)$ in these two cases occurs if one uses the expansions outside of the domain V. The expansion coefficients in Eq. (12) satisfy the relation


\begin{equation*}
\sum_{\substack{J \text { integer } \\ \text { or half-integer }}} \frac{8 \pi^{2}}{2 J+1} \sum_{M=-J}^{J} \sum_{M^{\prime}=-J}^{J}\left|b_{M M^{\prime}}^{J}\right|^{2}=\int_{0}^{2 \pi} d \alpha \int_{0}^{\pi} d \beta \sin \beta \int_{0}^{2 \pi} d \gamma|f(\alpha, \beta, \gamma)|^{2} \tag{14}
\end{equation*}


\subsection*{4.11. INTEGRALS INVOLVING THE $D$-FUNCTIONS}
\subsection*{4.11.1. Integration of Products of $D_{M M^{\prime}}^{J}$}

\begin{gather*}
\int_{0}^{2 \pi} d \alpha \int_{0}^{\pi} d \beta \sin \beta \int_{0}^{2 \pi} d \gamma D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)=\delta_{J 0} \delta_{M 0} \delta_{M^{\prime} 0} 8 \pi^{2},(J \text { is integer })  \tag{1}\\
...
\int_{0}^{2 \pi} d \alpha \int_{0}^{\pi} d \beta \sin \beta \int_{0}^{2 \pi} d \gamma D_{M_{2} M_{2}^{\prime}}^{J_{2} *}(\alpha, \beta, \gamma) D_{M_{1} M_{1}^{\prime}}^{J_{1}}(\alpha, \beta, \gamma)=\frac{8 \pi^{2}}{2 J_{2}+1} \delta_{J_{1} J_{2}} \delta_{M_{1} M_{2}} \delta_{M_{1}^{\prime} M_{2}^{\prime}}  \tag{2}\\
\quad\left(J_{1}+J_{2} \text { is integer }\right)  \tag{3}\\
...
=(-1)^{M_{3}-M_{3}^{\prime}} \frac{8 \pi^{2}}{2 J_{3}+1} C_{J_{1} M_{1} J_{2} M_{2}}^{J_{3}-M_{3}} C_{J_{1} M_{1}^{\prime} J_{2} M_{2}^{\prime}}^{J_{3}-M_{1}^{\prime}}\left(J_{1}+J_{2}+J_{3} \text { is integer }\right) \tag{4}
\end{gather*}
...
=\frac{8 \pi^{2}}{2 J_{3}+1} C_{J_{1} M_{1} J_{2} M_{2}}^{J_{3} M_{3}} C_{J_{1} M_{1}^{\prime} J_{2} M_{2}^{\prime}}^{J_{3} M_{3}^{\prime}}, \quad\left(J_{1}+J_{2}+J_{3} \text { is integer }\right) \tag{5}
\end{gather*}


Equations (1)-(5) are valid, if the conditions in parentheses are satisfied. These conditions may be omitted, if the integration domain is $V_{1}$ or $V_{2}$ instead of $V$; in the latter case the factor $8 \pi^{2}$ on the right-hand side of Eqs. (1)-(5) must be replaced by $16 \pi^{2}$ (see Sec. 4.10).

Integrals involving products of four or more $D$-functions may be reduced to Eqs. (4)-(5) by using the Clebsch-Gordan expansion (Sec. 4.6.1).

\subsection*{4.11.2. Integrals Involving $d_{M M^{\prime}}^{J}(\beta)$}
From Eqs. (1)-(5) one may obtain


\begin{gather*}
\int_{0}^{\pi} d \beta \sin \beta d_{00}^{J}(\beta)=2 \delta_{J 0}  \tag{6}\\
\int_{0}^{\pi} d \beta \sin \beta d_{M M^{\prime}}^{J}(\beta) d_{M M^{\prime}}^{J^{\prime}}(\beta)=\frac{2}{2 J+1} \delta_{J J^{\prime}}  \tag{7}\\
\int_{0}^{\pi} d \beta \sin \beta d_{M_{1} M_{1}^{\prime}}^{J_{1}}(\beta) d_{M_{2} M_{2}^{\prime}}^{J_{2}}(\beta) d_{M_{3} M_{3}^{\prime}}^{J_{3}}(\beta) \delta_{M_{1}+M_{2} M_{3}} \delta_{M_{1}^{\prime}+M_{2}^{\prime} M_{3}^{\prime}}=\frac{2}{2 J_{3}+1} C_{J_{1} M_{1} J_{2} M_{2}}^{J_{3} M_{3}} C_{J_{1} M_{1}^{\prime} J_{2} M_{2}^{\prime}}^{J_{3} M_{3}^{\prime}} \tag{8}
\end{gather*}
...
& \quad=\frac{-1}{\sqrt{J(J+1)-M(M+1)}}\left(\sin \frac{\beta}{2}\right)^{M-M^{\prime}+1}\left(\cos \frac{\beta}{2}\right)^{M+M^{\prime}+1} d_{M+1 M^{\prime}}^{J}(\beta) \tag{9}
\end{align*}


Equation (9) is valid, if $M \geq M^{\prime} \geq 0$. Other cases may be deduced from Eq. (9) using the symmetries of $d_{M M^{\prime}}^{J}(\beta)$ (Eq. 4.4(1)).

\subsection*{4.12. INVARIANT SUMMATION OF INTEGRALS INVOLVING $D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)$}
Hereafter $R$ will denote the Euler angles $\alpha, \beta, \gamma$ and we also will set $d R=\sin \beta d \beta d \alpha d \gamma$ :


\begin{equation*}
\int d R f(R) \equiv \int_{0}^{2 \pi} d \alpha \int_{0}^{\pi} d \beta \sin \beta \int_{0}^{2 \pi} d \gamma f(\alpha, \beta, \gamma) \tag{1}
\end{equation*}
...
\begin{gather*}
\sum_{M M^{\prime}} \int d R D_{M M}^{J *}(R) D_{M^{\prime} M^{\prime}}^{J^{\prime}}(R)=8 \pi^{2} \delta_{J J^{\prime}}  \tag{2}\\
\sum_{M M^{\prime}} \int d R D_{M M^{\prime}}^{J}(R) D_{M^{\prime} M}^{J^{\prime}}(R)=(-1)^{2 J} 8 \pi^{2} \delta_{J J^{\prime}}  \tag{3}\\
\sum_{M_{1} M_{2} M_{3}} \int d R D_{M_{3} M_{3}}^{J_{3}}(R) D_{M_{2} M_{2}}^{J_{2}}(R) D_{M_{1} M_{1}}^{J_{1}}(R)=8 \pi^{2}\left\{J_{1} J_{2} J_{3}\right\}  \tag{4}\\
...
J_{3} & J_{4} & J_{34} \\
J_{13} & J_{24} & J
\end{array}\right\}^{2} . \tag{9}
\end{align*}


The left-hand sides of Eqs. (5)-(9) include integrations as well as summations. If the integrations are carried out before the summations (with the aid of Eqs. 4.11(4)-4.11(5)), then Eqs. (5)-(9) are reduced to sums of the Clebsch-Gordan coefficients (Sec. 8.7). On the other hand, if the summations are preformed before the integrations, one obtains the integral representations of $6 j$ - and $9 j$-symbols (see Secs. 9.3 and 10.3).

\subsection*{4.13. GENERATING FUNCTIONS FOR $d_{M M}^{J}(\beta)$}
The functions $d_{M M^{\prime}}^{J}(\beta)$ may be defined as coefficients of expansions of various generating functions.\\
(a) If $J$ and $M^{\prime}$ are fixed, then
...
=\sum_{M=-J}^{J} \sqrt{\frac{\left(J-M^{\prime}\right)!\left(J+M^{\prime}\right)!}{(J-M)!(J+M)!}}(-i)^{M-M^{\prime}} e^{i M \varphi} d_{M M^{\prime}}^{J}(\beta) \tag{1}
\end{gather*}
...
\begin{equation*}
e^{i J \beta}=\sum_{M=-J}^{J} \sqrt{\frac{\left(J-M^{\prime}\right)!\left(J+M^{\prime}\right)!}{(J-M)!(J+M)!}}(-i)^{M-M^{\prime}} d_{M M^{\prime}}^{J}(\beta) \tag{2}
\end{equation*}
...
\begin{equation*}
e^{-i J \beta}=\sum_{M=-J}^{J} \sqrt{\frac{\left(J-M^{\prime}\right)!\left(J+M^{\prime}\right)!}{(J-M)!(J+M)!}} i^{M-M^{\prime}} d_{M M^{\prime}}^{J}(\beta) \tag{3}
\end{equation*}


(b) If $M$ and $M^{\prime}$ are fixed, one can obtain several expressions in which $s, \mu, \nu$ are related to $J, M, M^{\prime}$ by Eqs. 4.3(14), $\xi_{M M^{\prime}}$ is defined by Eq. 4.3(15); and $R$ denotes


\begin{gather*}
R=\sqrt{1-2 t \cos \beta+t^{2}}, \quad|t|<1 .  \tag{4}\\
...
In Eq. (8) $\lambda$ is an arbitrary integer.

\subsection*{4.14. CHARACTERS $\chi^{j}(R)$ OF IRREDUCIBLE REPRESENTATIONS OF ROTATION GROUP}
\subsection*{4.14.1. Definition}
The trace of the finite rotation matrix in the JM-representation


\begin{equation*}
\chi^{J}(R)=\sum_{M=-J}^{J} D_{M M}^{J}(R), \tag{1}
\end{equation*}


is called the characteristic function, or simply, the character of the irreducible representation of rank $J$.

In contrast to $D_{M M^{\prime}}^{J}(R)$, the function $\chi^{J}(R)$ is invariant under rotations of the coordinate systems. Explicit forms of $\chi^{J}(R)$ are simpler when $R$ is specified by $\omega, \Theta, \Phi$ rather than by $\alpha, \beta, \gamma$ (Sec. 1.4.2). With variables $\omega, \Theta, \Phi$ in use, $\chi^{\mathrm{J}}(R)$ is entirely determined by the rotation angles $\omega$ and is independent of the rotation axis $\mathbf{n}(\boldsymbol{\theta}, \boldsymbol{\Phi}):$


\begin{equation*}
\chi^{J}(R)=\chi^{J}(\omega) \tag{2}
\end{equation*}


\subsection*{4.14.2. Explicit Forms}
(a) Trigonometric formulas


\begin{align*}
& \chi^{J}(\omega)=\frac{\sin \left[(2 J+1) \frac{\omega}{2}\right]}{\sin \frac{\omega}{2}}  \tag{3}\\
& \chi^{J}(\omega)=\sum_{M=-J}^{J} e^{-i M \omega}=\sum_{M=-J}^{J} \cos M \omega  \tag{4}\\
& \chi^{J}(\omega)=\sum_{n=0}^{[J]}(-1)^{n} \frac{(2 J-n)!}{(2 J-2 n)!n!}\left(2 \cos \frac{\omega}{2}\right)^{2 J-2 n}  \tag{5}\\
& \chi^{J}(\omega)=\sum_{n=0}^{[J]}(-1)^{n} \frac{(2 J+1)!}{(2 n+1)!(2 J-2 n)!}\left(\cos \frac{\omega}{2}\right)^{2 J-2 n}\left(\sin \frac{\omega}{2}\right)^{2 n}  \tag{6}\\
& \chi^{J}(\omega)=\frac{1}{2 J+1} \frac{d}{d\left(\cos \frac{\omega}{2}\right)} \cos \left[(2 J+1) \frac{\omega}{2}\right]  \tag{7}\\
& \chi^{J}(\omega)=\frac{(2 J+1)!2^{2 J}}{(4 J+1)!\sin \frac{\omega}{2}}\left[-\frac{d}{d\left(\cos \frac{\omega}{2}\right)}\right]^{2 J}\left(\sin \frac{\omega}{2}\right)^{4 J+1} \tag{8}
\end{align*}


(b) Relations to hypergeometric functions


\begin{gather*}
\chi^{J}(\omega)=(2 J+1) F\left(-J, J+1 ; 3 / 2 ; \sin ^{2} \frac{\omega}{2}\right)  \tag{9}\\
\chi^{J}(\omega)=(2 J+1) F\left(-2 J, 2(J+1) ; 3 / 2 ; \sin ^{2} \frac{\omega}{4}\right) \tag{10}
\end{gather*}


(c) Relation to the Chebyshev polynomials of the second kind


\begin{equation*}
\chi^{J}(\omega)=U_{2 J}\left(\cos \frac{\omega}{2}\right) \tag{11}
\end{equation*}


(d) Relation to the Gegenbauer polynomials


\begin{equation*}
\chi^{J}(\omega)=C_{2 J}^{1}\left(\cos \frac{\omega}{2}\right) \tag{12}
\end{equation*}


(e) Relation to the Jacobi polynomials


\begin{equation*}
\chi^{J}(\omega)=\frac{(4 J+2)!!}{2(4 J+1)!!} P_{2 J}^{\left(\frac{1}{2}, \frac{1}{2}\right)}\left(\cos \frac{\omega}{2}\right) \tag{13}
\end{equation*}
...
\begin{equation*}
\chi^{J}(\omega)=\frac{2 J+1}{2} \int_{-1}^{1}\left(\cos \frac{\omega}{2}+i x \sin \frac{\omega}{2}\right)^{2 J} d x \tag{14}
\end{equation*}
...
\begin{equation*}
\cos \frac{\omega}{2}=\cos \frac{\beta}{2} \cos \frac{\alpha+\gamma}{2} . \tag{15}
\end{equation*}


\subsection*{4.14.3. Principal Properties}
In contrast to $D_{M M^{\prime}}^{J}(R)$, the characters $\chi^{J}(R)$ are real.


\begin{equation*}
\left(\chi^{J}(R)\right)^{*}=\chi^{J}(R) \tag{16}
\end{equation*}
...
\begin{equation*}
\chi^{J}\left(R^{-1}\right)=\chi^{J}(R) \tag{17}
\end{equation*}
...
\begin{equation*}
\chi^{J}\left(U R U^{-1}\right)=\chi^{J}(R) \tag{18}
\end{equation*}
...
\begin{equation*}
\chi^{J}\left(R_{1} R_{2} \ldots R_{n}\right)=\chi^{J}\left(R_{2} \ldots R_{n} R_{1}\right) \tag{19}
\end{equation*}
...
\begin{equation*}
\chi^{J}\left(R_{1} R_{2}\right)=\chi^{J}\left(R_{2} R_{1}\right) \tag{20}
\end{equation*}
...
\begin{equation*}
\chi^{J_{1}}(R) \chi^{J_{2}}(R)=\sum_{J}\left\{J_{1} J_{2} J\right\} \chi^{J}(R) \tag{21}
\end{equation*}
...
\chi^{J}(\omega+4 \pi) & =\chi^{J}(\omega),  \tag{23}\\
...
\begin{equation*}
\chi^{J}(\omega)=\sum_{\lambda=0}^{2 J}(-1)^{\lambda} \frac{2 \lambda+1}{2 J+1} \chi_{\lambda}^{J}\left(\omega_{1}\right) \chi_{\lambda}^{J}\left(\omega_{2}\right) P_{\lambda}\left(\cos \Theta_{12}\right), \tag{24}
\end{equation*}
...
\begin{equation*}
\cos \Theta_{12}=\left(n_{1} \cdot n_{2}\right)=\cos \Theta_{1} \cos \Theta_{2}+\sin \Theta_{1} \sin \Theta_{2} \cos \left(\Phi_{1}-\Phi_{2}\right) \tag{25}
\end{equation*}


\subsection*{4.14.4. Differential Equation}
The character $\chi^{J}(\omega)$ satisfies the equation


\begin{equation*}
\frac{d^{2}}{d \omega^{2}} \chi^{J}(\omega)+\cot \frac{\omega}{2} \cdot \frac{d}{d \omega} \chi^{J}(\omega)+J(J+1) \chi^{J}(\omega)=0 \tag{26}
\end{equation*}
...
\begin{align*}
\chi^{J}(0) & =2 J+1 \\
\chi^{J}(\omega \pm 4 \pi n) & =\chi^{J}(\omega), \quad \text { where } n \text { is integer. } \tag{27}
\end{align*}


\subsection*{4.14.5. Differential Relations}

\begin{gather*}
\frac{d}{d \omega} \chi^{J}(\omega)=-\sqrt{J(J+1)} \chi_{1}^{J}(\omega)  \tag{28}\\
\left(\frac{d}{d \cos \frac{\omega}{2}}\right)^{k} \chi^{J}(\omega)=\frac{1}{\sqrt{2 J+1}} \sqrt{\frac{(2 J+k+1)!}{(2 J-k)!}} \frac{\chi_{k}^{J}(\omega)}{\left(\sin \frac{\omega}{2}\right)^{k}} \tag{29}
\end{gather*}
...
\begin{equation*}
\sin \frac{\omega}{2} \frac{d}{d \omega} \chi^{J}(\omega)=J \cos \frac{\omega}{2} \chi^{J}(\omega)-\left(J+\frac{1}{2}\right) \chi^{J-\frac{1}{2}}(\omega)=\left(J+\frac{1}{2}\right) \chi^{J+\frac{1}{2}}(\omega)-(J+1) \cos \frac{\omega}{2} \chi^{J}(\omega) \tag{30}
\end{equation*}


\subsection*{4.14.6. Algebraic Relations}

\begin{align*}
\chi^{J+\frac{1}{2}}(\omega) & =2 \cos \frac{\omega}{2} \cdot \chi^{J}(\omega)-\chi^{J-\frac{1}{2}}(\omega)  \tag{31}\\
\chi^{J_{1}}(\omega)-\chi^{J_{2}}(\omega) & =2 \chi^{\frac{J_{1}-J_{2}-1}{2}}(\omega) \cos \left[\left(J_{1}+J_{2}+1\right) \frac{\omega}{2}\right]  \tag{32}\\
\chi^{J_{1}}(\omega)+\chi^{J_{2}}(\omega) & =2 \chi^{\frac{J_{1}+J_{2}}{2}}(\omega) \cos \left[\left(J_{1}-J_{2}\right) \frac{\omega}{2}\right] \tag{33}
\end{align*}


Equations (32) and (33) are valid, if $J_{1}+J_{2}$ is integer.


\begin{equation*}
\chi^{J-\frac{1}{2}}(\omega)=2 \cos \frac{J \omega}{2} \chi^{\frac{J-1}{2}}(\omega) \tag{34}
\end{equation*}
...
\begin{equation*}
-2 \sin ^{2} \frac{\omega}{2} \chi^{J_{1}}(\omega) \chi^{J_{2}}(\omega)=\cos \left[\left(J_{1}+J_{2}+1\right) \omega\right]-\cos \left[\left(J_{1}-J_{2}\right) \omega\right] \tag{35}
\end{equation*}
...
\begin{gather*}
2 \sin ^{2} \frac{\omega}{2}\left[\chi^{J}(\omega)\right]^{2}=1-\cos [(2 J+1) \omega]  \tag{36}\\
\chi^{J}(\omega)=2^{2 J} \prod_{k=1}^{2 J} \sin \left(\frac{\omega}{2}+\frac{k \pi}{2 J+1}\right) \tag{37}
\end{gather*}


\subsection*{4.14.7. Orthogonality and Completeness}
...
\begin{equation*}
\int_{0}^{2 \pi} \chi^{J_{1}}(\omega) \chi^{J_{2}}(\omega) \sin ^{2} \frac{\omega}{2} d \omega=\pi \delta_{J_{1} J_{2}} \tag{38}
\end{equation*}
...
\begin{equation*}
\sum_{J=0, \frac{1}{2}, 1, \ldots}^{\infty} \chi^{J}\left(\omega_{1}\right) \chi^{J}\left(\omega_{2}\right)=\frac{\pi \delta\left(\omega_{1}-\omega_{2}\right)}{\sin ^{2} \frac{\omega_{1}}{2}} \tag{39}
\end{equation*}


\subsection*{4.14.8. Integrals Involving $\chi^{J}(\omega)$}

\begin{gather*}
\int_{0}^{2 \pi} d \omega \sin ^{2} \frac{\omega}{2} \chi^{J}(\omega)=\pi \delta_{J 0}  \tag{40}\\
\int_{0}^{2 \pi} d \omega \sin ^{2} \frac{\omega}{2} \chi^{J}(2 \omega)=\pi(-1)^{2 J}  \tag{41}\\
\int_{0}^{2 \pi} d \omega \frac{\sin ^{2} \frac{\omega}{2}}{\cos \frac{\omega}{2}-\cos \frac{\Omega}{2}} \chi^{J}(\omega)=-2 \pi \cos \left[(2 J+1) \frac{\Omega}{2}\right] \tag{42}
\end{gather*}


In Eq. (42) the Cauchy principal value of the integral is assumed.


\begin{gather*}
\int_{0}^{2 \pi} d \omega \sin ^{2} \frac{\omega}{2} \chi^{J_{1}}(\omega) \chi^{J_{2}}(\omega)=\pi \delta_{J_{1} J_{2}}  \tag{43}\\
\int_{0}^{2 \pi} d \omega \sin ^{2} \frac{\omega}{2} \chi^{J_{1}}(\omega) \chi^{J_{2}}(\omega) \chi^{J_{3}}(\omega)=\pi\left\{J_{1} J_{2} J_{3}\right\} \tag{44}
\end{gather*}


\subsection*{4.14.9. Sums Involving $\chi^{J}(\omega)$}
(a) Finite sums


\begin{gather*}
\sum_{J=J_{1}, J_{1}+1, \ldots}^{J_{2}} \chi^{J}(\omega)=\frac{\sin \left[\left(J_{2}+J_{1}+1\right) \frac{\omega}{2}\right] \sin \left[\left(J_{2}-J_{1}+1\right) \frac{\omega}{2}\right]}{\sin ^{2} \frac{\omega}{2}}=\chi^{\frac{J_{2}+J_{1}}{2}}(\omega) \chi^{\frac{J_{2}-J_{1}}{2}}(\omega)  \tag{45}\\
\sum_{J=0,1,2, \ldots}^{J_{0}}(2 J+1) \chi^{J}(\omega)=\frac{\left(2 J_{0}+3\right) \sin \left[\left(2 J_{0}+1\right) \frac{\omega}{2}\right]-\left(2 J_{0}+1\right) \sin \left[\left(2 J_{0}+3\right) \frac{\omega}{2}\right]}{4 \sin ^{3} \frac{\omega}{2}} \tag{46}
\end{gather*}


The summation index in Eq. (45) runs over integer values, if $J_{1}$ and $J_{2}$ are integers, or half-integer values, if $J_{1}$ and $J_{2}$ are half-integers.

In the equations given below the summation indices run over both integer and half-integer values:


\begin{gather*}
\sum_{J=J_{1}, J_{1}+\frac{1}{2}, J_{1}+1, \ldots}^{J_{2}} \chi^{J}(\omega)=\frac{\sin \left[\left(J_{2}+J_{1}+1\right) \frac{\omega}{2}\right] \sin \left[\left(J_{2}-J_{1}+\frac{1}{2}\right) \frac{\omega}{2}\right]}{\sin \frac{\omega}{2} \sin \frac{\omega}{4}},  \tag{47}\\
\sum_{J=0, \frac{1}{2}, 1, \ldots}^{J_{0}}(2 J+1) \chi^{J}(\omega)=\frac{\left(2 J_{0}+2\right) \sin \left[\left(2 J_{0}+1\right) \frac{\omega}{2}\right]-\left(2 J_{0}+1\right) \sin \left[\left(2 J_{0}+2\right) \frac{\omega}{2}\right]}{4 \sin \frac{\omega}{2} \sin ^{2} \frac{\omega}{4}},  \tag{48}\\
\sum_{J=0, \frac{1}{2}, 1, \ldots}^{J_{0}}\left[\chi^{J}(\omega)\right]^{2}=\frac{\left(4 J_{0}+3\right) \sin \frac{\omega}{2}-\sin \left[\left(4 J_{0}+3\right) \frac{\omega}{2}\right]}{4 \sin ^{3} \frac{\omega}{2}},  \tag{49}\\
\sum_{J=0, \frac{1}{2}, 1, \ldots}^{J_{0}} \chi^{J}(\omega) \chi^{J}\left(\omega^{\prime}\right)=\frac{\chi^{J_{0}+\frac{1}{2}}(\omega) \chi^{J_{0}}\left(\omega^{\prime}\right)-\chi^{J_{0}}(\omega) \chi^{J_{0}+\frac{1}{2}}\left(\omega^{\prime}\right)}{2\left(\cos \frac{\omega}{2}-\cos \frac{\omega^{\prime}}{2}\right)},  \tag{50}\\
\sum_{J=0, \frac{1}{2}, 1, \ldots}^{J_{0}} \chi^{J}(\omega) \cos \left[(2 J+1) \frac{\omega^{\prime}}{2}\right] \\
=\frac{\sin \frac{\omega}{2}-\cos \left[\left(2 J_{0}+1\right) \frac{\omega^{\prime}}{2}\right] \sin \left[\left(J_{0}+1\right) \omega\right]+\sin \left[\left(2 J_{0}+1\right) \frac{\omega}{2}\right] \cos \left[\left(J_{0}+1\right) \omega^{\prime}\right]}{2 \sin \frac{\omega}{2}\left(\cos \frac{\omega^{\prime}}{2}-\cos \frac{\omega}{2}\right)} . \tag{51}
\end{gather*}
...
\sum_{J=0, \frac{1}{2}, 1, \ldots}^{\infty}(2 J+1) \chi^{J}(\omega)=\frac{\pi}{\sin ^{2} \frac{\omega}{2}} \delta(\omega) \tag{$\{53\}$}
\end{gather*}
...
\begin{gather*}
R^{2} \equiv 1-2 t \cos \frac{\omega}{2}+t^{2}, \quad \text { where }|t|<1:  \tag{54}\\
\sum_{J=0, \frac{1}{2}, 1, \ldots}^{\infty} t^{2 J} \chi^{J}(\omega)=\frac{1}{R^{2}},  \tag{55}\\
\sum_{J=0, \frac{1}{2}, 1, \ldots}^{\infty}(2 J+1) t^{2 J} \chi^{J}(\omega)=\frac{1-t^{2}}{R^{4}},  \tag{56}\\
\sum_{J=0, \frac{1}{2}, 1, \ldots}^{\infty} \frac{(4 J+1)!!}{(4 J+2)!!} t^{2 J} \chi^{J}(\omega)=\frac{1}{R \sqrt{2\left(1-t \cos \frac{\omega}{2}+R\right)}},  \tag{57}\\
\sum_{J=0, \frac{1}{2}, 1 \ldots}^{\infty} \frac{1}{(2 J+1)!} t^{2 J+1} \chi^{J}(\omega)=\frac{\sin \left(t \sin \frac{\omega}{2}\right)}{\sin \frac{\omega}{2}} e^{t \cos \frac{\omega}{2}},  \tag{58}\\
\sum_{J=0, \frac{1}{2}, 1, \ldots}^{\infty} \frac{1}{2 J+1} t^{2 J} \chi^{J}(\omega)=\frac{1}{2 i t \sin \frac{\omega}{2}} \ln \left(\frac{1-t e^{-\frac{i \omega}{2}}}{1-t e^{\frac{i \omega}{2}}}\right),  \tag{59}\\
\sum_{J=0, \frac{1}{2}, 1, \ldots}^{\infty} \sum_{\Gamma(\nu)}^{\Gamma(2 J+\nu)} \frac{t^{2 J} \chi^{J}(\omega)}{(2 J+1)!}=\left(1-t \cos \frac{\omega}{2}\right)^{-\nu}{ }_{2} F_{1}\left(\frac{\nu}{2}, \frac{\nu+1}{2} ; \frac{3}{2} ;-\left(\frac{t \sin \frac{\omega}{2}}{1-t \cos \frac{\omega}{2}}\right)^{2}\right),  \tag{60}\\
\sum_{J=0, \frac{1}{2}, 1, \ldots}^{\infty} \frac{1}{(4 J+2)!}(4 t)^{2 J} \chi^{J}(\omega)=\frac{1}{2}{ }^{0} F_{1}\left(; \frac{3}{2} ;-t \sin ^{2} \frac{\omega}{4}\right)_{0} F_{1}\left(; \frac{3}{2} ; t \cos { }^{2} \frac{\omega}{4}\right),  \tag{61}\\
\sum_{J=0, \frac{1}{2}, 1, \ldots}^{\infty} t^{2 J} \chi^{J}(\omega) \chi^{J}\left(\omega^{\prime}\right)=\frac{1-t^{2}}{1+t^{2}-4 t \cos \frac{\omega}{2} \cos \frac{\omega^{\prime}}{2}+2 t^{2}\left(\cos \omega+\cos \omega^{\prime}\right)} . \tag{62}
\end{gather*}
...
\begin{align*}
\chi^{J}(0) & =2 J+1  \tag{63}\\
\chi^{J}(2 \pi) & =(-1)^{2 J}(2 J+1)  \tag{64}\\
\chi^{J}(\pi) & = \begin{cases}0 & \text { if } J \text { is half-integer } \\
(-1)^{J} & \text { if } J \text { is integer }\end{cases}  \tag{65}\\
...
-\sqrt{2} & J=5 / 2,13 / 2,21 / 2, \ldots\end{cases} \tag{66}
\end{align*}


\subsection*{4.14.11. Special Cases of $\chi^{J}(\omega)$}

\begin{align*}
& \chi^{0}(\omega)=1  \tag{67}\\
& \chi^{\frac{1}{2}}(\omega)=2 \cos \frac{\omega}{2}  \tag{68}\\
& \chi^{1}(\omega)=4 \cos ^{2} \frac{\omega}{2}-1  \tag{69}\\
& \chi^{\frac{3}{2}}(\omega)=8 \cos ^{3} \frac{\omega}{2}-4 \cos \frac{\omega}{2}  \tag{70}\\
& \chi^{2}(\omega)=16 \cos ^{4} \frac{\omega}{2}-12 \cos ^{2} \frac{\omega}{2}+1  \tag{71}\\
& \chi^{\frac{5}{2}}(\omega)=32 \cos ^{5} \frac{\omega}{2}-32 \cos ^{3} \frac{\omega}{2}+6 \cos \frac{\omega}{2} \tag{72}
\end{align*}


\subsection*{4.15. GENERALIZED CHARACTERS, $\chi_{\hat{\lambda}}^{J}(R)$, OF IRREDUCIBLE REPRESENTATIONS OF THE ROTATION GROUP}
\subsection*{4.15.1. Definition}
Let us introduce the function $\chi_{\lambda}^{J}(\omega)$ associated with $\chi^{J}(\omega)$ by the differential relation


\begin{equation*}
\chi_{\lambda}^{J}(\omega)=\sqrt{2 J+1} \sqrt{\frac{(2 J-\lambda)!}{(2 J+\lambda+1)!}}\left(\sin \frac{\omega}{2}\right)^{\lambda}\left(\frac{d}{d \cos \frac{\omega}{2}}\right)^{\lambda} \chi^{J}(\omega) \tag{1}
\end{equation*}


where $\lambda$ is integer, $0 \leq \lambda \leq 2 J$, and $\chi^{J}(\omega)$ is the character of the irreducible representation of rank $J$ (Eq. 4.14(1)).
...
\subsection*{4.15.2 Explicit Forms}
(a) Trigonometric series


\begin{align*}
& \chi_{\lambda}^{J}(\omega)=i^{\lambda} \sum_{M} e^{-i M \omega} C_{J M \lambda 0}^{J M}  \tag{2}\\
& \chi_{\lambda}^{J}(\omega)=\left(\sin \frac{\omega}{2}\right)^{\lambda} \sqrt{2 J+1} \sqrt{\frac{(2 J-\lambda)!}{(2 J+\lambda+1)!}} 2^{\lambda} \sum_{s=0}^{|J-\lambda / 2|} \frac{(-1)^{s}(2 J-s)!}{s!(2 J-\lambda-2 s)!}\left(2 \cos \frac{\omega}{2}\right)^{2 J-\lambda-2 s}  \tag{3}\\
& \chi_{\lambda}^{J}(\omega)=\frac{\left(2 \sin \frac{\omega}{2}\right)^{\lambda}}{\lambda!} \sqrt{2 J+1} \sqrt{\frac{(2 J-\lambda)!}{(2 J+\lambda+1)!}} \sum_{s=0}^{2 J-\lambda} \frac{(\lambda+s)!(2 J-s)!}{s!(2 J-\lambda-s)!} \cos \left[(2 J-\lambda-2 s) \frac{\omega}{2}\right] \tag{4}
\end{align*}
...
\begin{equation*}
\chi_{\lambda}^{J}(\omega)=\frac{1}{\sqrt{2 J+1}} \sqrt{\frac{(2 J-\lambda)!}{(2 J+\lambda+1)!}}\left(\sin \frac{\omega}{2}\right)^{\lambda}\left(\frac{d}{d \cos \frac{\omega}{2}}\right)^{\lambda+1} \cos \left[(2 J+1) \frac{\omega}{2}\right] \tag{5}
\end{equation*}


See also Eq. (1).\\
(c) Relation between $\chi_{\lambda}^{J}(\omega)$ and the Gegenbauer polynomials


\begin{equation*}
\chi_{\lambda}^{J}(\omega)=(2 \lambda)!!\sqrt{2 J+1} \sqrt{\frac{(2 J-\lambda)!}{(2 J+\lambda+1)!}}\left(\sin \frac{\omega}{2}\right)^{\lambda} C_{2 J-\lambda}^{\lambda+1}\left(\cos \frac{\omega}{2}\right) \tag{6}
\end{equation*}


(d) Relations of $\chi_{\lambda}^{J}(\omega)$ to the Jacobi polynomials


\begin{align*}
& \chi_{\lambda}^{J}(\omega)=\frac{\sqrt{2 J+1} \sqrt{(2 J-\lambda)!(2 J+\lambda+1)!}}{(4 J+1)!!} 2^{2 J-\lambda}\left(\sin \frac{\omega}{2}\right)^{\lambda} P_{2 J-\lambda}^{\left(\lambda+\frac{1}{2}, \lambda+\frac{1}{2}\right)}\left(\cos \frac{\omega}{2}\right)  \tag{7}\\
...
(e) Relations of $\chi_{\lambda}^{J}(\omega)$ to the Hypergeometric functions


\begin{gather*}
\chi_{\lambda}^{J}(\omega)=\frac{\sqrt{2 J+1}}{(2 \lambda+1)!!} \sqrt{\frac{(2 J+\lambda+1)!}{(2 J-\lambda)!}}\left(\sin \frac{\omega}{2}\right)^{\lambda} F\left(-2 J+\lambda, 2 J+\lambda+2 ; \lambda+\frac{3}{2} ; \sin ^{2} \frac{\omega}{4}\right)  \tag{9}\\
\chi_{\lambda}^{J}(\omega)=\frac{(-1)^{2 J-\lambda}(2 \lambda)!!\sqrt{2 J+1}}{(2 \lambda+1)!} \sqrt{\frac{(2 J+\lambda+1)!}{(2 J-\lambda)!}}\left(\sin \frac{\omega}{2}\right)^{\lambda} F\left(-2 J+\lambda, 2 J+\lambda+2 ; \lambda+\frac{3}{2} ; \cos ^{2} \frac{\omega}{4}\right)  \tag{10}\\
...
\times F\left(-2 J+\lambda,-2 J-\frac{1}{2} ;-4 J-1 ; \frac{1}{\sin ^{2} \frac{\omega}{2}}\right)  \tag{11}\\
...
\times F\left(-J+\frac{1}{2}, \frac{-2 J+\lambda+1}{2} ;-2 J ; \frac{1}{\cos ^{2} \frac{\omega}{2}}\right)  \tag{12}\\
...
\times F\left(-2 J+\lambda,-2 J-\frac{1}{2} ; \lambda+\frac{3}{2} ;-\tan ^{2} \frac{\omega}{4}\right) \tag{13}
\end{gather*}



\begin{align*}
\chi_{\lambda}^{J}(\omega)= & \frac{\sqrt{2 J+1}(2 J)!i^{\lambda}}{\sqrt{(2 J-\lambda)!(2 J+\lambda+1)!}}\left(e^{-\frac{i \omega}{2}}-e^{\frac{i \omega}{2}}\right)^{\lambda} e^{ \pm i \frac{\omega}{2}(2 J-\lambda)} F\left(-2 J+\lambda, \lambda+1 ;-2 J ; e^{\mp i \omega}\right)  \tag{14}\\
...
\begin{align*}
& \chi_{\lambda}^{J}(\omega)=\frac{1}{2} \frac{1}{\lambda!} \sqrt{\frac{(2 J+1)(2 J+\lambda+1)!}{(2 J-\lambda)!}} \frac{1}{\left(\sin \frac{\omega}{2}\right)^{\lambda+1}} \int_{0}^{\omega} \cos \left[(2 J+1) \frac{\psi}{2}\right]\left(\cos \frac{\psi}{2}-\cos \frac{\omega}{2}\right)^{\lambda} d \psi  \tag{17}\\
& \chi_{\lambda}^{J}(\omega)=(-i)^{\lambda} \frac{\sqrt{(2 J+1)(2 J+\lambda+1)!(2 J-\lambda)!}}{2(2 J)!} \int_{-1}^{+1} P_{\lambda}(x)\left[\cos \frac{\omega}{2}+i x \sin \frac{\omega}{2}\right]^{2 J} d x \tag{18}
\end{align*}


\subsection*{4.15.3. Principal Properties}
(a) Symmetries


\begin{align*}
\chi_{\lambda}^{J *}(\omega) & =\chi_{\lambda}^{J}(\omega)=(-1)^{\lambda} \chi_{\lambda}^{J}(-\omega)  \tag{19}\\
\chi_{\lambda}^{J}(\omega+2 \pi n) & =(-1)^{2 J n} \chi_{\lambda}^{J}(\omega), \quad \chi_{\lambda}^{J}(2 \pi-\omega)=(-1)^{2 J-\lambda} \chi_{\lambda}^{J}(\omega) \tag{20}
\end{align*}


(b) Particular values of $\omega$
...
0 & \text { if } 2 J-\lambda \text { is odd } .\end{cases} \tag{21}
\end{align*}
...
\begin{gather*}
2 \frac{d}{d \omega} \chi_{\lambda}^{J}(\omega)=\frac{\lambda}{2 \lambda+1} \sqrt{(2 J+1)^{2}-\lambda^{2}} \chi_{\lambda-1}^{J}(\omega)-\frac{\lambda+1}{2 \lambda+1} \sqrt{(2 J+1)^{2}-(\lambda+1)^{2}} \chi_{\lambda+1}^{J}(\omega),  \tag{22}\\
(2 \lambda+1) \cot \frac{\omega}{2} \chi_{\lambda}^{J}(\omega)=\sqrt{(2 J+1)^{2}-\lambda^{2}} \chi_{\lambda-1}^{J}(\omega)+\sqrt{(2 J+1)^{2}-(\lambda+1)^{2}} \chi_{\lambda+1}^{J}(\omega) . \tag{23}
\end{gather*}
...
\begin{equation*}
\lim _{\substack{J \rightarrow \infty \\ \omega \rightarrow 0}} \frac{1}{2 J+1} \chi_{\lambda}^{J}(\omega)=j_{\lambda}(x) \tag{24}
\end{equation*}
...
\begin{equation*}
\chi_{\lambda}^{J}(\omega) \approx\left(\frac{\omega}{2}\right)^{\lambda} \frac{1}{(2 \lambda+1)!!} \sqrt{(2 J+1) \frac{(2 J+\lambda+1)!}{(2 J-\lambda)!}} \tag{25}
\end{equation*}


\subsection*{4.15.4. Differential Equation}
The functions $\chi_{\lambda}^{J}(\omega)$ are solutions of the linear differential equation


\begin{equation*}
\frac{d^{2}}{d \omega^{2}} \chi_{\lambda}^{J}(\omega)+\cot \frac{\omega}{2} \frac{d}{d \omega} \chi_{\lambda}^{J}(\omega)+\left[J(J+1)-\frac{\lambda(\lambda+1)}{4 \sin ^{2} \frac{\omega}{2}}\right] \chi_{\lambda}^{J}(\omega)=0 \tag{26}
\end{equation*}
...
\begin{equation*}
\chi_{\lambda}^{J}(0)=(2 J+1) \delta_{\lambda 0}, \quad \chi_{\lambda}^{J}(2 \pi)=(-1)^{2 J}(2 J+1) \delta_{\lambda 0} . \tag{27}
\end{equation*}


\subsection*{4.15.5. Orthogonality and Completeness}
...
\begin{equation*}
\int_{0}^{2 \pi} d \omega \sin ^{2} \frac{\omega}{2} \chi_{\lambda}^{J_{1}}(\omega) \chi_{\lambda}^{J_{2}}(\omega)=\pi \delta_{J_{1} J_{2}} \tag{28}
\end{equation*}
...
\begin{equation*}
\sum_{J=0, \frac{1}{2}, 1, \ldots}^{\infty} \chi_{\lambda}^{J}\left(\omega_{1}\right) \chi_{\lambda}^{J}\left(\omega_{2}\right)=\frac{\pi \delta\left(\omega_{1}-\omega_{2}\right)}{\sin ^{2} \frac{\omega_{1}}{2}} \tag{29}
\end{equation*}


\subsection*{4.15.6. The Addition Theorem for $\chi_{\lambda}^{J}(\omega)$}
...
\begin{equation*}
\chi_{\lambda}^{J}(\omega)=\sqrt{\frac{(2 J-\lambda)!}{(2 J+\lambda+1)!(2 J+1)}}\left(\frac{\sin \frac{\omega}{2}}{\sin \frac{\omega_{1}}{2} \sin \frac{\omega_{2}}{2} \sin \chi}\right)^{\lambda} \sum_{l=\lambda}^{2 J}(-1)^{l}(2 l+1) P_{l}^{\lambda}(\cos \chi) \chi_{l}^{J}\left(\omega_{1}\right) \chi_{l}^{J}\left(\omega_{2}\right), \tag{30}
\end{equation*}


where $P_{i}^{\lambda}(\cos \chi)$ is an associated Legendre function, $\chi$ is an angle between the rotation axes $\mathbf{n}_{1}\left(\Theta_{1}, \Phi_{1}\right)$ and $\mathbf{n}_{2}\left(\Theta_{2}, \Phi_{2}\right)$

\[
\cos \chi=\left(\begin{array}{ll}
\mathbf{n}_{1} & \mathbf{n}_{2} \tag{31}
...
\begin{equation*}
\cos \frac{\omega}{2}=\cos \frac{\omega_{1}}{2} \cos \frac{\omega_{2}}{2}-\sin \frac{\omega_{1}}{2} \sin \frac{\omega_{2}}{2} \cos \chi \tag{32}
\end{equation*}


\subsection*{4.15.7. Sums and Infinite Series Involving $\chi_{\lambda}^{J}(\omega)$}
(a) Summation over $\lambda$


\begin{align*}
& \sum_{\lambda=0}^{2 J}( \pm 1)^{\lambda} i^{\lambda} \frac{2 \lambda+1}{2 J+1} \chi_{\lambda}^{J}(\omega) C_{J M \lambda 0}^{J M}=e^{ \pm i M \omega}, \quad(|M| \leq J)  \tag{33}\\
& \sum_{\lambda=0,2, \ldots}^{\leq 2 J}(-i)^{\lambda} \frac{2 \lambda+1}{2 J+1} \chi_{\lambda}^{J}(\omega) C_{J M \lambda 0}^{J M}=\cos M \omega, \quad(|M| \leq J)  \tag{34}\\
& \sum_{\lambda=1,3, \ldots}^{\leq 2 J}(-i)^{\lambda-1} \frac{2 \lambda+1}{2 J+1} \chi_{\lambda}^{J}(\omega) C_{J M \lambda 0}^{J M}=\sin M \omega, \quad(|M| \leq J) \tag{35}
\end{align*}


In Eqs. (33)-(35) $J \geq|M|$ is an arbitrary integer or half-integer.


\begin{gather*}
\sum_{\lambda=0,2, \ldots}^{\leq 2 l} \frac{2 \lambda+1}{2 l+1} \frac{(\lambda-1)!!}{\lambda!!} \chi_{\lambda}^{l}(\vartheta) C_{l 0 \lambda 0}^{l 0}=P_{l}(\cos \vartheta),  \tag{36}\\
\sum_{\lambda=|m|}^{2 l} \frac{2 \lambda+1}{2 l+1} \sqrt{\frac{(\lambda+m-1)!!(\lambda-m-1)!!}{(\lambda+m)!!(\lambda-m)!!}} \chi_{\lambda}^{l}(\vartheta) C_{l 0 \lambda m}^{l m}=\sqrt{\frac{4 \pi}{2 l+1}} Y_{l m}(\vartheta, 0),  \tag{37}\\
(\lambda+m \text { is even }), \\
\sum_{\lambda=\left|M^{\prime}-M\right|}^{\leq 2 l}(-1)^{\lambda} \frac{2 \lambda+1}{2 J+1} \sqrt{\frac{\left(\lambda+M^{\prime}-M-1\right)!!\left(\lambda-M^{\prime}+M-1\right)!!}{\left(\lambda+M^{\prime}-M\right)!!\left(\lambda-M^{\prime}+M\right)!!}} \chi_{\lambda}^{J}(\beta) C_{J M \lambda M^{\prime}-M}^{J M^{\prime}}=d_{M M^{\prime}}^{J}(\beta),  \tag{38}\\
\left(\lambda+M^{\prime}-M \text { is even }\right) . \\
(\mathrm{b}) S u m m a t i o n^{\prime} \text { over } J \\
...
=\frac{\left(2 t \sin \frac{\omega}{2}\right)^{\nu}}{[(2 \nu+1)!!]^{2} \circ F_{1}\left(; \nu+\frac{3}{2} ;-t \sin ^{2} \frac{\omega}{4}\right)_{0} F_{1}\left(; \nu+\frac{3}{2} ; t \cos ^{2} \frac{\omega}{4}\right) .} \tag{44}
\end{gather*}


The right-hand sides of Eqs. (39)-(44) may be treated as generating functions of $\chi_{\lambda}^{J}(\omega)$.

\subsection*{4.15.8. Special Cases of $\chi_{\lambda}^{J}(\omega)$ for Particular $\lambda$}
(a) For $\lambda=2 J, 2 J-1,2 J-2,2 J-3$ the function $\chi_{\lambda}^{J}(\omega)$ is given by


\begin{align*}
\chi_{2 J}^{J}(\omega) & =\sqrt{2 J+1} \sqrt{\frac{(4 J)!!}{(4 J+1)!!}}\left(\sin \frac{\omega}{2}\right)^{2 J}  \tag{45}\\
\chi_{2 J-1}^{J}(\omega) & =\sqrt{2 J+1} \sqrt{\frac{(4 J)!!}{(4 J-1)!!}}\left(\sin \frac{\omega}{2}\right)^{2 J-1} \cos \frac{\omega}{2}  \tag{46}\\
\chi_{2 J-2}^{J}(\omega) & =\sqrt{2 J+1} \sqrt{\frac{(4 J-2)!!}{2(4 J-1)!!}}\left(\sin \frac{\omega}{2}\right)^{2 J-2}\left[4 J \cos ^{2} \frac{\omega}{2}-1\right]  \tag{47}\\
\chi_{2 J-3}^{J}(\omega) & =\sqrt{2 J+1} \sqrt{\frac{(4 J-2)!!}{6(4 J-3)!!}}\left(\sin \frac{\omega}{2}\right)^{2 J-3}\left[4 J \cos ^{3} \frac{\omega}{2}-3 \cos \frac{\omega}{2}\right] \tag{48}
\end{align*}


(b) When $\lambda=0,1,2$ one has


\begin{align*}
& \chi_{0}^{J}(\omega)=\frac{\sin (2 J+1) \frac{\omega}{2}}{\sin \frac{\omega}{2}}=\frac{\cos J \omega-\cos (J+1) \omega}{1-\cos \omega}  \tag{49}\\
& \chi_{1}^{J}(\omega)=\frac{-1}{\sqrt{J(J+1)}} \frac{2 J \cos (2 J+1) \frac{\omega}{2} \sin \frac{\omega}{2}-\sin J \omega}{2 \sin ^{2} \frac{\omega}{2}}=\frac{-1}{\sqrt{J(J+1)}} \frac{J \sin (J+1) \omega-(J+1) \sin J \omega}{1-\cos \omega}  \tag{50}\\
& \chi_{2}^{J}(\omega)=\frac{1}{\sqrt{J(J+1)(2 J-1)(2 J+3)}}\left\{\frac{\left[3-2 J(2 J-1) \sin ^{2} \frac{\omega}{2}\right] \sin (2 J+1) \frac{\omega}{2}}{2 \sin ^{3} \frac{\omega}{2}}-\frac{3}{2}(2 J+1) \frac{\cos J \omega}{\sin ^{2} \frac{\omega}{2}}\right\} \tag{51}
\end{align*}


(c) $\chi_{\lambda}^{J}(\omega)$ may be expressed in terms of derivatives of $\chi^{J}(\omega)$
...
\chi_{3}^{J}(\omega)= & -4 \sqrt{2 J+1} \sqrt{\frac{(2 J-3)!}{(2 J+4)!}}\left\{[3 J(J+1)-1] \frac{d \chi^{J}(\omega)}{d \omega}+5 \frac{d^{3} \chi^{J}(\omega)}{d \omega^{3}}\right\}  \tag{52}\\
...
\subsection*{4.15.9. Special Cases of $\chi_{\lambda}^{J}(\omega)$ for Particular $J$}
\[
\begin{array}{ll}
...
& \chi_{2}^{\frac{3}{2}}(\omega)=\frac{8}{\sqrt{5}}\left(\sin \frac{\omega}{2}\right)^{2} \cos \frac{\omega}{2}=\frac{4}{\sqrt{5}} \sin \frac{\omega}{2} \sin \omega,  \tag{53}\\
...
\subsection*{4.16. $D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)$ FOR PARTICULAR VALUES OF THE ARGUMENTS}
Here $k, l$ and $n$ are integers.


\begin{gather*}
D_{M M^{\prime}}^{J}(0,0,0)=\delta_{M M^{\prime}}  \tag{1}\\
D_{M M^{\prime}}^{J}(\alpha, 0, \gamma)=\delta_{M M^{\prime}} e^{-i M(\alpha+\gamma)}  \tag{2}\\
D_{M M^{\prime}}^{J}(\alpha, \pm 2 n \pi, \gamma)=\delta_{M M^{\prime}}(-1)^{2 n J} e^{-i M(\alpha+\gamma)} \tag{3}
\end{gather*}



\begin{gather*}
D_{M M^{\prime}}^{J}(\alpha, \pm(2 n+1) \pi, \gamma)=\delta_{-M M^{\prime}}(-1)^{ \pm(2 n+1) J+M} e^{-i M(\alpha-\gamma)},  \tag{4}\\
D_{M M^{\prime}}^{J}\left(\alpha, \frac{\pi}{2}, \gamma\right)=(-1)^{M-M^{\prime}} e^{-i \alpha M-i \gamma M^{\prime}} \frac{1}{2^{J}} \sqrt{\frac{(J+M)!(J-M)!}{\left(J+M^{\prime}\right)!\left(J-M^{\prime}\right)!}} \sum_{k}(-1)^{k}\binom{J+M^{\prime}}{k}\binom{J-M^{\prime}}{k+M-M^{\prime}} \tag{5}
\end{gather*}


Some particular cases of Eq. (5) are given by
...
D_{0 m}^{l}\left(\alpha, \frac{\pi}{2}, \gamma\right)=(-1)^{\frac{l-m}{2}} \delta_{l-m, 2 n} \frac{\sqrt{(l-m)!(l+m)!}}{2^{l}\left(\frac{l+m}{2}\right)!\left(\frac{l-m}{2}\right)!} e^{-i m \gamma},  \tag{6}\\
D_{00}^{l}\left(\alpha, \frac{\pi}{2}, \gamma\right)=P_{l}(0)=\delta_{l, 2 n}(-1)^{l / 2} \frac{(l-1)!!}{l!!},  \tag{7}\\
...
\left.\mp \delta_{l+m, 2 k+1} \frac{(-1)^{\frac{l-m-1}{2}}}{2^{l-1}\left(\frac{l-m-1}{2}\right)!\left(\frac{l+m-1}{2}\right)!}\right\} e^{\mp i \alpha-i m \gamma} . \tag{8}
\end{gather*}
...
\begin{equation*}
\left[D_{M M^{\prime}}^{J}\left(\alpha, \frac{\pi}{2}, \gamma\right)\right]^{2}=e^{-i 2 M \alpha-i 2 M^{\prime} \gamma}(-1)^{M-M^{\prime}} \sum_{l=0,2,4, \ldots}(-1)^{l / 2} \frac{(l-1)!!}{l!!} C_{J M J-M}^{l 0} C_{J M^{\prime} J-M^{\prime}}^{l 0} \tag{9}
\end{equation*}
...
& =\sum_{m_{i}} D_{M m_{1}}^{J}(\alpha, 0,0) D_{m_{1} m_{2}}^{J}\left(0, \frac{\pi}{2}, 0\right) D_{m_{2} m_{3}}^{J}(\beta, 0,0) D_{m_{3} m_{4}}^{J}\left(0, \frac{\pi}{2}, 0\right) D_{m_{4} M^{\prime}}^{J}(0,0, \gamma)  \tag{10}\\
...
4.17. SPECIAL CASES OF $D_{M M^{\prime}}^{J}$ FOR PARTICULAR $M$ OR $M^{\prime}$\\
(a) $M=0$ and/or $M^{\prime}=0$


\begin{align*}
& D_{m 0}^{l}(\alpha, \beta, \gamma)=(-1)^{m} \sqrt{\frac{4 \pi}{2 l+1}} Y_{l-m}(\beta, \alpha)=\sqrt{\frac{4 \pi}{2 l+1}} Y_{l m}^{*}(\beta, \alpha), \\
& D_{0 m}^{l}(\alpha, \beta, \gamma)=\sqrt{\frac{4 \pi}{2 l+1}} Y_{l-m}(\beta, \gamma)=(-1)^{m} \sqrt{\frac{4 \pi}{2 l+1}} Y_{l m}^{*}(\beta, \gamma) \tag{1}
\end{align*}
...
D_{0 \pm 1}^{l}(\alpha, \beta, \gamma) & = \pm e^{\mp i \gamma} \frac{\sin \beta}{\sqrt{l(l+1)}} P_{l}^{\prime}(\cos \beta)  \tag{2}\\
...
(b) $M= \pm 1 / 2$ and/or $M^{\prime}= \pm 1 / 2$
...
D_{M \pm \frac{1}{2}}^{J}(\alpha, \beta, \gamma)=(-1)^{ \pm \frac{1}{2}-M} e^{\mp i \frac{\alpha-\alpha}{2}} \frac{\sqrt{\pi}}{\sqrt{2 J+1} \sin \frac{\beta}{2}}\left\{ \pm \sqrt{\frac{J \pm M+1}{J+1}} Y_{J+\frac{1}{2} \mp \frac{1}{2}-M}(\beta, \alpha)\right.  \tag{3}\\
...
D_{-\frac{1}{2} \frac{1}{2}}^{J}(\alpha, \beta, \gamma) & =e^{i \frac{\alpha-\alpha}{2}} \frac{\sin \frac{\beta}{2}}{J+\frac{1}{2}}\left\{P_{J+\frac{1}{2}}^{\prime}(\cos \beta)+P_{J-\frac{1}{2}}^{\prime}(\cos \beta)\right\}  \tag{4}\\
D_{-\frac{1}{2}-\frac{1}{2}}^{J}(\alpha, \beta, \gamma) & =e^{i \frac{\alpha+\alpha}{2}} \frac{\cos \frac{\beta}{2}}{J+\frac{1}{2}}\left\{P_{J+\frac{1}{2}}^{\prime}(\cos \beta)-P_{J-\frac{1}{2}}^{\prime}(\cos \beta)\right\}
\end{align*}


(c) $M= \pm 1$ and/or $M^{\prime}= \pm 1$
...
D_{m \pm 1}^{l}(\alpha, \beta, \gamma)=e^{\mp i \gamma}(-1)^{m+1} \sqrt{\frac{4 \pi}{l(l+1)(2 l+1)}}\left\{\mp \sqrt{(l-m)(l+m+1)} \frac{1 \mp \cos \beta}{2} Y_{l-m-1}(\beta, \alpha) e^{i \alpha}\right.  \tag{5}\\
...
D_{ \pm 1-1}^{l}(\alpha, \beta, \gamma) & =e^{\mp i \alpha+i \gamma} \frac{1 \mp \cos \beta}{l(l+1)}\left\{P_{l}^{\prime}(\cos \beta) \pm(1 \pm \cos \beta) P_{l}^{\prime \prime}(\cos \beta)\right\} \tag{6}
\end{align*}


(d) $M= \pm(J-1)$ and/or $M^{\prime}= \pm(J-1)$
...
\times[J \cos \beta+m], \\
D_{m J-1}^{J}(\alpha, \beta, \gamma)=e^{-i(J-1) \gamma-i m \alpha} \sqrt{\frac{(2 J-1)!}{(J+m)!(J-m)!}}\left(\cos \frac{\beta}{2}\right)^{J+m-1}\left(\sin \frac{\beta}{2}\right)^{J-m-1}  \tag{7}\\
\times[J \cos \beta-m], \\
...
D_{-J M}^{J}(\alpha, \beta, \gamma) & =\sqrt{\frac{(2 J)!}{(J+M)!(J-M)!}}\left(\cos \frac{\beta}{2}\right)^{J-M}\left(\sin \frac{\beta}{2}\right)^{J+M} e^{i J \alpha-i M \gamma} \\
D_{M J}^{J}(\alpha, \beta, \gamma) & =\sqrt{\frac{(2 J)!}{(J+M)!(J-M)!}}\left(\cos \frac{\beta}{2}\right)^{J+M}\left(\sin \frac{\beta}{2}\right)^{J-M} e^{-i M \alpha-i J \gamma}  \tag{8}\\
...
\subsection*{4.18. ASYMPTOTICS OF $D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)$}
\subsection*{4.18.1. Large Angular Momentum}
If $J \gg 1$, one has


\begin{align*}
D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma) \approx & e^{-i M \alpha-i M^{\prime} \gamma} \xi_{M M^{\prime}} \sqrt{\frac{s!(s+\mu+\nu)!}{(s+\mu)!(s+\nu)!}} \\
& \times \sqrt{\frac{2}{\pi s}} \frac{\cos \left[\left(s+\frac{\mu+\nu+1}{2}\right) \beta-\frac{\pi}{4}(2 \mu+1)\right]}{\sqrt{\sin \beta}}+O\left(\frac{1}{J^{\frac{3}{2}}}\right) \tag{1}
\end{align*}


where $s, \mu, \nu$ are related to $J, M, M^{\prime}$ through Eqs. 4.3(14), and $\xi_{M M^{\prime}}$ is defined by Eq. 4.3(15).\\
If $J \rightarrow \infty$ and $\beta \rightarrow 0$, while $J \beta<\infty$, then


\begin{equation*}
D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma) \approx e^{-i M \alpha-i M^{\prime} \gamma} J_{M-M^{\prime}}(J \beta) . \tag{2}
\end{equation*}


Here $J_{n}(x)$ is the Bessel function.

\subsection*{4.18.2. Small Variation of Rotation Axis}
...
\subsection*{4.18.3. Infinitesimal Rotations}
(a) Rotation $\varepsilon$ about the $x$-Axis


\begin{gather*}
\lim _{\varepsilon \rightarrow 0} \frac{1}{\varepsilon}\left[D_{M M^{\prime}}^{J}\left(-\frac{\pi}{2}, \varepsilon, \frac{\pi}{2}\right)-\delta_{M M^{\prime}}\right]=-i\langle J M| \widehat{J}_{x}\left|J M^{\prime}\right\rangle \\
=-\frac{i}{2} \delta_{M M^{\prime}+1} \sqrt{\left(J-M^{\prime}\right)\left(J+M^{\prime}+1\right)}-\frac{i}{2} \delta_{M M^{\prime}-1} \sqrt{\left(J+M^{\prime}\right)\left(J-M^{\prime}+1\right)} \tag{5}
\end{gather*}


(b) Rotation $\varepsilon$ about the $y$-Axis


\begin{gather*}
\lim _{\varepsilon \rightarrow 0} \frac{1}{\varepsilon}\left[D_{M M^{\prime}}^{J}(0, \varepsilon, 0)-\delta_{M M^{\prime}}\right]=-i\langle J M| \widehat{J}_{y}\left|J M^{\prime}\right\rangle \\
=-\frac{1}{2} \delta_{M M^{\prime}+1} \sqrt{\left(J-M^{\prime}\right)\left(J+M^{\prime}+1\right)}+\frac{1}{2} \delta_{M M^{\prime}-1} \sqrt{\left(J+M^{\prime}\right)\left(J-M^{\prime}+1\right)} \tag{6}
\end{gather*}


(c) Rotation $\varepsilon$ about the $z$-Axis


\begin{equation*}
\lim _{\varepsilon \rightarrow 0} \frac{1}{\varepsilon}\left[D_{M M^{\prime}}(\varepsilon, 0,0)-\delta_{M M^{\prime}}\right]=-i\langle J M| \widehat{J}_{z}\left|J M^{\prime}\right\rangle=-i M \delta_{M M^{\prime}} \tag{7}
\end{equation*}


(d) Rotation $\varepsilon$ about an Arbitrary Axis $\mathbf{n}(\Theta, \Phi)$


\begin{gather*}
\lim _{\ell \rightarrow 0} \frac{1}{\varepsilon}\left[D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)-\delta_{M M^{\prime}}\right]=-i\langle J M| \widehat{\mathbf{J}} \cdot \mathbf{n}\left|J M^{\prime}\right\rangle=-i M \cos \Theta \delta_{M M^{\prime}} \\
-\frac{i}{2} \sin \Theta e^{-i \Phi} \sqrt{\left(J-M^{\prime}\right)\left(J+M^{\prime}+1\right)} \delta_{M M^{\prime}+1}-\frac{i}{2} \sin \Theta e^{i \Phi} \sqrt{\left(J+M^{\prime}\right)\left(J-M^{\prime}+1\right)} \delta_{M M^{\prime}-1} \tag{8}
\end{gather*}


In Eqs. (5)-(8) $\widehat{\mathrm{J}}$ is the operator of angular momentum defined in Sec.2.1.

\subsection*{4.19. DEFINITIONS OF $D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)$ BY OTHER AUTHORS}
...
(f) in accepting different phases of non-diagonal elements in Eqs. 4.2(4) and 4.2(5).
...
\subsection*{4.20. SPECIAL CASES OF $d_{M M^{\prime}}^{J}(\beta)$ FOR PARTICULAR $J, M$ AND $M^{\prime}$}
General expressions for the $D$-functions, Eqs. 4.3(2)-(5), may be reduced to simple closed forms for particular values of $J$. Explicit forms of $d_{M M^{\prime}}^{J}(\beta)$ for $J \leq 5$ are presented in Tables 4.3-4.12. $d_{M M^{\prime}}^{J}(\beta)$ are given in terms of either $\cos \beta$ and $\sin \beta$ (if $J$ is integer), or $\cos (\beta / 2)$ and $\sin (\beta / 2)$ (if $J$ is half-integer). Expressions for $d_{M M^{\prime}}^{J}(\beta)$ for $J \geq 5 / 2$ are presented for $M \geq 0$ and $\left|M^{\prime}\right| \leq M$ only. For $M<0$ and $\left|M^{\prime}\right|>M$ one can obtain $d_{M M^{\prime}}^{J}(\beta)$ using the symmetry properties (Sec. 4.4).
...
\subsection*{4.21. TABLES OF $d_{M M^{\prime}}^{J}(\beta)$ FOR $\beta=\pi / 2$}
...
\subsection*{4.22. SPECIAL CASES OF $U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi)$}
...
\captionsetup{labelformat=empty}
\caption{Table 4.2.\\
Definitions of the Rotation Matrix by Other Authors.}
\begin{tabular}{|l|l|l|l|}
\hline
...
\begin{center}
\captionsetup{labelformat=empty}
\caption{Table 4.7. $d_{M M^{\prime}}^{5 / 2}(\beta)$}
\begin{tabular}{|l|l|l|l|}
\hline
...
\begin{center}
\captionsetup{labelformat=empty}
\caption{Table 4.12. $d_{M M^{\prime}}^{5}(\beta)$}
\begin{tabular}{|l|l|l|l|}
\hline
...
$d_{M M^{\prime}}^{1 / 2}\left(\frac{\pi}{2}\right)$
...
$d_{M M^{\prime}}^{1}\left(\frac{\pi}{2}\right)$
...
$$
d_{M M^{\prime}}^{3 / 2}\left(\frac{\pi}{2}\right)
$$
...
$d_{M M^{\prime}}^{2}\left(\frac{\pi}{2}\right)$
...
$d_{M M^{\prime}}^{5 / 2}\left(\frac{\pi}{2}\right)$
...
$d_{M M^{\prime}}^{3}\left(\frac{\pi}{2}\right)$
...
$$
d_{M M^{\prime}}^{7 / 2}\left(\frac{\pi}{2}\right)
$$
...
Table 4.20.\\
$d_{M M^{\prime}}^{4}\left(\frac{\pi}{2}\right)$
...
Table 4.21.\\
$d_{M M^{\prime}}^{9 / 2}\left(\frac{\pi}{2}\right)$
...
\end{tabular}
\captionsetup{labelformat=empty}
\caption{Tables 4.23. -4.26. Explicit forms of $U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi)$.}
\end{center}
\end{table}
...
$$
U_{M M^{\prime}}^{3 / 2}(\omega ; \Theta, \Phi)
$$
...
$$
U_{M M^{\prime}}^{2}(\omega ; \Theta, \Phi)
$$
