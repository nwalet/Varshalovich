...
\begin{equation}
\Psi_{J}(\vartheta, \varphi)=\sum_{M=-J}^{J} C_{J}^{M} \Psi_{J M}(\vartheta, \varphi)=\left(\vect{C}_{J} \cdot \Psi_{J}\right) . \label{eq:4:1:8}
\end{equation}
...
(i) by rotating about the initial axes (case B in Sec. \ref{sec:1.4.1}), or\\
(ii) by rotating about the new (turned) axes (case A in Sec. \ref{sec:1.4.1}).
...
\begin{gather}
\widehat{J}^{ \pm 1}=\frac{i}{\sqrt{2}} e^{\mp i \gamma}\left[ \pm \cot \beta \frac{\partial}{\partial \gamma}+i \frac{\partial}{\partial \beta} \mp \frac{1}{\sin \beta} \cdot \frac{\partial}{\partial \alpha}\right]  \label{eq:4:2:7}\\
...
& =\hat{J}^{0}\left(\hat{J}^{0}-1\right)-2 \hat{J}^{-1} \hat{J}^{+1}=\hat{J}_{0}\left(\hat{J}_{0}-1\right)-2 \hat{J}_{+1} \hat{J}_{-1}=\hat{J}^{0}\left(\hat{J}^{0}+1\right)-2 \hat{J}^{+1} \hat{J}^{-1} \label{eq:4:2:8}
\end{align}
...
\hat{J}_{\nu}(\alpha, \beta, \gamma) & =\sum_{\mu} D_{\nu \mu}^{1 *}(\alpha, \beta, \gamma) \hat{J}^{\mu}(\alpha, \beta, \gamma) \label{eq:4:2:9}
\end{align}
Hence
\begin{equation}
...
& {\left[\hat{J}_{i}, \hat{J}_{k}\right]=i \varepsilon_{i k l}, \hat{J}_{l},}  \label{eq:4:2:12}\\
...
\hat{J}_{i}(0, \vartheta, \varphi) & =\hat{L}_{i}^{\prime}(\vartheta, \varphi), & & i=x, y, z \label{eq:4:2:14}
\end{align}
...
& \quad \times \sum_{k}(-1)^{k} \frac{\left(\cos \frac{\beta}{2}\right)^{2 J-2 k-M+M^{\prime}}\left(\sin \frac{\beta}{2}\right)^{2 k+M-M^{\prime}}}{k!(J-M-k)!\left(J+M^{\prime}-k\right)!\left(M-M^{\prime}+k\right)!} \label{eq:4:3:5}
\end{align}
...
& \times\left(i z \sin \frac{\beta}{2}+\cos \frac{\beta}{2}\right)^{J+M^{\prime}} z^{M-J-1} d z \label{eq:4:3:12}
\end{align}
...
(a) In accordance with Eqs. \eqref{eq:4:3:2}-\eqref{eq:4:3:5} the functions $d_{M M^{\prime}}^{J}(\beta)$ are real and satisfy the relations
\begin{equation}
\left.\begin{array}{rl}
...
d_{M M^{\prime}}^{J}(\beta \pm 2 \pi n) & =(-1)^{2 J n} d_{M M^{\prime}}^{J}(\beta),  \label{eq:4:4:1}\\
d_{M M^{\prime}}^{J}(\beta \pm(2 n+1) \pi) & =(-1)^{ \pm(2 n+1) J-M^{\prime}} d_{M-M^{\prime}}^{J}(\beta),
\end{array}\right\} n \text { is integer }
\end{equation}
(b) Equations \eqref{eq:4:4:1} imply the following symmetry properties of $D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)$
\[
\begin{array}{llll} 
...
\subsection{Deflnition}\label{sec:4.5.1}
...
\end{equation}
The polar angles $\vartheta, \varphi$ and $\vartheta^{\prime}, \varphi^{\prime}$ which specify a direction of an arbitrary vector in the initial and rotated coordinate systems in terms $\omega, \Theta, \Phi$ are related by Eqs. \eqref{eq:1.4:$2:$3} and \eqref{eq:1.4:$2:$3}.
...
(b) According to Eq. \eqref{eq:4:5:10} the functions $U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi)$ may be directly constructed from the matrix elements $U_{m m^{\prime}}^{\frac{1}{2}}$ which represent the Cayley-Klein parameters (see Eq. \eqref{eq:4:5:12}). This gives the expression
\begin{equation}
U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi)=\left\{\begin{array}{cc}
(-i v)^{2 J}\left(\frac{u}{-i v}\right)^{\left(M+M^{\prime}\right)} e^{-i\left(M-M^{\prime}\right) \Phi} \sum_{v} \frac{\sqrt{(J+M)!(J-M)!\left(J+M^{\prime}\right)!\left(J-M^{\prime}\right)!}}{s!\left(s+M+M^{\prime}\right)!(J-M-s)!\left(J-M^{\prime}-s\right)!}\left(1-v^{-2}\right)^{s}  \label{eq:4:5:4}\\
& M+M^{\prime} \geq 0 \\
...
\end{array}\right.
\end{equation}
In this case Eqs. \eqref{eq:1.4:$2:$3} have been used, and the following notations are introduced
\begin{equation}
...
(c) Another explicit form of $U_{M M^{\prime}}^{J}(\omega ; \Theta, \Phi)$ can be obtained directly from $D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)$ by changing variables $(\omega, \Theta, \Phi) \rightarrow(\alpha, \beta, \gamma)$ with the aid of Eqs. \eqref{eq:1.4:$2:$3} and \eqref{eq:1.4:$2:$3}
\begin{equation}
...
\end{equation}
is equivalent to Eq. \eqref{eq:4:7:1}. The angles $\omega_{1}, \Theta_{1}, \Phi_{1}, \omega_{2}, \Theta_{2}, \Phi_{2}$ and $\omega, \Theta, \Phi$ are related by Eqs. \eqref{eq:1.4:$2:$3}.
...
The Clebsch-Gordan expansion, Eq. \eqref{eq:4:6:1}, together with the orthogonality condition of the Clebsch-Gordan coefficients, Eq. \eqref{eq:8.1:$2:$3}, enable one to calculate sums of products of the $D$-functions with identical arguments. Hereafter we introduce the $3 j$-symbol $\left\{j_{1} j_{2} j_{3}\right\}$ defined by
\begin{equation}
...
\end{equation}
$\left\{j_{1} j_{2} j_{3}\right\}$ is invariant with respect to permutations of $j_{1}, j_{2}, j_{3}$. Using Eqs. \eqref{eq:4:6:1} and \eqref{eq:8.1:$2:$3}, one obtains
\begin{align}
...
& \quad \sum_{J=\left|J_{1}-J_{2}\right|}^{J_{1}+J_{2}} \sum_{M_{1} M} \clebsch{J_{1}}{M_{1}}{J_{2}}{M_{2}}{J}{M} D_{M_{1} N_{1}}^{J_{1} *}(\alpha, \beta, \gamma) D_{M N}^{J}(\alpha, \beta, \gamma) \clebsch{J_{1}}{N_{1}^{\prime}}{J_{2}}{N_{2}}{J}{N}=\delta_{N_{1} N_{1}^{\prime}} D_{M_{2} N_{2}}^{J_{2}}(\alpha, \beta, \gamma)  \label{eq:4:6:4}\\
& \quad \sum_{N_{1} N_{2}} D_{M_{1} N_{1}}^{J_{1}}(\alpha, \beta, \gamma) D_{M_{2} N_{2}}^{J_{2}}(\alpha, \beta, \gamma) \clebsch{J_{1}}{N_{1}}{J_{2}}{N_{2}}{J}{N}=\clebsch{J_{1}}{M_{1}}{J_{2}}{M_{3}}{J}{M} D_{M N}^{J}(\alpha, \beta, \gamma)  \label{eq:4:6:5}\\
& \quad \sum_{\substack{N_{1} N_{2} N \\
M_{1} M_{2} M}} D_{M_{N} N}^{J *}(\alpha, \beta, \gamma) D_{M_{1} N_{1}}^{J_{1}}(\alpha, \beta, \gamma) D_{M_{2} N_{2}}^{J_{2}}(\alpha, \beta, \gamma) \clebsch{J_{1}}{N_{1}}{J_{2}}{N_{2}}{J}{N}=\clebsch{J_{1}}{M_{1}}{J_{2}}{M_{2}}{J}{M} N_{J_{1} M_{1} J_{2} M_{2}}^{J *} D_{M N}^{J *}(\alpha, \beta, \gamma) D_{M_{1} N_{1}}^{J_{1}}(\alpha, \beta, \gamma) D_{M_{2} N_{2}}^{J_{2}}(\alpha, \beta, \gamma) \clebsch{J_{1}}{N_{1}}{J_{2}}{N_{2}}{J^{\prime}}{N^{\prime}}=\delta_{J J^{\prime}} \delta_{N N^{\prime}}\left\{J_{1} J_{2} J\right\} \label{eq:4:6:6}
\end{align}
...
\begin{equation}
\sum_{\substack{m_{1}, \ldots, m_{k} \\ n_{1}, \ldots, n_{k}}} \prod_{i=1}^{k} \clebsch{J_{i-1}}{M_{i-1}}{j_{i}}{m_{i}}{J_{i}}{M_{i}} D_{m_{i} n_{i}}^{j_{i}}(\alpha, \beta, \gamma) \clebsch{J_{i-1}^{\prime}}{N_{i-1}}{j_{i}}{n_{i}}{J_{i}^{\prime}}{N_{i}}=D_{M_{k} N_{k}}^{J_{k}}(\alpha, \beta, \gamma) \prod_{i=1}^{k} \delta_{J_{i} J_{i}^{\prime}}\left\{j_{i} J_{i-1} J_{i}\right\} \label{eq:4:6:8}
\end{equation}
...
\end{equation}
where $\alpha, \beta, \gamma$ are related to $\alpha_{1}, \beta_{1}, \gamma_{1}$ and $\alpha_{2}, \beta_{2}, \gamma_{2}$ by Eqs. \eqref{eq:1.4:$2:$3}-\eqref{eq:1.4:$2:$3}.\\
(b) The operator of the resultant rotation $\hat{D}(\alpha, \beta, \gamma)$ is given by Eq. \eqref{eq:1.4:$2:$3}, if $\alpha_{1}, \beta_{1}, \gamma_{1}$ and $\alpha, \beta, \gamma$ are defined with respect to the initial system $S\{x, y, z\}$, but $\alpha_{2}, \beta_{2}, \gamma_{2}$ are defined with respect to the intermediate system $S^{\prime}\left\{x^{\prime}, y^{\prime}, z^{\prime}\right\}$ (scheme B), or if successive rotations are performed according to scheme A. In these cases the addition theorem reads
\begin{equation}
...
\end{equation}
and $\alpha, \beta, \gamma$ are related to $\alpha_{1}, \beta_{1}, \gamma_{1}$ and $\alpha_{2}, \beta_{2}, \gamma_{2}$ by the equations which may be obtained from Eqs. \eqref{eq:1.4:$2:$3}$\eqref{eq:1.4:$2:$3}$ by replacing $\left(\alpha_{1}, \beta_{1}, \gamma_{1}\right) \rightleftarrows\left(\alpha_{2}, \beta_{2}, \gamma_{2}\right)$.
...
\sin \beta e^{-i \alpha} D_{M-1 M^{\prime}}^{J}(\alpha, \beta, \gamma)= & \frac{\sqrt{(J-M)(J-M+1)\left(J^{2}-M^{\prime 2}\right)}}{J(2 J+1)} D_{M M^{\prime}}^{J-1}(\alpha, \beta, \gamma)  \label{eq:4:8:3}\\
& +\frac{M^{\prime} \sqrt{(J+M)(J-M+1)}}{J(J+1)} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)  \notag\\
...
&+\frac{\sqrt{(J-M)(J-M+1)\left(J-M^{\prime}\right)\left(J-M^{\prime}+1\right)}}{(J+1)(2 J+1)} D_{M M^{\prime}}^{J+1}(\alpha, \beta, \gamma),(6)  \label{eq:4:8:6}\\
...
&+\frac{\sqrt{(J+M)(J-M+1)\left(J+M^{\prime}\right)\left(J-M^{\prime}+1\right)}}{J(J+1)} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)  \notag\\
&+\frac{\sqrt{\left(J+M^{\prime}\right)\left(J+M^{\prime}+1\right)\left(J+M^{\prime}\right)(J+M+1)}}{(J+1)(2 J+1)} D_{M M^{\prime}}^{J+1}(\alpha, \beta, \gamma),(7)  \label{eq:4:8:7}\\
&(1-\cos \beta) e^{i(\alpha-\gamma)} D_{M+1 M^{\prime}-1}^{J(\alpha, \beta, \gamma)=} \frac{\sqrt{(J+M)(J+M+1)\left(J-M^{\prime}\right)\left(J-M^{\prime}+1\right)}}{J(2 J+1)} D_{M M^{\prime}}^{J-1}(\alpha, \beta, \gamma)  \notag\\
&-\frac{\sqrt{(J-M)(J+M+1)\left(J+M^{\prime}\right)\left(J-M^{\prime}+1\right)}}{J(J+1)} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)  \notag\\
&+\frac{\sqrt{(J-M)(J-M+1)\left(J+M^{\prime}\right)\left(J+M^{\prime}+1\right)}}{(J+1)(2 J+1)} D_{M M^{\prime}}^{J+1}(\alpha, \beta, \gamma),(8)  \label{eq:4:8:8}\\
&(1-\cos \beta) e^{-i(\alpha-\gamma)} D_{M-1 M^{\prime}+1}^{J}(\alpha, \beta, \gamma)= \frac{\sqrt{(J-M)(J-M+1)\left(J+M^{\prime}\right)\left(J+M^{\prime}+1\right)}}{J(2 J+1)} D_{M M^{\prime}}^{J-1}(\alpha, \beta, \gamma)  \notag\\
&-\frac{\sqrt{(J+M)(J-M+1)\left(J-M^{\prime}\right)\left(J+M^{\prime}+1\right)}}{J(J+1)} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)  \notag\\
...
\end{aligned}  \notag\\
\frac{\partial}{\partial \beta} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)=\frac{1}{2} \sqrt{\left(J+M^{\prime}\right)\left(J-M^{\prime}+1\right)} e^{-i \gamma} D_{M M^{\prime}-1}^{J}(\alpha, \beta, \gamma)  \label{eq:4:9:2}\\
\\
-\frac{1}{2} \sqrt{\left(J-M^{\prime}\right)\left(J+M^{\prime}+1\right)} e^{i \gamma} D_{M M^{\prime}+1}^{J}(\alpha, \beta, \gamma)  \label{eq:4:9:4}\\
...
\frac{\partial}{\partial \beta} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)=\frac{M-M^{\prime} \cos \beta}{\sin \beta} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)+\sqrt{\left(J+M^{\prime}\right)\left(J-M^{\prime}+1\right)} e^{-i \gamma} D_{M M^{\prime}-1}^{J}(\alpha, \beta, \gamma)  \label{eq:4:9:7}\\
\frac{\partial}{\partial \beta} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)=-\frac{M-M^{\prime} \cos \beta}{\sin \beta} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)-\sqrt{\left(J-M^{\prime}\right)\left(J+M^{\prime}+1\right)} e^{i \gamma} D_{M M^{\prime}+1}^{J}(\alpha, \beta, \gamma)  \label{eq:4:9:8}\\
\frac{\partial}{\partial \alpha} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)=-i M D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)  \label{eq:4:9:9}\\
\frac{\partial}{\partial \gamma} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma)=-i M^{\prime} D_{M M^{\prime}}^{J}(\alpha, \beta, \gamma) \label{eq:4:9:10}
\end{gather}
...
V_{2}: & 0 \leq \alpha<\gamma<2 \pi  \label{eq:4:10:1}\\
...
\begin{equation}
\iiint_{V_{1}\left(V_{2}\right)} d \alpha d \beta \sin \beta d \gamma|f(\alpha, \beta, \gamma)|^{2}<\infty \label{eq:4:10:7}
\end{equation}
...
\int_{0}^{2 \pi} d \alpha \int_{0}^{\pi} d \beta \sin \beta \int_{0}^{2 \pi} d \gamma D_{M_{2} M_{2}^{\prime}}^{J_{2} *}(\alpha, \beta, \gamma) D_{M_{1} M_{1}^{\prime}}^{J_{1}}(\alpha, \beta, \gamma)=\frac{8 \pi^{2}}{2 J_{2}+1} \delta_{J_{1} J_{2}} \delta_{M_{1} M_{2}} \delta_{M_{1}^{\prime} M_{2}^{\prime}}  \label{eq:4:11:2}\\
...
\end{array}\right\}, \label{eq:4:12:5}
\end{gather}
\begin{align}
...
\end{array}\right\}^{2},  \label{eq:4:12:6}\\
...
\end{array}\right\},  \label{eq:4:12:7}\\
...
J & J & J_{2} \\
J_{1} & J_{2} & J_{3}
\end{array}\right\},  \label{eq:4:12:8}\\
...
J_{3} & J_{4} & J_{34} \\
J_{13} & J_{24} & J
\end{array}\right\}^{2} . \label{eq:4:12:9}
\end{align}
...
\subsubsection{ If $J$ and $M^{\prime}$ are fixed, then}
\begin{gather}
...
\end{equation}
where $\omega_{1}, \omega_{2}$ and $\omega$ are the rotation angles corresponding to $R_{1}, R_{2}$ and $R=R_{1} R_{2}$, respectively. These angles are mutually related by means of Eqs. $\eqref{eq:1.4:$2:$3} ; \Theta_{12}$ is the angle between the rotation axes of $R_{1}$ and $R_{2}$
\begin{equation}
...
\begin{equation}
\frac{d^{2}}{d \omega^{2}} \chi^{J}(\omega)+\cot \frac{\omega}{2} \cdot \frac{d}{d \omega} \chi^{J}(\omega)+J(J+1) \chi^{J}(\omega)=0 \label{eq:4:14:26}
\end{equation}
and the boundary conditions
\begin{align}
\chi^{J}(0) & =2 J+1  \notag\\
\chi^{J}(\omega \pm 4 \pi n) & =\chi^{J}(\omega), \quad \text { where } n \text { is integer. } \label{eq:4:14:27}
\end{align}
...
\sum_{J=0, \frac{1}{2}, 1, \ldots}^{\infty} \frac{1}{(4 J+2)!}(4 t)^{2 J} \chi^{J}(\omega)=\frac{1}{2}{ }^{0} F_{1}\left(; \frac{3}{2} ;-t \sin ^{2} \frac{\omega}{4}\right)_{0} F_{1}\left(; \frac{3}{2} ; t \cos { }^{2} \frac{\omega}{4}\right),  \label{eq:4:14:61}\\
...
\end{align}
\subsection{Special Cases of $\chi^{J}(\omega)$}\label{sec:4.14.10}
\begin{align}
...
\chi_{\lambda}^{J}(\omega)=\frac{(-1)^{2 J-\lambda}(2 \lambda)!!\sqrt{2 J+1}}{(2 \lambda+1)!} \sqrt{\frac{(2 J+\lambda+1)!}{(2 J-\lambda)!}}\left(\sin \frac{\omega}{2}\right)^{\lambda} F\left(-2 J+\lambda, 2 J+\lambda+2 ; \lambda+\frac{3}{2} ; \cos ^{2} \frac{\omega}{4}\right)  \label{eq:4:15:10}\\
...
\times F\left(-2 J+\lambda,-2 J-\frac{1}{2} ;-4 J-1 ; \frac{1}{\sin ^{2} \frac{\omega}{2}}\right)  \label{eq:4:15:11}\\
...
\times F\left(-J+\frac{1}{2}, \frac{-2 J+\lambda+1}{2} ;-2 J ; \frac{1}{\cos ^{2} \frac{\omega}{2}}\right)  \label{eq:4:15:12}\\
...
\times F\left(-2 J+\lambda,-2 J-\frac{1}{2} ; \lambda+\frac{3}{2} ;-\tan ^{2} \frac{\omega}{4}\right) \label{eq:4:15:13}
\end{gather}
\begin{align}
...
\vect{n}_{1} & \vect{n}_{2} \label{eq:4:15:31}
...
(f) in accepting different phases of non-diagonal elements in Eqs. \eqref{eq:4:2:4} and \eqref{eq:4:2:5}.
