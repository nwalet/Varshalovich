...
\section{Graphical representation of functions}\label{sec:11.1}
...
\subsection{Basic Elements of Diagrams}\label{sec:11.1.1}
...
\subsection{Diagrams of the Basic Functions of the Theory}\label{sec:11.1.2}
...
\section{Graphical representation of the main operations of the theory}\label{sec:11.2}
...
\subsection{Multiplication}\label{sec:11.2.1}
...
\subsection{Invariant Summation over Projections}\label{sec:11.2.2}
...
\subsection{Summation over Angular Momentum}\label{sec:11.2.3}
...
\]
\subsection{Invariant Integration over Directions}\label{sec:11.2.4}
...
\subsection{Integration over Rotation Parameters}\label{sec:11.2.5}
...
\section{Rules of the graphical technique}\label{sec:11.3}
...
\subsection{Deformation of Diagrams}\label{sec:11.3.1}
...
\subsection{Change of Node Sign}\label{sec:11.3.2}
...
\subsection{Change of Direction of External Lines}\label{sec:11.3.3}
...
\]
\subsection{Change of Direction of Integral Lines}\label{sec:11.3.4}
...
\subsection{Linking Subdiagrams}\label{sec:11.3.5}
...
\subsection{Cutting Diagram into Subdiagrams}\label{sec:11.3.6}
...
\subsection{Graphical Method of Summation}\label{sec:11.3.7}
...
\sum_{j m}\ket{j m}\bra{j m}=\sum_{j m}\rket{j m}(2 j+1)\rbra{j m}=1,
\]
\subsection{Replacing An Internal $\Omega$-Line by a Thick $j$-Line}\label{sec:11.3.8}
...
\subsection{Elimination of $j=0$ Line}\label{sec:11.3.9}
...
\subsection{Elimination of the $R=1$ Line}\label{sec:11.3.10}
...
\section{Summary of the graphical technique}\label{sec:11.4}
...
\subsection{General Properties of Diagrams}\label{sec:11.4.1}
...
\subsection{Generalized Wigner-Eckart Theorem in Diagrammatic Form}\label{sec:11.4.2}
...
\subsection{Scheme for the Application of the Graphical Technique}\label{sec:11.4.3}
