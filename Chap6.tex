...
\end{align}
where $D_{m m^{\prime}}^{S}$ are the Wigner $D$-functions (Chap.~\ref{chap:4}), and $U_{m m^{\prime}}^{S}$ are the functions defined in Sec.~\ref{sec:4.5}. The functions $\chi_{S m^{\prime}}^{\prime}$ describe quantum states with definite spin $S$ and spin projection $m^{\prime}$ on the new $z^{\prime}$-axis. They are eigenfunctions of the operators $\widehat{\vect{S}}^{\prime 2}$ and $\widehat{S}_{x}^{\prime}$,
\begin{gather}
...
\times \sum_{S^{\prime}}\sixj{S_{1}}{S_{2}}{S}{S^{\prime}}{L_{1}}{S_{1}} \clebsch{S}{m}{L_{1}}{M_{1}}{S^{\prime}}{m^{\prime}} \times S_{S^{\prime} m^{\prime}}(1,2) , \label{eq:6:1:57}\\
\hat{T}_{L_{2} M_{2}}(2) \chi_{S m}(1,2)=(-1)^{2 S+L_{2}} \sqrt{\left(2 L_{2}+1\right)(2 S+1)}  \notag\\
\times \sum_{S^{\prime}}\sixj{S_{1}}{S_{2}}{S}{S^{\prime}}{L_{2}}{S_{2}} \clebsch{S}{m}{L_{2}}{M_{2}}{S^{\prime}}{m^{\prime}} \chi_{S^{\prime} m^{\prime}}(1,2) . \label{eq:6:1:58}
\end{gather}
...
\begin{equation}
\hat{Q}_{L}(1,2) \chi_{S m}(1,2)=(-1)^{S_{1}+S_{2}+S}(2 L+1)\sixj{S_{1}}{S_{2}}{L}{S}{S}{S} \chi_{S m}(1,2). \label{eq:6:1:60}
\end{equation}
...
\begin{equation}
\hat{P}_{S}(1,2)=(-1)^{S_{1}+S_{2}+S}(2 S+1) \sum_{L}\sixj{S_{1}}{S_{2}}{L}{S}{S}{S} \hat{Q}_{L}(1,2). \label{eq:6:1:65}
\end{equation}
