...
\end{gather}
The expansions for the basis functions in the rotated coordinate system in terms of the angles $\omega, \Theta, \Phi$ may be obtained by the use of the rotation operator $\hat{U}^{1}(\omega ; \Theta, \Phi)$ (Eqs. \eqref{eq:2:6:80}-(81)).
