...
\section{SPIN FUNCTIONS OF PARTICLES WITH ARBITRARY SPIN}
...
\begin{equation}
\chi^{\dagger}=\left(\chi^{*}(S), \chi^{*}(S-1), \ldots \chi^{*}(-S+1), \chi^{*}(-S)\right) . \label{chap6:eq:2}
\end{equation}
...
\begin{equation}
\sum_{\sigma=-S}^{S}|\chi(\sigma)|^{2}=1 \label{chap6:eq:3}
\end{equation}
...
\begin{equation}
\chi^{\dagger} \chi=1 \label{chap6:eq:4}
\end{equation}
...
\subsection{Basis Spin Functions}
...
\begin{equation}
\widehat{\vect{S}}^{2} \chi_{S m}=S(S+1) \chi_{S m}, \widehat{S}_{z} \chi_{S m}=m \chi_{S m} \label{chap6:eq:5}
\end{equation}
...
\begin{equation}
\chi s_{m}(\sigma)=\delta_{m \sigma} \label{chap6:eq:6}
\end{equation}
In other words, contravariant components of the basis spin functions $\chi_{S_{m}}$ have the form
\begin{equation}
\left[x_{s_{m}}\right]^{\sigma}=\delta_{m \sigma} \label{chap6:eq:7}
\end{equation}
...
\begin{equation}
\chi_{S m}^{\dagger} \chi_{S_{m^{\prime}}}=\delta_{m m^{\prime}} \label{chap6:eq:9}
\end{equation}
The completeness condition for the basis spin functions may be written in matrix form
\begin{equation}
\sum_{m=-s}^{s} \chi_{s m} \chi_{S m}^{\dagger}=\widehat{I} \label{chap6:eq:10}
\end{equation}
...
\begin{equation}
\chi_{S m} \chi_{S m^{\prime}}^{\dagger}=\sum_{L} \sqrt{\frac{2 L+1}{2 S+1}} \clebsch{S}{m^{\prime}}{L}{M}{S}{m} \hat{T}_{L M}(S) . \label{chap6:eq:11}
\end{equation}
...
\begin{equation}
\chi_{S m^{\prime}}^{\dagger} \widehat{S}_{\mu} \chi_{S m}=\sqrt{S(S+1)} \clebsch{S}{m}{1}{\mu}{S}{m^{\prime}} ; \label{chap6:eq:12}
\end{equation}
...
\chi_{S m}^{\dagger} S_{0} \chi_{S_{m}}=m  \label{chap6:eq:13}\\
\chi_{S m-1}^{\dagger} \widehat{S}_{-1} \chi_{S m}=\frac{1}{\sqrt{2}} \sqrt{(S+m)(S-m+1)} \notag
\end{gather}
...
& \chi_{S m \pm 1}^{\dagger} \widehat{S}_{y} \chi_{S m}=\mp \frac{i}{2} \sqrt{(S \mp m)(S \pm m+1)}  \label{chap6:eq:14}\\
...
\begin{equation}
\chi_{S m^{\prime}}^{\dagger} \hat{T}_{L M}(S)_{\chi S_{m}}=\sqrt{\frac{2 L+1}{2 S+1}} \clebsch{S}{m}{L}{M}{S}{m^{\prime}} \label{chap6:eq:15}
\end{equation}
...
& \chi_{S m^{\prime}}^{\prime} \equiv \hat{U}^{S}(\omega ; \Theta, \Phi) \chi_{m_{m^{\prime}}}=\sum_{m} U_{m m^{\prime}}^{S}(\omega ; \Theta, \Phi) \chi_{S m} \label{chap6:eq:16}
\end{align}
...
\begin{gather}
\hat{\vect{s}}^{\prime 2} \chi_{S m^{\prime}}^{\prime}=S(S+1) \chi_{S m^{\prime}}^{\prime}  \label{chap6:eq:17}\\
...
\begin{equation}
\widehat{S}_{\mu}^{\prime}=\sum_{\nu} D_{\nu \mu}^{1}(\alpha, \beta, \gamma) \widehat{S}_{\nu}, \quad(\mu, \nu= \pm 1,0) \label{chap6:eq:18}
\end{equation}
\subsection{Helicity Basis Functions}
...
\begin{gather}
\widehat{\vect{S}}^{2} \chi_{S \lambda}(\vartheta, \varphi)=S(S+1) \chi_{S \lambda}(\vartheta, \varphi)  \label{chap6:eq:19}\\
...
& \chi_{S m}^{\dagger}=\sum_{\lambda}(-1)^{\lambda-m} D_{\lambda m}^{S}(0, \vartheta, \varphi) \chi_{S \lambda}^{\dagger}(\vartheta, \varphi) \label{chap6:eq:21}
\end{align}
It follows from \eqref{chap6:eq:7}, \eqref{chap6:eq:20}, \eqref{chap6:eq:21} that the contravariant components of the helicity basis functions have the form
\begin{gather}
{\left[\chi_{s \lambda}(\vartheta, \varphi)\right]^{\sigma}=D_{\sigma \lambda}^{S}(\varphi, \vartheta, 0),}  \notag\\
{\left[\chi_{S \lambda}^{\dagger}(\vartheta, \varphi)\right]^{\sigma}=(-1)^{\lambda-\sigma} D_{-\sigma-\lambda}^{S}(\varphi, \vartheta, 0) . \quad(\sigma, \lambda=-S,-S+1, \ldots S-1, S)} \label{chap6:eq:22}
\end{gather}
...
\begin{equation}
\chi_{S \lambda}^{\dagger}(\vartheta, \varphi) \chi_{S \lambda^{\prime}}(\vartheta, \varphi)=\delta_{\lambda \lambda^{\prime}} \label{chap6:eq:23}
\end{equation}
The completeness condition for these functions has the following matrix form
\begin{equation}
\sum_{\lambda} \chi_{s \lambda}(\vartheta, \varphi) \chi_{S \lambda}^{\dagger}(\vartheta, \varphi)=\hat{I} \label{chap6:eq:24}
\end{equation}
...
\begin{equation}
\chi_{S \lambda}(\vartheta, \varphi) \chi_{S \lambda^{\prime}}^{\dagger}(\vartheta, \varphi)=\sum_{L M} \sqrt{\frac{2 L+1}{2 S+1}} \clebsch{S}{\lambda^{\prime}}{L}{A}{S}{\lambda} D_{M A}^{L}(\varphi, \vartheta, 0) \widehat{T}_{L M}(S) \label{chap6:eq:25}
\end{equation}
Matrix elements of the polarization operators between the helicity basis functions are given by
\begin{equation}
\chi_{S \lambda^{\prime}}^{\dagger}(\vartheta, \varphi) \hat{T}_{L M}(S) \chi_{S \lambda}(\vartheta, \varphi)=\sqrt{\frac{2 L+1}{2 S+1}}(-1)^{M+\Lambda} \clebsch{S}{\lambda}{L}{A}{S}{\lambda^{\prime}} D_{-M-A}^{L}(\varphi, \vartheta, 0) \label{chap6:eq:26}
\end{equation}
In particular, the diagonal matrix elements are
\begin{equation}
\chi_{S \lambda}^{\dagger}(\vartheta, \varphi) \hat{T}_{L M}(S) \chi_{S \lambda}(\vartheta, \varphi)=\sqrt{\frac{4 \pi}{2 S+1}} \clebsch{S}{\lambda}{L}{0}{S}{\lambda} Y_{L M}(\vartheta, \varphi) \label{chap6:eq:27}
\end{equation}
\subsection{General Spin Functions}
Any spin function \eqref{chap6:eq:1} of particles of spin $S$ can be expanded in sum of the basis spin functions $\chi_{S m}$,
\begin{equation}
\chi=\sum_{m=-S}^{S} a^{m} \chi_{s_{m}}, \label{chap6:eq:28}
\end{equation}
...
\begin{equation}
\chi^{\dagger}=\sum_{m=-s^{\prime}}^{s}\left(a^{m}\right)^{*} \chi_{S m}^{\dagger} \label{chap6:eq:29}
\end{equation}
In general, $\left(a^{m}\right)^{*} \neq a_{m}$, i.e., the corresponding irreducible tensor is not real. The normalization condition \eqref{chap6:eq:4} imposes a restriction on $a^{m}$:
\[
...
\begin{equation}
\chi \chi^{\dagger}=\sum_{L=0}^{2 S} \sum_{M=-L}^{L}(-1)^{M} P_{L-M} \hat{T}_{L M}(S), \label{chap6:eq:30}
\end{equation}
where the expansion coefficients may be expressed through $a^{m}$ as
\begin{equation}
P_{L M}=\sqrt{\frac{2 L+1}{2 S+1}} \sum_{m, n=-S}^{S} \clebsch{S}{m}{L}{M}{S}{n}\left(a^{n}\right)^{*} a^{m} . \label{chap6:eq:31}
\end{equation}
...
\begin{equation}
\chi^{\dagger} \hat{T}_{L M}(S)_{\chi}=P_{L M} \label{chap6:eq:32}
\end{equation}
Under complex conjugation $P_{L M}$ transforms as
\begin{equation}
\left(P_{L M}\right)^{*}=(-1)^{M} P_{L-M} \label{chap6:eq:33}
\end{equation}
...
L_{1} & L_{2} & L  \label{chap6:eq:34}\\
S & S & S
\end{array}\right\} \clebsch{L_{1}}{M_{1}}{L_{2}}{M_{2}}{L}{M} P_{L_{1} M_{1}} P_{L_{2} M_{2}}
\end{equation}
In particular, Eq. \eqref{chap6:eq:34} gives the normalization condition
\begin{equation}
\sum_{L=0}^{2 S} \sum_{M=-L}^{L}\left|P_{L M}\right|^{2}=1 \label{chap6:eq:35}
\end{equation}
...
\begin{equation}
\chi^{\prime}=\widehat{D}^{S}(\alpha, \beta, \gamma) \chi \label{chap6:eq:36}
\end{equation}
...
\begin{equation}
\chi^{\prime}=\sum_{m=-S}^{S} a^{\prime m} \chi_{S m}=\sum_{m=-S}^{S} a^{m} \chi_{S m}^{\prime} \label{chap6:eq:37}
\end{equation}
where $a^{m}$ and $a^{\prime m}$ are components of the spin function in the original and rotated systems, respectively. The relations between the basis functions $\chi_{S_{m}}$ and $\chi_{S_{m}}^{\prime}$ are given by Eq. \eqref{chap6:eq:16}. The transformation properties of $a^{m}$ under rotations are
\begin{align}
a^{\prime m} & =\sum_{n=-S}^{S} D_{m n}^{S}(\alpha, \beta, \gamma) a^{n}  \label{chap6:eq:38}\\
...
\subsection{Polarization Density Matrix}
...
\begin{equation}
\rho_{\sigma \sigma^{\prime}}=\left\langle\chi(\sigma) \chi^{*}\left(\sigma^{\prime}\right)\right\rangle_{\xi} \label{chap6:eq:39}
\end{equation}
or in a matrix form by
\begin{equation}
\hat{\rho}=\left\langle x x^{\dagger}\right\rangle_{\xi}, \label{chap6:eq:40}
\end{equation}
where ()$_{\epsilon}$ denotes the statistical average. In particular, for pure states one gets
\begin{equation}
\hat{\rho}=\chi \chi^{\dagger} \label{chap6:eq:41}
\end{equation}
The density matrix is Hermitian,
\begin{equation}
\hat{\rho}^{\dagger}=\hat{\rho}, \quad \text { i.e., } \rho_{\sigma \sigma^{\prime}}^{*}=\rho_{\sigma^{\prime} \sigma} ; \label{chap6:eq:42}
\end{equation}
and normalized,
\begin{equation}
\operatorname{Tr} \hat{\rho}=1, \text { i.e., } \sum_{\sigma} \rho_{\sigma \sigma}=1 . \label{chap6:eq:43}
\end{equation}
The conditions \eqref{chap6:eq:42}, \eqref{chap6:eq:43} reveal that the density matrix of particles of spin $S$ is completely determined by $(2 S+1)^{2}-1=4 S(S+1)$ real parameters.
...
\begin{equation}
\langle\widehat{T}\rangle=\operatorname{Tr}\{\widehat{T} \widehat{\rho}\}=\operatorname{Tr}\{\widehat{\rho} \widehat{T}\} \label{chap6:eq:44}
\end{equation}
Note also the following property of the density matrix
\begin{equation}
\operatorname{Tr}\left\{\hat{\rho}^{2}\right\} \leq 1, \label{chap6:eq:45}
\end{equation}
where the equality holds only for pure states. The density matrix of pure states satisfies the relation
\begin{equation}
\hat{p}^{2} \pm \hat{p} . \label{chap6:eq:46}
\end{equation}
The density matrix $\hat{\rho}$ may be expanded into a sum of the polarisation operators $\hat{T}_{L M}(S)$,
\begin{equation}
\hat{\rho}=\sum_{L=0}^{2 S} \sum_{M=-L}^{L}(-1)^{M} t_{L-M} \hat{T}_{L M}(S) . \label{chap6:eq:47}
\end{equation}
...
\begin{equation}
t_{L M}=\left\langle\widehat{T}_{L M}(S)\right\rangle=\operatorname{Tr}\left\{\hat{\rho} \widehat{T}_{L M}(S)\right\} . \label{chap6:eq:48}
\end{equation}
The statistical tensors are related to the density matrix elements by
\begin{gather}
t_{L M}=\sqrt{\frac{2 L+1}{2 S+1}} \sum_{\sigma, \sigma^{\prime}=-s}^{s} \clebsch{S}{\sigma}{L}{M}{S}{\sigma^{\prime}} \rho_{\sigma \sigma^{\prime}}  \label{chap6:eq:49}\\
\rho_{\sigma \sigma^{\prime}}=\sum_{L, M} \sqrt{\frac{2 L+1}{2 S+1}} C_{S \sigma_{L M}^{\prime}}^{S \sigma_{L M}^{\prime}} \label{chap6:eq:50}
\end{gather}
In particular,
\begin{equation}
t_{00}=\frac{1}{\sqrt{2 S+1}} . \label{chap6:eq:51}
\end{equation}
Under complex conjugation the statistical tensors transform as
\[
t_{L M}^{*}=(-1)^{M} t_{L-M} .
\]
The properties of the statistical tensors for pure (completely polarized) states have been considered above (Eqs. \eqref{chap6:eq:31}-\eqref{chap6:eq:35}). For unpolarised states all statistical tensors vanish except $t_{00}$, thus
\begin{equation}
\hat{\rho}_{\text {unpol }}=\frac{1}{2 S+1} \hat{I}, \label{chap6:eq:52}
\end{equation}
...
\subsection{Two Particles with Arbitrary Spins}
...
\begin{equation}
\chi S_{S_{m}}(1,2)=\sum_{m_{1} m_{2}} \clebsch{S_{1}}{m_{1}}{s_{2}}{m_{2}}{S}{m} \chi S_{S_{1} m_{1}}(1) \chi S_{S_{2} m_{2}}(2) . \label{chap6:eq:53}
\end{equation}
The inverse relation is
\begin{equation}
\chi_{S_{1} m_{1}}(1) \chi_{S_{2} m_{3}}(2)=\sum_{S} \clebsch{S_{1}}{m_{1}}{S_{2}}{m_{2}}{S}{m} \chi_{S m}(1,2) \label{chap6:eq:54}
\end{equation}
Spin functions \eqref{chap6:eq:53} are orthonormalized
\begin{equation}
\chi_{S m}^{\dagger}(1,2) \chi_{S^{\prime} m^{\prime}}(1,2)=\delta_{S S^{\prime}} \delta_{m m^{\prime}} \label{chap6:eq:55}
\end{equation}
and satisfy the completeness condition
\begin{equation}
\sum_{S, m} \chi_{S m}(1,2) \chi_{S m}^{\dagger}(1,2)=\widehat{I} \label{chap6:eq:56}
\end{equation}
...
S_{1} & S_{2} & S \\
S^{\prime} & L_{1} & S_{1}
\end{array}\right\} \clebsch{S}{m}{L_{1}}{M_{1}}{S^{\prime}}{m^{\prime}} \times S_{S^{\prime} m^{\prime}}(1,2)  \label{chap6:eq:57}\\
\hat{T}_{L_{2} M_{2}}(2) \chi_{S m}(1,2)=(-1)^{2 S+L_{2}} \sqrt{\left(2 L_{2}+1\right)(2 S+1)}  \notag\\
\times \sum_{S^{\prime}}\left\{\begin{array}{lll}
S_{1} & S_{2} & S \\
L_{2} & S^{\prime} & S_{2}
\end{array}\right\} \clebsch{S}{m}{L_{2}}{M_{2}}{S^{\prime}}{m^{\prime}} \chi_{S^{\prime} m^{\prime}}(1,2) \label{chap6:eq:58}
\end{gather}
One may also consider a set of scalar operators $\widehat{Q}_{L}(1,2)$ with $0 \leq L \leq \min \left\{2 S_{1}, 2 S_{2}\right\}$
\begin{equation}
\widehat{Q}_{L}(1,2)=\sum_{M}(-1)^{M} \widehat{T}_{L M}(1) \hat{T}_{L-M}(2) \label{chap6:eq:59}
\end{equation}
...
\begin{equation}
\widehat{P}_{S}(1,2) \chi_{S^{\prime} m^{\prime}}(1,2)=\delta_{S S^{\prime}} \chi_{S^{\prime} m^{\prime}}(1,2) \label{chap6:eq:61}
\end{equation}
From Eqs. \eqref{chap6:eq:61} one may obtain the following properties of the projection operators
\begin{gather}
\hat{P}_{S}(1,2) \hat{P}_{S^{\prime}}(1,2)=\delta_{S S^{\prime}} \hat{P}_{S}(1,2)  \label{chap6:eq:62}\\
\sum_{S} \hat{P}_{S}(1,2)=\hat{I} \label{chap6:eq:63}
\end{gather}
The form of $\widehat{P}_{S}(1,2)$ may be written explicitly as
\begin{equation}
\widehat{P}_{S}(1,2)=\sum_{m} \chi_{S_{m}}(1,2) \chi_{S_{m}}^{\dagger}(1,2) \label{chap6:eq:64}
\end{equation}
or, in terms of scalar operators $\widehat{Q}_{L}(1,2)$,
\begin{equation}
\hat{P}_{S}(1,2)=(-1)^{S_{1}+S_{2}+S}(2 S+1) \sum_{L}\left\{\begin{array}{lll}
S_{1} & S_{1} & L  \label{chap6:eq:65}\\
S_{1} & S_{2} & S
\end{array}\right\} \hat{Q}_{L}(1,2)
\end{equation}
\section{SPIN FUNCTIONS FOR $S=1 / 2$}
\subsection{Basis Spin Functions}
The basis functions $\chi_{\frac{1}{2} m}(m= \pm 1 / 2)$ are the eigenfunctions of the operators $\widehat{S}^{2}$ and $\widehat{S}_{z}$ :
\begin{align}
& \widehat{\vect{S}}^{2} X_{\frac{1}{2} m}=\frac{3}{4} X_{\frac{1}{2} m}  \label{chap6:eq:66}\\
...
\begin{equation}
x_{\frac{1}{2} m}(\sigma)=\delta_{m \sigma} \label{chap6:eq:67}
\end{equation}
According to Eq. \eqref{chap6:eq:1}, the basis functions $\chi_{1} m$ may be written as
\begin{equation}
x_{\frac{1}{2} \frac{1}{3}}=\binom{1}{0}, x_{\frac{1}{2}-\frac{1}{2}}=\binom{0}{1} . \label{chap6:eq:68}
\end{equation}
The Hermitian conjugate functions $\chi_{\frac{1}{2} m}^{\dagger}$ have the form
\begin{equation}
\chi_{\frac{1}{2} \frac{1}{2}}^{\dagger}=(1,0), \chi_{\frac{1}{2}-\frac{1}{2}}^{\dagger}=(0,1) . \label{chap6:eq:69}
\end{equation}
The following compact notations for the basis functions are widely used:
\begin{equation}
x_{\frac{1}{2} \frac{1}{2}} \equiv \alpha, x_{\frac{1}{2}-\frac{1}{2}} \equiv \beta . \label{chap6:eq:70}
\end{equation}
The basis functions $\chi_{\frac{1}{2} m}$ satisfy the orthonormality condition
\begin{equation}
x_{\frac{1}{2} m^{\prime}}^{\dagger} x_{\frac{1}{2} m}=\delta_{m^{\prime} m} . \label{chap6:eq:71}
\end{equation}
The completeness condition for the basis functions is
\begin{equation}
\sum_{m} x_{\frac{1}{2} m} x_{\frac{1}{2} m}^{t}=\widehat{I}, \label{chap6:eq:72}
\end{equation}
where $\widehat{I}$ is the unit $2 \times 2$ matrix.

\subsection{Expansions of Products of Basis Functions}
The products $\chi_{\frac{1}{2} m} \chi_{\frac{1}{2} m}^{\dagger}$ represent $2 \times 2$ square matrices whose elements are
\begin{equation}
\left[\chi_{\frac{1}{2} m} \chi_{\frac{1}{2} m^{\prime}}^{\dagger}\right]_{\sigma \sigma^{\prime}} \equiv \chi_{\frac{1}{2} \sigma}^{\dagger}\left(\chi_{\frac{1}{2} m} \chi_{\frac{1}{3} m^{\prime}}^{\dagger}\right) \chi_{\frac{1}{2} \sigma^{\prime}}=\delta_{\sigma m} \delta_{\sigma^{\prime} m^{\prime}} \label{chap6:eq:73}
\end{equation}
The expansions of these products in terms of the spin matrices are given by
\begin{equation}
\chi_{\frac{1}{2} m} \chi_{\frac{1}{2} m^{\prime}}^{\dagger}=\frac{1}{2} \delta_{m m^{\prime}} \widehat{I}-\sqrt{3} \clebsch{1}{\mu}{\frac{1}{2}}{m^{\prime}}{\frac{1}{2}}{m} \widehat{S}_{\mu} \label{chap6:eq:74}
\end{equation}
where $S_{\mu}(\mu= \pm 1,0)$ are spherical components of the spin operator (Sec. 2.5). In more detailed form Eq. \eqref{chap6:eq:74} may be written as
\begin{align}
...
& \alpha \beta^{\dagger} \equiv \chi_{\frac{1}{2} \frac{1}{2}} \chi_{\frac{1}{2}-\frac{1}{2}}^{\dagger}=\widehat{S}_{x}+i \widehat{S}_{y}=-\sqrt{2} \widehat{S}_{+1}  \label{chap6:eq:75}\\
...
\end{align}
\subsection{Action of Spin Operators on Basis Functions}
...
\widehat{S}_{y} \chi_{\frac{1}{2} \frac{1}{2}}=\frac{i}{2} \chi_{\frac{1}{2}-\frac{1}{2}}, & \widehat{S}_{y} \chi_{\frac{1}{2}-\frac{1}{2}}=-\frac{i}{2} \chi_{\frac{1}{2} \frac{1}{2}}  \label{chap6:eq:76}\\
...
\begin{equation}
\widehat{S}_{\mu} \chi_{\frac{1}{2} m}=-\frac{\sqrt{3}}{2} \clebsch{1}{\mu}{\frac{1}{2}}{m}{\frac{1}{2}}{m^{\prime}} \chi_{\frac{1}{2} m^{\prime}} \label{chap6:eq:77}
\end{equation}
More explicitly Eq. \eqref{chap6:eq:77} is
\begin{align}
\widehat{S}_{+1} \chi_{\frac{1}{2} \frac{1}{2}} & =0, & \widehat{S}_{+1} \chi_{\frac{1}{2}-\frac{1}{2}} & =-\frac{1}{\sqrt{2}} \chi_{\frac{1}{2} \frac{1}{2}}  \notag\\
\widehat{S}_{0} \chi_{\frac{1}{2} \frac{1}{2}} & =\frac{1}{2} \chi_{\frac{1}{2} \frac{1}{2}}, & \widehat{S}_{0} \chi_{\frac{1}{3}-\frac{1}{2}} & =-\frac{1}{2} \chi_{\frac{1}{2}-\frac{1}{2}}  \label{chap6:eq:78}\\
\widehat{S}_{-1} \chi_{\frac{1}{2} \frac{1}{2}} & =\frac{1}{\sqrt{2}} \chi_{\frac{1}{2}-\frac{1}{2}}, & \widehat{S}_{-1} \chi_{\frac{1}{2}-\frac{1}{2}} & =0 \notag
\end{align}
According to \eqref{chap6:eq:77}, matrix elements of the operator $\widehat{S} \cdot$ a for any vector a have the form
\begin{equation}
[\widehat{\vect{S}} \cdot \vect{a}]_{\sigma \sigma^{\prime}}=\chi_{\frac{1}{2} \sigma}^{\dagger} \widehat{\vect{S}} \cdot \vect{a} \chi_{\frac{1}{2} \sigma^{\prime}}=(-1)^{1-\mu} \frac{\sqrt{3}}{2} \clebsch{1}{\mu}{\frac{1}{2}}{\sigma^{\prime}}{\frac{1}{2}}{\sigma} a_{-\mu} \label{chap6:eq:79}
\end{equation}
where $a_{-\mu}(\mu= \pm 1,0)$ are covariant spherical components of a (Sec.1.2).

\subsection{Transformation of the Basis Functions Under Rotations of the Coordinate System}
...
& x_{\frac{1}{2} m^{\prime}}^{\prime}=\hat{U}^{\frac{1}{2}}(\omega ; \theta, \Phi) x_{\frac{1}{2} m^{\prime}}=\sum_{m} x_{\frac{1}{2} m} U_{m m^{\prime}}^{\frac{1}{2}}(\omega ; \theta, \Phi) \label{chap6:eq:80}
\end{align}
...
\begin{align}
\widehat{\vect{S}}^{\prime 2} \chi_{\frac{1}{3} m^{\prime}}^{\prime} & =\frac{3}{4} \chi_{\frac{1}{3} m^{\prime \prime}}^{\prime}  \label{chap6:eq:81}\\
...
\begin{equation}
x_{\frac{1}{2} \frac{1}{2}}^{\prime}=\binom{\cos \frac{\beta}{2} e^{-i \alpha \frac{\alpha}{2}}}{\sin \frac{\beta}{2} e^{i \frac{\alpha-\alpha}{2}}}, \quad x_{\frac{1}{2}-\frac{1}{2}}^{\prime}=\binom{-\sin \frac{\beta}{2} e^{i \frac{\alpha}{2}-\alpha}}{\cos \frac{\beta}{2} e^{i \frac{\alpha+\alpha}{2}}}, \label{chap6:eq:82}
\end{equation}
if the rotation is specified by the Euler angles $\alpha, \beta, \gamma$ and
\begin{equation}
x_{\frac{1}{2}}^{\prime}=\binom{\cos \frac{\omega}{2}-i \sin \frac{\omega}{2} \cos \theta}{-i \sin \frac{\omega}{2} \sin \theta e^{i \phi}}, x_{\frac{1}{4}-\frac{1}{2}}^{\prime}=\binom{-i \sin \frac{\omega}{2} \sin \theta e^{-i \phi}}{\cos \frac{\omega}{2}+i \sin \frac{\omega}{2} \cos \theta} \label{chap6:eq:83}
\end{equation}
in terms of the angles $\omega, \theta, \Phi$.\\
The functions $\chi_{\frac{1}{2} m}^{\prime}$, satisfy the orthonormality and completeness conditions \eqref{chap6:eq:71}, \eqref{chap6:eq:72} as well as the relations \eqref{chap6:eq:74}-\eqref{chap6:eq:78} in which the spin operator $\widehat{\vect{S}}$ should be replaced by $\widehat{\vect{S}}^{\prime}$.
...
\begin{align}
\hat{\vect{S}}^{2} \chi_{\frac{1}{2} \lambda}(\vartheta, \phi) & =\frac{3}{4} \chi_{\frac{1}{2} \lambda}(\vartheta, \varphi)  \label{chap6:eq:84}\\
\hat{\vect{S}} \cdot \vect{n} \chi_{\frac{1}{2} \lambda}(\vartheta, \varphi) & =\lambda \chi_{\frac{1}{2} \lambda}(\vartheta, \varphi) \notag
\end{align}
According to Eq. \eqref{chap6:eq:80} the helicity functions $\chi_{\frac{1}{2} \lambda}(\vartheta, \varphi)$ are related to the basis functions $\chi_{\frac{1}{3} m}$ by
\begin{gather}
\chi_{\frac{1}{2} \lambda}(\vartheta, \varphi)=\sum_{m} D_{m \lambda}^{\frac{1}{3}}(\varphi, \vartheta, 0) \chi_{\frac{1}{3} m}  \notag\\
\chi_{\frac{1}{2} m}=\sum_{\lambda} D_{-\lambda-m}^{\frac{1}{2}}(0, \vartheta, \varphi) \chi_{\frac{1}{2} \lambda}(\vartheta, \varphi) \label{chap6:eq:85}
\end{gather}
For Hermitian adjoint functions Eqs. \eqref{chap6:eq:85} yield
\begin{align}
...
& \chi_{\frac{1}{2} m}^{\dagger}=\sum_{\lambda}(-1)^{\lambda-m} D_{\lambda m}^{\frac{1}{3}}(0, \vartheta, \varphi) \chi_{\frac{1}{2} \lambda}^{\dagger}(\vartheta, \varphi) \label{chap6:eq:86}
\end{align}
The explicit form of the helicity functions is given by
\begin{gather}
x_{\frac{1}{2} \frac{1}{2}}(\vartheta, \varphi)=\binom{\cos \frac{\vartheta}{2} e^{-i \frac{\psi}{2}}}{\sin \frac{\vartheta}{2} e^{i \frac{\psi}{2}}}, \quad x_{\frac{1}{2}-\frac{1}{2}}(\vartheta, \varphi)=\binom{-\sin \frac{\vartheta}{2} e^{-i \frac{\psi}{2}}}{\cos \frac{\vartheta}{2} e^{i \frac{\psi}{2}}},  \label{chap6:eq:87}\\
x_{\frac{1}{3} \frac{1}{2}}^{\dagger}(\vartheta, \varphi)=\left(\cos \frac{\vartheta}{2} e^{i \frac{\psi}{2}}, \sin \frac{\vartheta}{2} e^{-i \frac{\psi}{2}}\right), \quad x_{\frac{1}{2}-\frac{1}{2}}^{\dagger}(\vartheta, \varphi)=\left(-\sin \frac{\vartheta}{2} e^{i \frac{\psi}{3}}, \cos \frac{\vartheta}{2} e^{-i \frac{\psi}{2}}\right) . \label{chap6:eq:88}
\end{gather}
...
\begin{equation}
\chi_{\frac{1}{2} \lambda^{\prime}}^{\dagger}(\vartheta, \varphi) \chi_{\frac{1}{2} \lambda}(\vartheta, \varphi)=\delta_{\lambda^{\prime} \lambda} \label{chap6:eq:89}
\end{equation}
The completeness condition is
\begin{equation}
\sum_{\lambda} x_{\frac{1}{2} \lambda}(\vartheta, \varphi) \chi_{\frac{1}{3} \lambda}^{\dagger}(\vartheta, \varphi)=\hat{I} . \label{chap6:eq:90}
\end{equation}
...
\braOket{+}{\widehat{S}_{-1}}{+} & =\frac{\sin \vartheta}{2 \sqrt{2}} e^{-i \varphi}, & \braOket{+}{\widehat{S}_{-1}}{-} & =-\frac{1-\cos \vartheta}{2 \sqrt{2}} e^{-i \varphi}  \label{chap6:eq:94}\\
...
\braOket{+}{\hat{S}_{x}}{+}=\frac{1}{2} \cos \vartheta, & \braOket{+}{\hat{S}_{x}}{-}=-\frac{1}{2} \sin \vartheta,  \label{chap6:eq:95}\\
...
\begin{equation}
\chi_{\frac{1}{2} \lambda}^{\dagger}(\vartheta, \varphi) \hat{\vect{S}}_{\chi_{\frac{1}{2} \lambda}}(\vartheta, \varphi)=\lambda \vect{n}(\vartheta, \varphi) . \label{chap6:eq:96}
\end{equation}
\subsection{General Spin Functions for $S=\frac{1}{2}$}
...
\begin{equation}
x_{\frac{1}{2}}=\sum_{m=-\frac{1}{3}}^{\frac{1}{2}} a^{m} x_{\frac{1}{2} m}=\binom{a^{\frac{1}{2}}}{a^{-\frac{1}{2}}} \label{chap6:eq:97}
\end{equation}
An analogous expansion of the Hermitian conjugate function $\chi_{\frac{1}{2}}^{\dagger}$ is
\begin{equation}
\chi_{\frac{1}{2}}^{\dagger}=\sum_{m=-\frac{1}{2}}^{\frac{1}{2}} a^{m *} \chi_{\frac{1}{2} m}^{\dagger}=\left(a^{\frac{1}{3} *}, a^{-\frac{1}{2} *}\right) \label{chap6:eq:98}
\end{equation}
...
\begin{equation}
\chi_{\frac{1}{2}}^{\dagger} \chi_{\frac{1}{2}}=1 \label{chap6:eq:99}
\end{equation}
...
\subsubsection{(a) Spin is directed along the $z$-axis}
\begin{equation}
a^{\frac{1}{2}}=1, a^{-\frac{1}{2}}=0, \chi_{\frac{1}{2}}=\chi_{\frac{1}{2} \frac{1}{2}}=\binom{1}{0} . \label{chap6:eq:100}
\end{equation}
\subsubsection{(b) Spin is directed along the negative $z$-axis}
\begin{equation}
a^{\frac{1}{2}}=0, a^{-\frac{1}{2}}=1, \quad \chi_{\frac{1}{2}}=\chi_{\frac{1}{2}-\frac{1}{2}}=\binom{0}{1} . \label{chap6:eq:101}
\end{equation}
\subsubsection{(c) Spin is parallel to $\vect{n}(\vartheta, \varphi)$}
\begin{equation}
a^{\frac{1}{2}}=\cos \frac{\vartheta}{2} e^{-i \frac{\varphi}{2}}, a^{-\frac{1}{2}}=\sin \frac{\vartheta}{2} e^{i \frac{\varphi}{2}}, \chi_{\frac{1}{2}}=\chi_{\frac{1}{2} \frac{1}{2}}(\vartheta, \varphi)=\binom{\cos \frac{\vartheta}{2} e^{-i \frac{\varphi}{2}}}{\sin \frac{\vartheta}{2} e^{i \frac{\varphi}{2}}} . \label{chap6:eq:102}
\end{equation}
\subsubsection{(d) Spin is antiparallel to $\vect{n}(\vartheta, \varphi)$}
\begin{equation}
a^{\frac{1}{2}}=-\sin \frac{\vartheta}{2} e^{-i \frac{\varphi}{2}}, a^{-\frac{1}{2}}=\cos \frac{\vartheta}{2} e^{i \frac{\varphi}{2}}, \chi_{\frac{1}{2}}=\chi_{\frac{1}{2}-\frac{1}{2}}(\vartheta, \varphi)=\binom{-\sin \frac{\vartheta}{2} e^{-i \frac{\varphi}{2}}}{\cos \frac{\vartheta}{2} e^{i \frac{\varphi}{2}}} . \label{chap6:eq:103}
\end{equation}
In general, the spin function \eqref{chap6:eq:97} describes a spin- $\frac{1}{2}$ particle whose spin is directed along some unit vector n with cartesian components
\begin{equation}
n_{x}=2 \operatorname{Re}\left(a^{\frac{1}{2} *} a^{-\frac{1}{2}}\right), n_{y}=2 \operatorname{Im}\left(a^{\frac{1}{2} *} a^{-\frac{1}{2}}\right), n_{x}=\left|a^{\frac{1}{2}}\right|^{2}-\left|a^{-\frac{1}{2}}\right|^{2} . \label{chap6:eq:104}
\end{equation}
The spherical components of this unit vector $n$ are given by
\begin{equation}
n_{\mu}=\sqrt{3} \sum_{m, m^{\prime}} \clebsch{\frac{1}{2}}{m}{1}{\mu}{\frac{1}{2}}{m^{\prime}} a^{m^{\prime} *} a^{m} \label{chap6:eq:105}
\end{equation}
or more explicitly
\begin{equation}
n_{+1}=-\sqrt{2} a^{\frac{1}{2} *} a^{-\frac{1}{2}}, n_{0}=\left|a^{\frac{1}{2}}\right|^{2}-\left|a^{-\frac{1}{2}}\right|^{2}, n_{-1}=\sqrt{2} a^{-\frac{1}{2} *} a^{\frac{1}{2}} \label{chap6:eq:106}
\end{equation}
...
\left|a^{\frac{1}{2}}\right|^{2} & a^{-\frac{1}{2} *} a^{\frac{1}{2}}  \label{chap6:eq:107}\\
a^{\frac{1}{2} *} a^{-\frac{1}{2}} & \left|a^{-\frac{1}{2}}\right|^{2}
\end{array}\right)=\frac{1}{2} \widehat{I}+\mathrm{n} \widehat{\mathrm{~S}},
\end{equation}
where $n$ specifies the spin direction \eqref{chap6:eq:104}-\eqref{chap6:eq:106}.

Matrix elements of the spin operator $\widehat{\vect{S}}$ may be written in terms of the vector $\vect{n}$ as
\begin{equation}
\chi_{\frac{1}{2}}^{\dagger} \widehat{\vect{S}}_{\chi_{\frac{1}{2}}}=\frac{1}{2} \mathrm{n} . \label{chap6:eq:108}
\end{equation}
...
\begin{equation}
\chi_{\frac{1}{2}}^{\prime}=\widehat{D}^{\frac{1}{2}}(\alpha, \beta, \gamma) \chi_{\frac{1}{2}}=\widehat{U}^{\frac{1}{2}}(\omega ; \theta, \Phi) \chi_{\frac{1}{2}} \label{chap6:eq:109}
\end{equation}
...
\begin{equation}
\chi_{\frac{1}{2}}^{\prime}=\binom{a^{\prime \frac{1}{2}}}{a^{\prime-\frac{1}{2}}}=\sum_{\dot{m}} a^{\prime m} \chi_{\frac{1}{2} m}=\sum_{m} a^{m} \chi_{\frac{1}{2} m}^{\prime} . \label{chap6:eq:110}
\end{equation}
In this case $a^{m}$ and $a^{m}$ are spinor components in the original and rotated coordinate systems. The relation between the basis functions $\chi_{\frac{1}{2} m}^{\prime}$ and $\chi_{\frac{1}{2} m}$ is given by Eq. \eqref{chap6:eq:80}. The transformation properties of $a^{m}$ are as follows.
\begin{align*}
a^{\prime m} & =\sum_{n} D_{m n}^{\frac{1}{2}}(\alpha, \beta, \gamma) a^{n}, \\
a^{n} & =\sum_{m} D_{m n}^{\frac{1}{2}}(\alpha, \beta, \gamma) a^{\prime m} . \quad\left(\dot{m}, n= \pm \frac{1}{2}\right) .
\end{align*}
...
\begin{equation}
\hat{\rho}=\frac{1}{2}\{\hat{I}+2 \vect{P} \hat{\vect{S}}\}, \label{chap6:eq:111}
\end{equation}
...
\begin{equation}
\vect{P}=2\langle\vect{S}\rangle=2 \operatorname{Tr}\{\hat{\rho} \widehat{\vect{S}}\} . \label{chap6:eq:112}
\end{equation}
...
\begin{equation}
0 \leq|P| \leq 1 . \label{chap6:eq:113}
\end{equation}
The spherical components of the polarization vector are related to the elements of the density matrix by
\begin{equation}
P_{\mu}=\sqrt{3} \sum_{\sigma \sigma!} \clebsch{\frac{1}{2}}{\sigma}{1}{\mu}{\frac{1}{2}}{\sigma^{\prime}} \rho_{\sigma \sigma^{\prime}} \label{chap6:eq:114}
\end{equation}
or in an expanded form
\begin{equation}
P_{+1}=-\sqrt{2} \rho_{-\frac{1}{2} \frac{1}{2}}, P_{0}=\rho_{\frac{1}{2} \frac{1}{2}}-\rho_{-\frac{1}{2}-\frac{1}{2}}, P_{-1}=\sqrt{2} \rho_{\frac{1}{2}-\frac{1}{2}} . \label{chap6:eq:115}
\end{equation}
Cartesian components of the polarization vector are given by
\begin{equation}
P_{x}=\rho_{\frac{1}{2}-\frac{1}{2}}+\rho_{-\frac{1}{2} \frac{1}{2}}, P_{y}=i\left(\rho_{\frac{1}{2}-\frac{1}{2}}-\rho_{-\frac{1}{2} \frac{1}{2}}\right), P_{z}=\rho_{\frac{1}{2} \frac{1}{2}}-\rho_{-\frac{1}{2}-\frac{1}{2}} . \label{chap6:eq:116}
\end{equation}
For a pure state described by a spin function $\chi_{\frac{1}{2}}$ the density matrix $\hat{\rho}$ has the form
\begin{equation}
\hat{\rho}_{\text {pure }}=\chi_{\frac{1}{2}} \chi_{\frac{1}{2}}^{\dagger} \label{chap6:eq:117}
\end{equation}
and the polarization vector $\vect{P}$ coincides with the unit vector $\vect{n}$ (see Eqs. \eqref{chap6:eq:104}-\eqref{chap6:eq:106}). For an unpolarized state
\begin{equation}
\hat{\rho}_{\text {unpol }}=\frac{1}{2} \widehat{I} \label{chap6:eq:118}
\end{equation}
\section{SPIN FUNCTIONS FOR $S=1$}
\subsection{Basis Spin Functions}
The basis functions $\chi_{1 m}(m= \pm 1,0)$ are eigenfunctions of the operators $\widehat{S}^{2}$ and $\widehat{S}_{z}$
\begin{align}
& \widehat{\vect{S}}^{2} \chi_{1 m}=2 \chi_{1 m}  \label{chap6:eq:119}\\
...
\chi_{10}=\chi_{x}, & \chi_{y}=\frac{i}{\sqrt{2}}\left(\chi_{1-1}+\chi_{11}\right)  \label{chap6:eq:120}\\
...
\begin{equation}
\chi_{1 m^{\prime}}^{\dagger} \chi_{1 m}=\delta_{m^{\prime} m}, \quad \chi_{i}^{\dagger} \chi_{k}=\delta_{i k} . \label{chap6:eq:121}
\end{equation}
The completeness condition for basis functions may be written as
\begin{equation}
\sum_{m= \pm 1,0} \chi_{1 m} \chi_{1 m}^{\dagger}=\widehat{I}, \quad \sum_{i=x, y, x} \chi_{i} \chi_{i}^{\dagger}=\widehat{I}, \label{chap6:eq:122}
\end{equation}
...
\begin{equation}
\chi_{1 m}(\sigma)=\delta_{m \sigma} \label{chap6:eq:123}
\end{equation}
According to Eq. \eqref{chap6:eq:1}, the basis spin functions $\chi_{1 m}$ may be written as
\begin{equation}
\chi_{11}=\left(\begin{array}{l}
1  \label{chap6:eq:124}\\
0 \\
0
...
\begin{equation}
\chi_{11}^{\dagger}=(1,0,0), \quad \chi_{10}^{\dagger}=(0,1,0), \quad \chi_{1-1}^{\dagger}=(0,0,1) . \label{chap6:eq:125}
\end{equation}
...
1 \\
0
\end{array}\right),  \label{chap6:eq:126}\\
\chi_{x}^{\dagger}=\frac{1}{\sqrt{2}}(-1,0,1), \quad \chi_{y}^{\dagger}=-\frac{i}{\sqrt{2}}(1,0,1), \quad \chi_{z}^{\dagger}=(0,1,0) . \label{chap6:eq:127}
\end{gather}
It follows from \eqref{chap6:eq:124}, \eqref{chap6:eq:126} that in the spherical basis representation the functions $\chi_{1 m}$ are real,
\begin{equation}
\chi_{1 m}^{*}=\chi_{1 m}, \quad(m= \pm 1,0), \label{chap6:eq:128}
\end{equation}
and the functions $\chi_{i}$ satisfy the relations
\begin{equation}
\chi_{x}^{*}=\chi_{x}, \quad \chi_{y}^{*}=-\chi_{y}, \quad \chi_{x}^{*}=\chi_{x} . \label{chap6:eq:129}
\end{equation}
...
\begin{equation}
x_{i}(\sigma)=\delta_{i \sigma} \label{chap6:eq:130}
\end{equation}
...
1
\end{array}\right) \\
\chi_{x}^{\dagger}=(1,0,0), & \chi_{y}^{\dagger}=(0,1,0), & \chi_{z}^{\dagger}=(0,0,1) . \label{chap6:eq:131}
\end{array}
\end{equation}
...
-i \\
0
\end{array}\right),  \label{chap6:eq:132}\\
& \chi_{11}^{\dagger}=-\frac{1}{\sqrt{2}}(1,-i, 0), \quad \chi_{10}^{\dagger}=(0,0,1), \quad \chi_{1-1}^{\dagger}=\frac{1}{\sqrt{2}}(1, i, 0) . \label{chap6:eq:133}
\end{align}
It follows from Eqs. (13), (15) that in the cartesian basis representation the functions $\chi_{i}$ are real,
\begin{equation}
\chi_{i}^{*}=\chi_{i} \quad(i=x, y, z), \label{chap6:eq:134}
\end{equation}
and the functions $\chi_{1 m}$ satisfy the relations
\begin{equation}
\chi_{1 m}^{*}=(-1)^{m} \chi_{1-m}(m= \pm 1,0) \label{chap6:eq:135}
\end{equation}
...
\chi(\text { cartesian basis }) & =U^{-1} \chi(\text { spherical basis }) \label{chap6:eq:136}
\end{align}
...
\subsection{Expansions of Products of Spin Functions}
...
\begin{gather}
\chi_{1 m} \chi_{1 m^{\prime}}^{\dagger}=\frac{1}{3} \delta_{m m^{\prime}} \hat{I}+\frac{1}{\sqrt{2}} \clebsch{1}{m^{\prime}}{1}{\mu}{1}{m} \hat{S}_{\mu}+\sqrt{\frac{5}{3}} \clebsch{1}{m^{\prime}}{2}{M}{1}{m} \hat{T}_{2 M}  \label{chap6:eq:137}\\
\chi_{i} \chi_{k}^{\dagger}=\frac{1}{3} \delta_{i k} \hat{I}+\frac{i}{2} \varepsilon_{i k l} \widehat{S}_{l}-\widehat{Q}_{i k} \label{chap6:eq:138}
\end{gather}
...
\chi_{10} \chi_{10}^{\dagger} & =\frac{1}{3} \widehat{I}-\sqrt{\frac{2}{3}} \widehat{T}_{20}=\frac{1}{3} \widehat{I}-\widehat{Q}_{x x}  \label{chap6:eq:139}\\
...
& \chi_{y} \chi_{y}^{\dagger}=\frac{1}{3} \widehat{I}+\frac{1}{2} \widehat{T}_{2-2}+\frac{1}{2} \widehat{T}_{22}+\frac{1}{\sqrt{6}} \widehat{T}_{20}=\frac{1}{3} \widehat{I}-\widehat{Q}_{y y},  \label{chap6:eq:140}\\
...
\begin{align}
\widehat{S}_{\mu} \chi_{1 m} & =\sqrt{2} \clebsch{1}{m}{1}{\mu}{1}{m^{\prime}} \chi_{1 m^{\prime}}  \label{chap6:eq:141}\\
...
\widehat{S}_{0} \chi_{11}=\chi_{11}, \quad \widehat{S}_{0} \chi_{10}=0, \quad \widehat{S}_{0} \chi_{1-1}=-\chi_{1-1},  \label{chap6:eq:142}\\
...
\widehat{S}_{0} \chi_{z}=i \chi_{y}, \quad \widehat{S}_{0} \chi_{y}=-i \chi_{z}, \quad \widehat{S}_{0} \chi_{z}=0,  \label{chap6:eq:143}\\
...
\widehat{S}_{y} \chi_{11}=\frac{i}{\sqrt{2}} \chi_{10}, \quad \widehat{S}_{y} \chi_{10}=\frac{i}{\sqrt{2}}\left(\chi_{1-1}-\chi_{11}\right), \quad \widehat{S}_{y} \chi_{1-1}=-\frac{i}{\sqrt{2}} \chi_{10},  \label{chap6:eq:144}\\
...
\widehat{S}_{y} \chi_{z}=-i \chi_{z}, \quad \widehat{S}_{y} \chi_{y}=0, \quad \widehat{S}_{y} \chi_{z}=i \chi_{z},  \label{chap6:eq:145}\\
\widehat{S}_{z} \chi_{z}=i \chi_{y}, \quad \widehat{S}_{z} \chi_{y}=-i \chi_{z}, \quad \widehat{S}_{z} \chi_{z}=0 . \notag
\end{gather}
\subsection{Action of Quadrupole Operators on Basis Functions}
The operators $\widehat{T}_{2 M}(M= \pm 2, \pm 1,0)$ and $\widehat{Q}_{i k}(i, k=x, y, z)$ act on basis functions in accordance with
\begin{gather}
\hat{T}_{2 M} \chi_{1 m}=\sqrt{\frac{5}{3}} \clebsch{1}{m}{2}{M}{1}{m^{\prime}} \chi_{1 m^{\prime}}  \label{chap6:eq:146}\\
...
\hat{T}_{20} \chi_{11}=\frac{1}{\sqrt{6}} \chi_{11}, & \hat{T}_{20} \chi_{10}=-\sqrt{\frac{2}{3}} \chi_{10}, & \hat{T}_{20} \chi_{1-1}=\frac{1}{\sqrt{6}} \chi_{1-1},  \label{chap6:eq:147}\\
...
\hat{T}_{20} \chi_{x}=\frac{1}{\sqrt{6}} \chi_{x}, & \hat{T}_{20} \chi_{y}=\frac{1}{\sqrt{6}} \chi_{y}, & \hat{T}_{20} \chi_{x}=-\sqrt{\frac{2}{3}} \chi_{x},  \label{chap6:eq:148}\\
...
\hat{Q}_{x x} \chi_{11}=\frac{1}{2 \sqrt{2}} \chi_{10}, & \hat{Q}_{x x} \chi_{10}=\frac{1}{2 \sqrt{2}}\left(\chi_{11}-\chi_{1-1}\right), & \hat{Q}_{x x} \chi_{1-1}=-\frac{1}{2 \sqrt{2}} \chi_{10},  \label{chap6:eq:149}\\
...
\hat{Q}_{z x} \chi_{x}=\frac{1}{3} \chi_{x}, & \hat{Q}_{z x} \chi_{y}=\frac{1}{3} \chi_{y}, & \hat{Q}_{z z} \chi_{z}=-\frac{2}{3} \chi_{z}  \label{chap6:eq:150}\\
...
\end{array}
\end{equation}
\subsection{Transformation of Basis Functions Under Rotations of the Coordinate Systems}
...
\chi_{i}^{\prime}=\hat{D}^{1}(\alpha, \beta, \gamma) \chi_{i}=\sum_{k=x, y, z} a_{k i} \chi_{k} \label{chap6:eq:151}
\end{gather}
...
\begin{align}
\widehat{\vect{S}}^{\prime 2} \chi_{1 m^{\prime}}^{\prime} & =2 \chi_{1 m^{\prime}}^{\prime}  \label{chap6:eq:152}\\
...
\frac{1+\cos \beta}{2} e^{-i(\alpha+\gamma)}  \label{chap6:eq:153}\\
...
-\frac{\cos \beta \cos \gamma-i \sin \gamma}{\sqrt{2}} e^{-i \alpha}  \label{chap6:eq:154}\\
-\sin \beta \cos \gamma \\
...
\frac{\cos \beta \sin \alpha-i \cos \alpha}{\sqrt{2}} e^{i \gamma} \\
-\frac{\sin \beta}{\sqrt{2}} e^{i \gamma}
\end{array}\right),  \label{chap6:eq:155}\\
\chi_{x}^{\prime}=\left(\begin{array}{c}
...
\sin \beta \sin \alpha \\
\cos \beta
\end{array}\right) \label{chap6:eq:156}
\end{gather}
...
\subsection{Helicity Basis Functions for $S=1$}
...
\widehat{\vect{S}} \vect{n}_{\chi_{1 \lambda}}(\vartheta, \varphi) & =\lambda_{\chi_{1 \lambda}}(\vartheta, \varphi) \label{chap6:eq:157}
\end{align}
According to Eq. \eqref{chap6:eq:20}, the helicity basis functions may be derived from the functions $\chi_{1 m}$ by a coordinate rotation
\begin{gather}
\chi_{1 \lambda}(\vartheta, \varphi)=\sum_{m} D_{m \lambda}^{1}(\varphi, \vartheta, 0) \chi_{1 m}  \notag\\
\chi_{1 m}=\sum_{\lambda} D_{-\lambda-m}^{1}(0, \vartheta, \varphi) \chi_{1 \lambda}(\vartheta, \varphi) \label{chap6:eq:158}
\end{gather}
For Hermitian adjoint functions Eqs. \eqref{chap6:eq:158} assume the form
\begin{align}
& \chi_{1 \lambda}^{\dagger}(\vartheta, \varphi)=\sum_{m}(-1)^{\lambda-m} D_{-m-\lambda}^{1}(\varphi, \vartheta, 0) \chi_{1 m}^{\dagger}  \notag\\
& \chi_{1 m}^{\dagger}=\sum_{\lambda}(-1)^{\lambda-m} D_{\lambda m}^{1}(0, \vartheta, \varphi) \chi_{1 \lambda}^{\dagger}(\vartheta, \varphi) \label{chap6:eq:159}
\end{align}
...
\begin{equation}
\chi_{1 \lambda}(\vartheta, \varphi)=\vect{e}_{\lambda}^{\prime} \quad(\lambda= \pm 1,0) \label{chap6:eq:160}
\end{equation}
...
& \chi_{y}(\vartheta, \varphi)=\frac{i}{\sqrt{2}}\left\{\chi_{1-1}(\vartheta, \varphi)+\chi_{11}(\vartheta, \varphi)\right\}  \label{chap6:eq:161}\\
...
\begin{equation}
\chi_{x}(\vartheta, \varphi) \equiv \vect{e}_{\vartheta}, \quad \chi_{y}(\vartheta, \varphi) \equiv \vect{e}_{\varphi}, \quad \chi_{z}(\vartheta, \varphi)=\vect{e}_{p} \label{chap6:eq:162}
\end{equation}
...
& \chi_{k}=\sum_{i} a_{i k}(\varphi, \vartheta, 0) \chi_{i}(\vartheta, \varphi), \label{chap6:eq:163}
\end{align}
where $a_{i k}(\alpha, \beta, \gamma)$ are elements of the rotation matrix given by Eqs. 1.4(54). The relations between the Hermitian conjugate functions $\chi_{i}^{\dagger}(\vartheta, \varphi)$ and $\chi_{k}^{\dagger}$ are also given by Eq. \eqref{chap6:eq:163} because the elements $a_{i k}$ are real.
...
\chi_{i}^{\dagger}(\vartheta, \varphi) \chi_{k}(\vartheta, \varphi)=\delta_{i k} \label{chap6:eq:164}
\end{gather}
...
& \sum_{i=x, y, x} \chi_{i}(\vartheta, \varphi) \chi_{i}^{\dagger}(\vartheta, \varphi)=\widehat{I} . \label{chap6:eq:165}
\end{align}
...
\frac{1+\cos \vartheta}{2} e^{i \varphi}
\end{array}\right),  \label{chap6:eq:166}\\
...
\cos \vartheta \\
\frac{\sin \vartheta}{\sqrt{2}} e^{i \varphi}
\end{array}\right) . \label{chap6:eq:167}
\end{gather}
\subsubsection{(b) Cartesian basis representation}
\begin{gather}
...
\cos \vartheta \sin \varphi-i \cos \varphi \\
-\sin \vartheta
\end{array}\right),  \label{chap6:eq:168}\\
\chi_{x}(\vartheta, \varphi)=\left(\begin{array}{c}
...
\sin \vartheta \sin \varphi \\
\cos \vartheta
\end{array}\right) . \label{chap6:eq:169}
\end{gather}
In the cartesian basis representation these functions satisfy the relations
\begin{gather}
\chi_{1 \lambda}^{*}(\vartheta, \varphi)=(-1)^{\lambda} \chi_{1-\lambda}(\vartheta, \varphi), \quad(\lambda= \pm 1,0)  \label{chap6:eq:170}\\
...
& +\sqrt{\frac{5}{3}} \clebsch{1}{\lambda^{\prime}}{2}{N}{1}{\lambda} \sum_{M=-2}^{2} D_{M N}^{2}(\varphi, \vartheta, 0) \widehat{T}_{2 M} \label{chap6:eq:171}
\end{align}
Analogous expansions for $\chi_{i}(\vartheta, \varphi)$ can be written as
\begin{equation}
\chi_{i}(\vartheta, \varphi) \chi_{k}^{\dagger}(\vartheta, \varphi)=\frac{1}{3} \delta_{i k} \widehat{I}+\frac{i}{2} \varepsilon_{i k l} \sum_{m=x, y, z} a_{m l}(\varphi, \vartheta, 0) \widehat{S}_{m}-\sum_{m, n=x, y, z} a_{m i}(\varphi, \vartheta, 0) a_{n k}(\varphi, \vartheta, 0) \widehat{Q}_{m n} \label{chap6:eq:172}
\end{equation}
...
\begin{gather}
\chi_{1 \lambda}^{\dagger}(\vartheta, \varphi) \hat{S}_{\mu} \chi_{1 \lambda^{\prime}}(\vartheta, \varphi)=(-1)^{\mu+\nu} \sqrt{2} \clebsch{1}{\lambda^{\prime}}{1}{\nu}{1}{\lambda} D_{-\mu-\nu}^{1}(\varphi, \vartheta, 0)  \label{chap6:eq:173}\\
\chi_{i}^{\dagger}(\vartheta, \varphi) \hat{S}_{l} \chi_{k}(\vartheta, \varphi)=-i \sum_{m} \varepsilon_{i k m} a_{l m}(\varphi, \vartheta, 0) \label{chap6:eq:174}
\end{gather}
In particular, the expectation value of the spin operator $\widehat{\vect{S}}$ in a state with the helicity $\lambda$ is given by
\begin{equation}
\chi_{1 \lambda}^{\dagger}(\vartheta, \varphi) \widehat{\vect{S}}_{\chi_{1 \lambda}}(\vartheta, \varphi)=\lambda \vect{n}(\vartheta, \varphi), \quad(\lambda= \pm 1,0) \label{chap6:eq:175}
\end{equation}
The expectation value of the operator $\widehat{\vect{S}}$ in the states $\chi_{i}(\vartheta, \varphi)$ is zero.
\begin{equation}
\chi_{i}^{\dagger}(\vartheta, \varphi) \widehat{\vect{S}}_{\chi_{i}}(\vartheta, \varphi)=0, \quad(i=x, y, z) \label{chap6:eq:176}
\end{equation}
The evaluation of matrix elements of the quadrupole operators $\hat{T}_{2 M}(M= \pm 2, \pm 1,0)$ and $\hat{Q}_{i k}(i, k=x, y, z)$ gives
\begin{gather}
\chi_{1 \lambda}^{\dagger}(\vartheta, \varphi) \hat{T}_{2 M} \chi_{1 \lambda^{\prime}}(\vartheta, \varphi)=(-1)^{M+N} \sqrt{\frac{5}{3}} \clebsch{1}{\lambda^{\prime}}{2}{N}{1}{\lambda} D_{-M-N}^{2}(\varphi, \vartheta, 0)  \label{chap6:eq:177}\\
\chi_{i}^{\dagger}(\vartheta, \varphi) \hat{Q}_{l m} \chi_{k}(\vartheta, \varphi)=-\frac{1}{2}\left\{a_{l i}(\varphi, \vartheta, 0) a_{m k}(\varphi, \vartheta, 0)+a_{l k}(\varphi, \vartheta, 0) a_{m i}(\varphi, \vartheta, 0)-\frac{2}{3} \delta_{i k} \delta_{l m}\right\} . \label{chap6:eq:178}
\end{gather}
In particular, the expectation values of the quadrupole operators $\hat{T}_{2 M}$ in states with helicity $\lambda$ are equal to
\begin{gather}
\chi_{1 \lambda}^{\dagger}(\vartheta, \varphi) \hat{T}_{2 M} \chi_{1 \lambda}(\vartheta, \varphi)=\frac{(-1)^{1+\lambda}}{1+|\lambda|} \sqrt{\frac{8 \pi}{15}} Y_{2 M}(\vartheta, \varphi)  \label{chap6:eq:179}\\
(\lambda= \pm 1,0 ; M= \pm 2, \pm 1,0) \notag
\end{gather}
\subsection{General Spin Functions for $S=1$}
...
\begin{equation}
\chi_{1}=\sum_{m= \pm 1,0} a^{m} \chi_{1 m}=\sum_{m= \pm 1,0}(-1)^{m} a_{-m} \chi_{1 m}=\sum_{i=x, y, x} a_{i} \chi_{i} \label{chap6:eq:180}
\end{equation}
The expansion of the Hermitian conjugate function $\chi_{1}^{\dagger}$ is given by
\begin{equation}
\chi_{1}^{\dagger}=\sum_{m= \pm 1,0}\left(a^{m}\right)^{*} \chi_{1 m}^{\dagger}=\sum_{m= \pm 1,0}(-1)^{m}\left(a_{-m}\right)^{*} \chi_{1 m}^{\dagger}=\sum_{i=x, y, x} a_{i}^{*} \chi_{i}^{\dagger} \label{chap6:eq:181}
\end{equation}
In a spherical basis the function $\chi_{1}$ has the form
\begin{equation}
\chi_{1}=\left(\begin{array}{c}
a^{+1}  \label{chap6:eq:182}\\
a^{0} \\
a^{-1}
...
\begin{equation}
\chi_{1}=\left(\begin{array}{c}
\frac{1}{\sqrt{2}}\left(a^{-1}-a^{+1}\right)  \label{chap6:eq:183}\\
...
\begin{equation}
\left(a^{m}\right)^{*}=\left(a^{*}\right)_{m},\left(a_{m}\right)^{*}=\left(a^{*}\right)^{m},\left(a_{i}\right)^{*}=\left(a^{*}\right)_{i} \label{chap6:eq:184}
\end{equation}
The normalization condition
\begin{equation}
\chi_{1}^{\dagger} \chi_{1}=1 \label{chap6:eq:185}
\end{equation}
imposes a restriction to the components of a
\begin{equation}
\left|a^{+1}\right|^{2}+\left|a^{0}\right|^{2}+\left|a^{-1}\right|^{2}=\left|a_{+1}\right|^{2}+\left|a_{0}\right|^{2}+\left|a_{-1}\right|^{2}=\left|a_{x}\right|^{2}+\left|a_{y}\right|^{2}+\left|a_{z}\right|^{2}=1, \label{chap6:eq:186}
\end{equation}
or, in compact form
\begin{equation}
|\vect{a}|^{2}=\vect{a}^{*} \cdot \vect{a}=1 \label{chap6:eq:187}
\end{equation}
...
& \chi_{1} \chi_{1}^{\dagger}=\frac{1}{3} \widehat{I}+\frac{1}{2} \sum_{i=x, y, x} P_{i} \widehat{S}_{i}+\sum_{i, k=x, y, x} P_{i k} \widehat{Q}_{i k} \label{chap6:eq:188}
\end{align}
or in more compact form,
\begin{equation}
\chi_{1} \chi_{1}^{\dagger}=\frac{1}{3} \widehat{\vect{I}}+\frac{1}{2} \vect{P} \cdot \widehat{\vect{S}}+\left(\vect{P}_{2} \cdot \widehat{\vect{T}}_{2}\right), \label{chap6:eq:189}
\end{equation}
...
\begin{equation}
\vect{P}=i\left[\vect{a} \times \vect{a}^{*}\right], \label{chap6:eq:190}
\end{equation}
or, in components,
\begin{gather}
P_{\mu}=\sqrt{2} \sum_{m, n} \clebsch{1}{m}{1}{\mu}{1}{n}\left(a^{n}\right)^{*} a^{m}, \quad(m, n, \mu= \pm 1,0)  \notag\\
P_{i}=i \sum_{k, l} \varepsilon_{i k l} a_{k} a_{l}^{*}, \quad(i, k, l=x, y, z) \label{chap6:eq:191}
\end{gather}
...
P_{i k}=-\frac{1}{2}\left\{a_{i} a_{k}^{*}+a_{k} a_{i}^{*}-\frac{2}{3} \delta_{i k}\right\}, \quad(i, k=x, y, z),  \label{chap6:eq:192}\\
...
\left\langle\widehat{T}_{2 M}\right\rangle \equiv \chi_{1}^{\dagger} \hat{T}_{2 M} \chi_{1}=P_{2 M}  \label{chap6:eq:193}\\
...
\begin{equation}
\chi_{1}^{\prime}=\hat{D}^{1}(\alpha, \beta, \gamma) \chi_{1}=\hat{U}^{1}(\omega ; \Theta, \Phi) \chi_{1} \label{chap6:eq:194}
\end{equation}
...
\chi_{1}^{\prime}=\sum_{m= \pm 1,0}(-1)^{m} a_{-m}^{\prime} \chi_{1 m} & =\sum_{m= \pm 1,0}(-1)^{m} a_{-m} \chi_{1 m}^{\prime}  \label{chap6:eq:195}\\
\chi_{1}^{\prime}=\sum_{i=x, y, z} a_{i}^{\prime} \chi_{i} & =\sum_{i=x, y, z} a_{i} \chi_{i}^{\prime} \notag
\end{align}
The relations between basis functions in the rotated and original coordinate systems are given by Eqs. \eqref{chap6:eq:151}. The components of $\vect{a}$ in the above systems are related by
\begin{equation}
\begin{array}{rlrl}
a^{\prime m} & =\sum_{n} D_{m n}^{1}(\alpha, \beta, \gamma) a^{n}, & a^{n} & =\sum_{m} D_{m n}^{1 *}(\alpha, \beta, \gamma) a^{\prime m} \\
a_{m}^{\prime} & =\sum_{n} D_{n m}^{1}(\alpha, \beta, \gamma) a_{n}, & a_{n} & =\sum_{m} D_{n m}^{1 *}(\alpha, \beta, \gamma) a_{m}^{\prime}  \label{chap6:eq:196}\\
