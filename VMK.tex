...
\usepackage{tikz}
\usetikzlibrary{arrows.meta,decorations.markings,positioning,calc,decorations.pathreplacing,decorations.markings}
...
\tikzset{
  ...
  arrowmid/.style={postaction={decorate,decoration={markings,mark=at position 0.5 with {\arrow{Stealth[length=2.2mm]}}}}},
  doublearrowmid/.style={postaction={decorate,decoration={markings,mark=at position 0.45 with {\arrow{Stealth[length=2.2mm]}}},mark=at position 0.55 with {\arrowreversed{Stealth[length=2.2mm]}}}}
  }
