...
Instead of the Wigner $6 j$ symbols the Racah coefficients [91] are often used, especially in spectroscopy theory.\isym{W-racah@$W(a b e d ; c f)$, Racah coefficient} These coefficients differ from the $6 j$ symbols only by a phase factor:
\begin{equation}
...
The $6 j$ symbols and the Racah coefficients may be written in the form of a $3 \times 4$ array\isym{R-ialpha@$R_{i \alpha}$, $R$-symbol of the $6j$ symbol} $\left\|R_{i \alpha}\right\|(i=1,2,3 ; \alpha= 1,2,3,4)$ which is called the $R$-symbol (Shelepin [105])
\begin{equation}
...
\end{align}
\subsection{Bargmann Formula [58]}\label{sec:9.2.2}\index{Bargmann formula}\index{6j symbol@$6j$ symbol!Bargmann formula}
\begin{equation}
...
\subsubsection{The Ponzano-Regge Formula [89] (semiclassical approximation to the $6 j$ symbols)}\index{Ponzano-Regge formula}\index{semiclassical formulas}\isym{V-tetra@$V$, volume of the tetrahedron}
