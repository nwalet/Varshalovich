...
\text { III) } \vect{j}_{1}+\vect{j}_{3}=\vect{j}_{13}, & \vect{j}_{13}+\vect{j}_{2}=\vect{j} . \label{chap9:eq:1}
\end{array}
\end{equation}
...
\begin{equation}
\ket{j_{1} j_{2}\left(j_{12}\right) j_{33} j m}=\sum_{m_{1} m_{2} m_{2}} \clebsch{j_{12}}{m_{12}}{j_{2}}{m_{3}}{j}{m} C_{j_{2} m_{12} m_{2}}^{j_{12} m_{12}}\ket{j_{1} m_{1}, j_{2} m_{2}, j_{3} m_{3}} . \label{chap9:eq:2}
\end{equation}
...
\begin{equation}
\ket{j_{1}, j_{2} j_{3}\left(j_{23}\right) j m}=\sum_{m_{1} m_{2} m_{3}} \clebsch{j_{1}}{m_{1}}{j_{23}}{m_{23}}{j}{m} \clebsch{j_{2}}{m_{2}}{j_{2}}{m_{3}}{j_{2}}{m_{20}}\ket{j_{1} m_{1}, j_{2} m_{2}, j_{3} m_{3}} . \label{chap9:eq:3}
\end{equation}
...
\begin{equation}
\ket{j_{1} j_{3}\left(j_{13}\right) \dot{j}_{2} j m}=\sum_{m_{1} m_{2} m_{3}} \clebsch{j_{13}}{m_{13}}{j_{2}}{m_{2}}{j}{m} \clebsch{j_{1}}{m_{1}}{j_{3}}{m_{2}}{j_{13}}{m_{13}}\ket{j_{1} m_{1}, j_{2} m_{2}, j_{3} m_{3}} . \label{chap9:eq:4}
\end{equation}
...
= & \delta_{j j^{\prime}} \delta_{m m^{\prime}}(-1)^{j_{1}+j_{2}+j_{3}+j} \sqrt{\left(2 j_{12}+1\right)\left(2 j_{23}+1\right)}\sixj{j_{1}}{j_{2}}{j_{12}}{j_{3}}{j}{j_{23}} . \label{chap9:eq:5}
\end{align}
From Eq. \eqref{chap9:eq:5} one may obtain [92,64]
\begin{align}
...
=&\delta_{j j^{\prime}} \delta_{m m^{\prime}}(-1)^{j_{2}+j_{3}+j_{12}+j_{13}} \sqrt{\left(2 j_{12}+1\right)\left(2 j_{13}+1\right)}\sixj{j_{2}}{j_{1}}{j_{12}}{j_{3}}{j}{j_{13}}  \label{chap9:eq:6}\\
...
=&\delta_{j j^{\prime}} \delta_{m m^{\prime}}(-1)^{j_{1}+j+j_{23}} \sqrt{\left(2 j_{13}+1\right)\left(2 j_{23}+1\right)}\sixj{j_{1}}{j_{3}}{j_{13}}{j_{2}}{j}{j_{23}} . \label{chap9:eq:7}
\end{align}
...
=\delta_{j j^{\prime}} \delta_{m m^{\prime}}(-1)^{j_{1}+j_{2}+j_{3}+j} \sqrt{\left(2 j_{12}+1\right)\left(2 j_{23}+1\right)}\sixj{j_{1}}{j_{2}}{j_{12}}{j_{3}}{j}{j_{23}} . \label{chap9:eq:8}
\end{multline}
...
\begin{align}
& \sum_{j_{12}}\left(2 j_{12}+1\right)\left(2 j_{23}+1\right)\sixj{j_{1}}{j_{2}}{j_{12}}{j_{3}}{j}{j_{23}}\sixj{j_{1}}{j_{2}}{j_{12}}{j_{3}}{j}{j_{23}^{\prime}}=\delta_{j_{23} j_{23}^{\prime}} , \label{chap9:eq:9}\\
& \sum_{j_{23}}\left(2 j_{12}+1\right)\left(2 j_{23}+1\right)\sixj{j_{1}}{j_{2}}{j_{12}}{j_{3}}{j}{j_{23}}\sixj{j_{1}}{j_{2}}{j_{12}^{\prime}}{j_{3}}{j}{j_{23}}=\delta_{j_{12} j_{23}^{\prime}} . \label{chap9:eq:10}
\end{align}
Below we shall use Latin letters $a, b, c$, etc., to denote arguments of the $6 j$ symbols.

\subsection{Racah Coefficients}
...
\begin{equation}
\sixj{a}{b}{c}{d}{e}{f}  \label{chap9:eq:11} \equiv(-1)^{a+b+d+e} W(a b e d ; c f) .
\end{equation}
...
R_{11} & R_{12} & R_{13} & R_{14}  \label{chap9:eq:12}\\
...
R_{31}=-a+e+f, & R_{32}=-a+b+c, & R_{33}=c-d+e, & R_{34}=b-d+f . \label{chap9:eq:13}
\end{array}
\end{equation}
...
2 c=R_{22}+R_{33}=R_{23}+R_{32}, & 2 f=R_{21}+R_{34}=R_{24}+R_{31} . \label{chap9:eq:14}
\end{array}
\end{equation}
...
R_{i \alpha}-R_{i \beta} & =R_{k \alpha}-R_{k \beta}, \quad(i, k=1,2,3 ; \alpha, \beta=1,2,3,4) .
\end{align*}
Note the following relations:
\begin{gather}
\sum_{i=1}^{3} R_{i 1}=2(d+e+f)-a-b-c, \quad \sum_{i=1}^{3} R_{i 3}=2(a+c+e)-b-d-f,  \notag\\
\sum_{i=1}^{3} R_{i 2}=2(b+c+d)-a-e-f, \quad \sum_{i=1}^{3} R_{i 4}=2(a+b+f)-c-d-e,  \label{chap9:eq:15}\\
\sum_{i, \alpha} R_{i \alpha}=2(a+b+c+d+e+f) . \notag
\end{gather}
One may also use the following parametrisation of the elements $R_{i \alpha}$ [45]:
\begin{equation}
R_{i \alpha}=A_{i}-B_{\alpha} . \label{chap9:eq:16}
\end{equation}
...
& B_{4}=c+d+e, \label{chap9:eq:17}
\end{array}
\end{equation}
with
\begin{equation}
\sum_{i=1}^{3} A_{i}=\sum_{\alpha=1}^{4} B_{\alpha}=2(a+b+c+d+e+f). \label{chap9:eq:18}
\end{equation}
The inverse relations are
\begin{align}
2 a & =A_{1}+A_{2}-B_{3}-B_{4}, & 2 d & =A_{1}+A_{2}-B_{1}-B_{2},  \notag\\
2 b & =A_{1}+A_{3}-B_{2}-B_{4}, & 2 e & =A_{1}+A_{3}-B_{1}-B_{3},  \notag\\
2 c & =A_{2}+A_{3}-B_{2}-B_{3}, & 2 f & =A_{2}+A_{3}-B_{1}-B_{4} . \label{chap9:eq:19}
\end{align}
The $R$ symbols provide the simplest formulation of the symmetry properties of the $6 j$ symbols and Racah coefficients.

\section{GENERAL EXPRESSIONS FOR THE $6 j$ SYMBOLS. RELATIONS BETWEEN THE $6 j$ SYMBOLS AND OTHER FUNCTIONS}
The $6 j$ symbols $\sixj{a}{b}{c}{d}{e}{f}$ vanish if at least one of the triads $(a b c),(c d e),(a e f)$ and $(b d f)$ does not obey the triangular conditions 8.1 (1). The expressions for the $6 j$ symbols given below are valid if all these conditions are satisfied. Corresponding expressions for the Racah coefficients may be obtained by the use of the relations between these coefficients and the $6 j$ symbols \eqref{chap9:eq:11}.

\subsection{Expressions for the 6j Symbols in Terms of Finite Sums}
...
\text { (Racah [91]) } \label{chap9:eq:20}
\end{gather}
By the replacement $n \rightarrow a+b+d+e-n$ one can rewrite Eq. \eqref{chap9:eq:20} in the form
\begin{gather}
...
\times(-a+c-d+f+n)!(-b+c-e+f+n)!  \notag\\
\text { (Racah [91]) } \label{chap9:eq:21}
\end{gather}
Some other expressions for the $6 j$ symbols which cannot be easily reduced to \eqref{chap9:eq:20} and \eqref{chap9:eq:21} are [45,50].
\begin{align}
& \sixj{a}{b}{c}{d}{e}{f}=(-1)^{a+c+d+f} \frac{\Delta(a e f) \Delta(b d f)}{\Delta(a b c) \Delta(c d e)}  \notag\\
& \times \sum_{n}(-1)^{n} \frac{(-a+b+c+n)!(c-d+e+n)!(a-c+d+f-n)!}{n!(a-e+f-n)!(-b+d+f-n)!(-a+b-d+e+n)!(b+c+e-f+1+n)!},  \label{chap9:eq:22}\\
& \sixj{a}{b}{c}{d}{e}{f}=(-1)^{a+c+d+f} \frac{\Delta(a b c) \Delta(b d f)}{\Delta(a e f) \Delta(c d e)}  \notag\\
& \times \sum_{n}(-1)^{n} \frac{(a-b+d+e-n)!(-b+c+e+f-n)!(a+c+d+f+1-n)!}{n!(a-b+c-n)!(-b+d+f-n)!(a+e+f+1-n)!(c+d+e+1-n)!},  \label{chap9:eq:23}\\
...
& \times \sum_{n}(-1)^{n} \frac{(-a+e+f+n)!(b-d+f+n)!(a+c+d-f-n)!}{n!(a+e-f-n)!(b+d-f-n)!(-a+c-d+f+n)!(2 f+1+n)!},  \label{chap9:eq:24}\\
...
& \times \sum_{n}(-1)^{n} \frac{(2 b-n)!(b+c-e+f-n)!(b+c+e+f+1-n)!}{n!(-a+b+c-n)!(b-d+f-n)!(a+b+c+1-n)!(b+d+f+1-n)!} . \label{chap9:eq:25}
\end{align}
\subsection{Bargmann Formula [58]}
\begin{equation}
\sixj{a}{b}{c}{d}{e}{f}  \label{chap9:eq:26} \equiv\left\|\begin{array}{llll}
...
\end{equation}
Here $R_{i \alpha}$ are elements of the $R$ symbol (Sec. 9.1.3), $B_{\alpha}$ are given by Eq. \eqref{chap9:eq:17}, $x_{i}, y_{\alpha}$ are summation indices, $n \equiv \sum_{i=1}^{3} x_{i}+\sum_{\alpha=1}^{4} y_{\alpha}$. The sums are over all integer nonnegative values of $x_{i}, y_{\alpha}$ which satisfy the conditions $x_{i}+y_{\alpha}=R_{i \alpha}$. These conditions show that only one of the summation indices is independent. The sum in \eqref{chap9:eq:26} contains $r+1$ terms where $r=\min \left\{R_{i \alpha}\right\}$. If we take the quantity $n$ (integer nonnegative) as an independent summation index, then $x_{i}=A_{i}-n, y_{\alpha}=n-B_{\alpha}, A_{i}$ and $B_{\alpha}$ being given by Eq. \eqref{chap9:eq:17}. In this case the Bargmann formula \eqref{chap9:eq:26} reduces to the Racah formula \eqref{chap9:eq:20}.

\subsection{Relations Between the $6 j$ Symbols and the Generalized Hypergeometric Functions}
...
\end{array} \right\rvert\, 1\right], \quad(\text { Rose [30]) }  \label{chap9:eq:27}\\
...
\end{array} \right\rvert\, 1\right],  \label{chap9:eq:28}\\
...
\end{array} \right\rvert\, 1\right],  \label{chap9:eq:29}\\
...
\end{array} \right\rvert\, 1\right],  \label{chap9:eq:30}\\
...
\end{array} \right\rvert\, 1\right] . \label{chap9:eq:31}
\end{align}
Equations \eqref{chap9:eq:27}-\eqref{chap9:eq:31} present Eqs. \eqref{chap9:eq:21}-\eqref{chap9:eq:25} in terms of the hypergeometric functions.

\subsection{Relations Between the $6 j$ Symbols and the $3jm$ Symbols}
The $6 j$ symbols may be written as sums of products of the Clebsch-Gordan coefficients (Eq. \eqref{chap9:eq:8}) or $3jm$ symbols. The relations between the $6 j$ symbols and the $3 j m$ symbols are
\begin{equation}
\sixj{a}{b}{c}{d}{e}{f}  \label{chap9:eq:32}=\sum(-1)^{d+e+f+\delta+e+\varphi}\threej{a }{ b }{ c }{\alpha }{ \beta }{ \gamma}\threej{a }{ e }{ f }{\alpha }{ \varepsilon }{ -\varphi}\threej{d }{ b }{ f }{-\delta }{ \beta }{ \varphi}\threej{d }{ e }{ c }{\delta }{ -\varepsilon }{ \gamma} .
\end{equation}
In Eq. \eqref{chap9:eq:32} the sum is over all possible values of $\alpha, \beta, \gamma, \delta, \varepsilon, \varphi$ with only three summation indices being independent. Some other sums of the $3 j m$ symbols which yield the $6 j$ symbols will be considered in Chap. 12 .

\subsection{Quasi-Binomial Representation of the 6j Symbols}
...
k_{2} \equiv a-b, & D \equiv R_{34}=b-d+f, & E \equiv R_{12}+R_{21}+R_{34}+1=b+d+f+1 \label{chap9:eq:33}
\end{array}
\end{equation}
Then the dependence of the $6 j$ symbols on $k_{1}$ and $k_{2}$ is given by
\begin{gather}
\sixj{a}{b}{c}{d}{e}{f} \equiv\sixj{b+k_{2}}{b}{c}{d}{d+k_{1}}{f}  \notag\\
=(-1)^{E+k_{1}+k_{2}+1}\left[\frac{\left(c+k_{2}\right)^{\left(2 k_{2}\right)} B^{\left(k_{2}-k_{1}\right)} D^{(-1)\left(k_{2}-k_{1}\right)} E^{(-1)\left(k_{2}+k_{1}\right)} F^{(-1)\left(k_{2}+k_{1}\right)}}{\left(c+k_{1}\right)!\left(c-k_{1}\right)!\left(2 b+c+k_{2}+1\right)^{(2 c+1)}\left(2 d+c+k_{1}+1\right)^{(2 c+1)}}\right]^{\frac{1}{2}}(u-v)^{\left(c-k_{2}\right)} . \label{chap9:eq:34}
\end{gather}
...
Equations \eqref{chap9:eq:20} and \eqref{chap9:eq:21} are obtained by putting
\begin{align}
& u=\left(c+k_{1}\right)^{(1)}\left(B-k_{2}+k_{1}\right)^{(1)} D^{(1)}  \notag\\
& v=\left(c-k_{1}\right)^{(1)} F^{(1)}\left(E+k_{1}+k_{2}\right)^{(-1)} \label{chap9:eq:35}
\end{align}
Equation \eqref{chap9:eq:22} is obtained, if
\begin{align}
& u=\left(c+k_{1}\right)^{(1)} B^{(-1)}\left(D+k_{2}-k_{1}\right)^{(-1)}  \notag\\
& v=\left(c-k_{1}\right)^{(1)}\left(F+k_{2}+k_{1}\right)^{(-1)} E^{(1)} \label{chap9:eq:36}
\end{align}
or
\begin{align}
& u=\left(2 d-c+k_{1}\right)^{(-1)} D^{(1)}\left(F+k_{2}+k_{1}\right)^{(-1)}  \notag\\
& v=\left(2 d+c+k_{1}+1\right)^{(1)}\left(D+k_{2}-k_{1}\right)^{(-1)} F^{(1)} \label{chap9:eq:37}
\end{align}
Equation \eqref{chap9:eq:23} corresponds to
\begin{align}
& u=\left(2 d+c+k_{1}+1\right)^{(1)}\left(B-k_{2}+k_{1}\right)^{(1)} E^{(1)}  \notag\\
& v=\left(2 d-c+k_{1}\right)^{(-1)} B^{(-1)}\left(E+k_{2}+k_{1}\right)^{(-1)} \label{chap9:eq:38}
\end{align}
Equation \eqref{chap9:eq:24} is obtained provided
\begin{align}
& u=\left(c+k_{2}\right)^{(-1)}\left(B-k_{2}+k_{1}\right)^{(1)}\left(D+k_{2}-k_{1}\right)^{(-1)}  \notag\\
& v=\left(c-k_{1}\right)^{(1)}\left(2 b+c+k_{2}+1\right)^{(1)}\left(2 d-c+k_{1}\right)^{(-1)} \label{chap9:eq:39}
\end{align}
or
\begin{align}
& u=\left(c+k_{1}\right)^{(1)}\left(2 b-c+k_{2}\right)^{(-1)}\left(2 d-c+k_{1}\right)^{(-1)}  \label{chap9:eq:40}\\
& v=\left(c+k_{2}\right)^{(-1)} F^{(1)} E^{(1)} \notag
\end{align}
Equation \eqref{chap9:eq:25} corresponds to
\begin{align}
& u=D^{(1)} E^{(1)}\left(2 b+c+k_{2}+1\right)^{(1)}  \notag\\
& v=\left(D+k_{2}-k_{1}\right)^{(-1)}\left(E+k_{2}+k_{1}\right)^{(-1)}\left(2 b-c+k_{2}\right)^{(-1)} \label{chap9:eq:41}
\end{align}
or
\begin{align}
& u=\left(c+k_{1}\right)^{(1)}\left(2 b+c+k_{2}+1\right)^{(1)}\left(2 d+c+k_{1}+1\right)^{(1)}  \label{chap9:eq:42}\\
& v=\left(c+k_{2}\right)^{(-1)}\left(F+k_{2}+k_{1}\right)^{(-1)}\left(E+k_{2}+k_{1}\right)^{(-1)} \notag
\end{align}
Equation \eqref{chap9:eq:34} for the $6 j$ symbols is valid, if all the exponents $2 k_{2}, k_{2}-k_{1}$ and $k_{2}+k_{1}$ are integer nonnegative numbers, i.e., if $k_{2} \geq\left|k_{1}\right| \geq 0$. If some of the exponents are negative, the corresponding quasi-power should be replaced in accordance with
\begin{equation}
p^{(\sigma)} \rightarrow \frac{1}{p^{(-1)(|\sigma|)}}, \quad p^{(-1)(\sigma)} \rightarrow \frac{1}{p^{(|\sigma|)}} \quad \text { for } \sigma<0 \label{chap9:eq:43}
\end{equation}
\section{INTEGRAL REPRESENTATIONS OF THE $6 j$ SYMBOLS}
...
\begin{equation}
\sixj{a}{b}{c}{d}{e}{f}^{2}  \label{chap9:eq:44}=\frac{1}{\left(8 \pi^{2}\right)^{3}} \int d R_{1} d R_{2} d R_{3} \chi^{a}\left(R_{1}\right) \chi^{b}\left(R_{2}\right) \chi^{c}\left(R_{3}\right) \chi^{d}\left(R_{2} R_{3}^{-1}\right) \chi^{e}\left(R_{3} R_{1}^{-1}\right) \chi^{f}\left(R_{1} R_{2}^{-1}\right)
\end{equation}
Here
\[
...
\begin{align}
\MoveEqLeft{\sixj{a}{b}{c}{a}{b}{f}=\frac{(-1)^{2 c}}{\left(8 \pi^{2}\right)^{2}} \int d R_{1} d R_{2} \chi^{c}\left(R_{1}\right) \chi^{f}\left(R_{2}\right) \chi^{a}\left(R_{2} R_{1}\right) \chi^{b}\left(R_{2}^{-1} R_{1}\right),}  \label{chap9:eq:45}\\
\MoveEqLeft{\sixj{a}{b}{g}{d}{b}{c}\sixj{a}{b}{g}{d}{b}{f}\sixj{a}{b}{c}{d}{b}{f} } \notag\\
=&\frac{(-1)^{2 a}}{\left(8 \pi^{2}\right)^{4}} \int d R_{1} d R_{2} d R_{3} d R_{4} \chi^{c}\left(R_{1}\right) \chi^{g}\left(R_{2}\right) \chi^{f}\left(R_{3}\right) \chi^{a}\left(R_{4} R_{2}\right) \chi^{b}\left(R_{4} R_{3} R_{2} R_{1} R_{4}\right) \chi^{d}\left(R_{1} R_{4} R_{3}\right),  \label{chap9:eq:46}\\
...
\chi^{a}\left(R_{5}^{-1} R_{3} R_{2}\right) \chi^{b}\left(R_{6} R_{4} R_{2} R_{1}\right) \chi^{c}\left(R_{4}^{-1} R_{5} R_{1} R_{3}\right). \label{chap9:eq:47}
\end{align}
\section{SYMMETRIES OF THE $6 j$ SYMBOLS AND THE RACAH COEFFICIENTS}
\subsection{R-Symbols}
...
\begin{equation}
\left\|\begin{array}{llll}
R_{11} & R_{12} & R_{13} & R_{14}  \label{chap9:eq:48}\\
R_{21} & R_{22} & R_{23} & R_{24} \\
R_{31} & R_{32} & R_{33} & R_{34}
...
=\sixj{s_{3}-d}{s_{1}-e}{s_{2}-f}{s_{3}-a}{s_1-b}{s_2-c} , \label{chap9:eq:50}
\end{gather}
where
\begin{equation}
s_{1}=\frac{1}{2}(b+c+e+f), \quad s_{2}=\frac{1}{2}(a+c+d+f), \quad s_{3}=\frac{1}{2}(a+b+d+e) . \label{chap9:eq:51}
\end{equation}
...
=&\varepsilon_{1} W(a f c d ; e b)=\varepsilon_{1} W(d c f a ; e b)=\varepsilon_{1} W(c d a f ; e b)=\varepsilon_{1} W(f a d c ; e b)  \label{chap9:eq:52}\\
...
where
\begin{equation}
\varepsilon_{1}=(-1)^{b+e-c-f}, \quad \varepsilon_{2}=(-1)^{a+d-c-f} \label{chap9:eq:53}
\end{equation}
...
&=\varepsilon_{2} W\left(s_{3}-d, s_{1}-e, s_{1}-b, s_{3}-a ; s_{2}-f, s_{2}-c\right) \label{chap9:eq:54}
\end{align}
Here $s_{1}, s_{2}, s_{3}$ are given by Eq. \eqref{chap9:eq:51} and $\varepsilon_{1}, \varepsilon_{2}$ by Eq. \eqref{chap9:eq:53}.
...
=(-1)^{\varphi_{5}+1}\sixj{a}{b}{\bar{c}}{d}{\bar{e}}{\bar{f}} . \label{chap9:eq:55}
\end{align}
Here
\begin{gather}
\bar{a} \equiv-a-1, \quad \bar{b} \equiv-b-1, \text { etc. }  \notag\\
\varphi_{1}=b-c-e+f, \varphi_{2}=2(a+d), \varphi_{3}=c+d+e+2 f, \varphi_{4}=a+b+c, \varphi_{5}=2(c+f)+1 \label{chap9:eq:56}
\end{gather}
...
=i(-1)^{\psi_{3}} W(\bar{a} \bar{b} e d ; \bar{c} f)=i(-1)^{\psi_{3}} W(a b \bar{e} \bar{d} ; c \bar{f})=(-1)^{\psi_{4}} W(\bar{a} \bar{b} e \bar{d} ; c f)=(-1)^{\psi_{4}+1} W(a b \bar{e} d ; \bar{c} f) . \label{chap9:eq:57}
\end{gather}
Here
\begin{equation}
\psi_{1}=-b+c-e+f, \quad \psi_{2}=-c+d+e+2 f, \quad \psi_{3}=a+b-c, \quad \psi_{4}=2(d+f) \label{chap9:eq:58}
\end{equation}
\section{EXPLICIT FORMS OF THE $6 j$ SYMBOLS FOR CERTAIN ARGUMENTS}
\subsection{One of Arguments is Equal to Zero}
...
\sixj{a}{b}{0}{d}{e}{f}&=(-1)^{a+e+f} \frac{\delta_{a b} \delta_{d e}}{\sqrt{(2 a+1)(2 d+1)}}, & \sixj{a}{b}{c}{d}{e}{0}&=(-1)^{a+b+c} \frac{\delta_{a e} \delta_{b d}}{\sqrt{(2 a+1)(2 b+1)}} . \label{chap9:eq:59}
\end{alignat}
...
\subsection{One of Arguments is Equal to the Sum of Two Others}
If one of the $6 j$ symbol arguments is equal to sum of two others from the same triad (abc), (cde), (aef), (bdf), one may use the classical symmetries of the $6 j$ symbol (Eqs. \eqref{chap9:eq:49}) to express it in the form
\begin{gather}
\sixj{a}{b}{a+b}{d}{e}{f}=(-1)^{a+b+d+e} W(a b e d ; a+b f)=(-1)^{a+b+d+e}  \notag\\
\times\left[\frac{(2 a)!(2 b)!(a+b+d+e+1)!(a+b-d+e)!(a+b+d-e)!(-a+e+f)!(-b+d+f)!}{(2 a+2 b+1)!(-a-b+d+e)!(a+e-f)!(a-e+f)!(a+e+f+1)!(b+d-f)!(b-d+f)!(b+d+f+1)!}\right]^{\frac{1}{2}} \label{chap9:eq:60}
\end{gather}
In particular,
\begin{align}
&\sixj{a}{b}{a+b}{d}{e}{a+e}
=(-1)^{a+b+d+e}\left[\frac{(2 b)!(2 e)!(a+b+d-e)!(a-b+d+e)!}{(2 a+2 b+1)!(2 a+2 e+1)!(-a-b+d+e)!(-a+b+d-e)!}\right]^{\frac{1}{2}}  \label{chap9:eq:61}\\
...
&\sixj{a}{b}{a+b}{a}{e}{-1}=(-1)^{2 a+b+e} \frac{(2 a-1)!(b+e-1)!}{(2 a+2 b)!(-b+e)!}\left[\frac{2 a \cdot 2 b(b+e)(2 a+b-e)(2 a+b+e+1)}{(2 a+2 b+1)(-b+e+1)}\right]^{\frac{1}{2}}  \label{chap9:eq:62}\\
&\sixj{a}{b}{a+b}{a}{b}{f}=(-1)^{2 a+2 b} \frac{(2 a)!(2 b)!}{(a+b-f)!(a+b+f+1)!},  \label{chap9:eq:63}\\
&\sixj{a}{b}{a+b}{b}{a}{f}=(-1)^{2 a+2 b} \frac{(2 a)!(2 b)!}{[(2 a-f)!(2 a+f+1)!(2 b-f)!(2 b+f+1)!]^{\frac{1}{2}}},  \label{chap9:eq:64}\\
&\sixj{a}{b}{a+b}{a}{b}{a+b}=(-1)^{2 a+2 b} \frac{(2 a)!(2 b)!}{(2 a+2 b+1)!}, \label{chap9:eq:65}\\
...
\subsection{One of Arguments is Smaller by Unity than the Sum of Two Others}
If the $6 j$ symbol has one argument which is one less than the sum of two others from the same triad $(a b c),(c d e),(a e f),(b d f)$, one may use the classical symmetries of the $6 j$ symbol (Eqs. \eqref{chap9:eq:49}) to bring it into the form
\begin{gather}
\sixj{a}{b}{a+b-1}{d}{e}{f}=(-1)^{a+b+d+e} W(a b e d ; a+b-1 f)  \notag\\
=(-1)^{a+b+d+e} 2\{a b(a+b)+(a+b) f(f+1)-a d(d+1)-b e(e+1)\}  \notag\\
\times\left[\frac{(2 a-1)!(2 b-1)!(a+b+d+e)!(a+b-d+e-1)!(a+b+d-e-1)!(-a+e+f)!(-b+d+f)!}{(2 a+2 b)!(-a-b+d+e+1)!(a+e-f)!(a-e+f)!(a+e+f+1)!(b+d-f)!(b-d+f)!(b+d+f+1)!}\right]^{\frac{1}{2}} \label{chap9:eq:66}
\end{gather}
In particular
\begin{align}
& \sixj{a}{b}{a+b-1}{d}{e}{a+e-1}=(-1)^{a+b+d+e} 2\{a(a+b+e-1)(a+b+e)-a d(d+1)-2 b e\}  \notag\\
& \times\left[\frac{(2 b-1)!(2 e-1)!(a+b+d-e-1)!(a-b+d+e-1)!}{(2 a+2 b)!(2 a+2 e)!(-a-b+d+e+1)!(-a+b+d-e+1)!}\right]^{\frac{1}{2}},  \label{chap9:eq:67}\\
& \sixj{a}{b}{a+b-1}{a}{e}{a+b-1}=(-1)^{2 a+b+e} 2\left\{b(2 a+b-1)(2 a+b)-b e(e+1)-2 a^{2}\right\} \frac{(2 a-1)!(b+e-1)!}{(2 a+2 b)!(-b+e+1)!},  \label{chap9:eq:68}\\
& \sixj{a}{b}{a+b-1}{a}{b}{f}=(-1)^{2 a+2 b} 2\left\{a b(a+b)+(a+b) f(f+1)-a^{2}(a+1)\right.  \notag\\
& \left.-b^{2}(b+1)\right\} \frac{(2 a-1)!(2 b-1)!}{(a+b-f)!(a+b+f+1)!},  \label{chap9:eq:69}\\
& \sixj{a}{b}{a+b-1}{b}{a}{f}=(-1)^{2 a+2 b} 2\{(a+b) f(f+1)-2 a b\} \frac{(2 a-1)!(2 b-1)!}{[(2 a-f)!(2 a+f+1)!(2 b-f)!(2 b+f+1)!]^{\frac{1}{2}}} ;  \label{chap9:eq:70}\\
& \sixj{a}{b}{a+b-1}{a+b+e-1}{e}{a+e-1}=(-1)^{2(a+b+e)}\left[\frac{2 b \cdot 2 e}{(2 a+2 b)(2 a+2 b-1)(2 a+2 e)(2 a+2 e-1)}\right]^{\frac{1}{2}} . \label{chap9:eq:71}
\end{align}
Some other cases are given by Eqs. \eqref{chap9:eq:62}, \eqref{chap9:eq:64}, (11).

\subsection{Arguments $a, b, d, e$ are Equal in Pairs}
...
& =(-1)^{a+b+c+J}\left[\frac{(2 a-c)!(2 b-c)!}{(2 a+c+1)!(2 b+c+1)!}\right]^{\frac{1}{2}} V_{c}(a, f, b) \label{chap9:eq:72}
\end{align}
where $c$ is integer, and $V_{c}(a, f, b)=V_{c}(b, f, a)$. According to Eq. \eqref{chap9:eq:92}, the quantities $V_{c}$ satisfy the recursion relation
\begin{equation}
V_{c+1}=\frac{2 c+1}{c+1} V_{1} V_{c}-c(2 c+1) V_{c}-\frac{c}{c+1}\left[4 a(a+1)+1-c^{2}\right]\left[4 b(b+1)+1-c^{2}\right] V_{c-1} \label{chap9:eq:73}
\end{equation}
Let us denote
\begin{equation}
\tilde{a} \equiv a(a+1), \quad \tilde{b} \equiv b(b+1), \quad x \equiv f(f+1)-a(a+1)-b(b+1)=\tilde{f}-\tilde{a}-\tilde{b} \label{chap9:eq:74}
\end{equation}
...
\end{aligned}  \label{chap9:eq:77}\\
& V_{2 a}(a, f, b)=(-1)^{a-b+f} \frac{(2 a)!(2 a)!(2 a+2 b+1)!(-a+b+f)!}{(2 b-2 a)!(a+b-f)!(a-b+f)!(a+b+f+1)!}  \label{chap9:eq:78}\\
& \quad(a \leq b),  \notag\\
& V_{2 b}(a, f, b)=(-1)^{-a+b+f} \frac{(2 b)!(2 b)!(2 a+2 b+1)!(a-b+f)!}{(2 a-2 b)!(a+b-f)!(-a+b+f)!(a+b+f+1)!}  \label{chap9:eq:79}\\
& (b \leq a) . \label{chap9:eq:80}
\end{align}
For special values of $f$ one has
\begin{align}
& V_{c}(a, a-b, b)=\frac{(2 b)!(2 a+c+1)!}{(2 a+1)!(2 b-c)!}, \quad(a \geq b)  \label{chap9:eq:81}\\
& V_{c}(a, b-a, b)=\frac{(2 a)!(2 b+c+1)!}{(2 b+1)!(2 a-c)!}, \quad(a \leq b)  \label{chap9:eq:82}\\
& V_{c}(a, a-b+1, b)=2\{2 b(a+1)-(a-b+1) c(c+1)\} \frac{(2 b-1)!(2 a+c+1)!}{(2 a+2)!(2 b-c)!},  \label{chap9:eq:83}\\
&(a \geq b-1)  \notag\\
& V_{c}(a, b-a+1, b)=2\{2 a(b+1)+(a-b-1) c(c+1)\} \frac{(2 a-1)!(2 b+c+1)!}{(2 b+2)!(2 a-c)!},  \label{chap9:eq:84}\\
&(b \geq a-1),  \notag\\
& V_{c}(a, a+b-1, b)=(-1)^{c+1} 2\{(a+b) c(c+1)-2 a b\} \frac{(2 a-1)!(2 b-1)!}{(2 a-c)!(2 b-c)!},  \label{chap9:eq:85}\\
& V_{c}(a, a+b, b)=(-1)^{c} \frac{(2 a)!(2 b)!}{(2 a-c)!(2 b-c)!} \label{chap9:eq:86}
\end{align}
See also Eqs. (9) and \eqref{chap9:eq:70}.

\section{RECURSION RELATIONS}
\subsection{Relations in Which Arguments are Changed by $1 / 2$}
\begin{gather}
...
+[(a+b-c+1)(a-b+c)(-c+d+e+1)(c-d+e)]^{\frac{1}{2}}\sixj{a}{b}{c-1}{d}{e}{f},  \label{chap9:eq:87}\\
...
+[(-a+b+c)(c+d-e)(b+d-f)(b+d+f+1)]^{\frac{1}{2}}\sixj{a}{b-\frac{1}{2}}{c-\frac{1}{2}}{d-\frac{1}{2}}{e}{f},  \label{chap9:eq:88}\\
...
+(a-b-d+e+1)[(-a+b+c)(b-d+f)]^{\frac{1}{2}}\sixj{a+\frac{1}{2}}{b-\frac{1}{2}}{c}{d}{e}{f-\frac{1}{2}}, \label{chap9:eq:89}
\end{gather}
\begin{align}
...
& \times\sixj{a-\frac{1}{2}}{b}{c-\frac{1}{2}}{d+\frac{1}{2}}{e}{f+\frac{1}{2}} . \label{chap9:eq:90}
\end{align}
\subsection{Relations in Which Arguments are Changed by 1}
\begin{gather}
...
\times(d+e+c+1)(-d+e+c)(d-e+c)(d+e-c+1)]^{\frac{1}{2}}\sixj{a}{b}{c-1}{d}{e}{f} \label{chap9:eq:91}
\end{gather}
In particular
\begin{align}
& (2 c+1)\{-2 a(a+1)-2 b(b+1)+2 f(f+1)+c(c+1)\}\sixj{a}{a}{c}{b}{b}{f}  \notag\\
& =(c+1)[(2 a+c+2)(2 a-c)(2 b+c+2)(2 b-c)]^{\frac{1}{2}}\sixj{a}{a}{c+1}{b}{b}{f}  \notag\\
& +c[(2 a+c+1)(2 a-c+1)(2 b+c+1)(2 b-c+1)]^{\frac{1}{2}}\sixj{a}{a}{c-1}{b}{b}{f} \label{chap9:eq:92}
\end{align}
\begin{gather}
...
+(c+1)(a+b+c+1)(-a+b+c)(a-b+c)(a+b-c+1)\sixj{a}{b}{c-1}{a}{b}{f} \label{chap9:eq:93}
\end{gather}
...
\begin{equation}
f\left(r_{i \alpha}\right) \equiv\left[1+\sum_{i=1}^{3} \prod_{\alpha=1}^{4} r_{i \alpha}+\sum_{\alpha=1}^{4} \prod_{i=1}^{3} r_{i \alpha}\right]^{-2}=\sum_{R_{i \alpha}} N\left(R_{i \alpha}\right)\sixj{a}{b}{c}{d}{e}{f}  \label{chap9:eq:94} \prod_{i=1}^{3} \prod_{\alpha=1}^{4}\left(r_{i \alpha}\right)^{R_{i \alpha}}
\end{equation}
The exponents $R_{i \alpha}$ are elements of the $R$ symbol. The relation between $R_{i \alpha}$ and arguments $a, b, c$, etc. is given by Eqs. \eqref{chap9:eq:13}-\eqref{chap9:eq:14}. The normalization factors $N$ are
\begin{equation}
N\left(R_{i \alpha}\right)=\left[\frac{\prod_{\alpha=1}^{4}\left(B_{\alpha}+1\right)!}{\prod_{i=1}^{3} \prod_{\alpha=1}^{4}\left(R_{i \alpha}\right)!}\right]^{\frac{1}{2}}, \label{chap9:eq:95}
\end{equation}
where $B_{\alpha}$ are given by Eqs. \eqref{chap9:eq:17}.

\section{SUMS INVOLVING THE $6 j$ SYMBOLS}
...
\begin{align}
& \sum_{X}(2 X+1)\sixj{a}{b}{X}{a}{b}{c}=(-1)^{2 c}\{a b c\},  \label{chap9:eq:96}\\
& \sum_{X}(-1)^{a+b+X}(2 X+1)\sixj{a}{b}{X}{b}{a}{c}=\delta_{c 0} \sqrt{(2 a+1)(2 b+1)},  \label{chap9:eq:97}\\
& \sum_{X}(2 X+1)\sixj{a}{b}{X}{c}{d}{p}\sixj{a}{b}{X}{c}{d}{q}=\delta_{p q} \frac{\{a d p\}\{b c p\}}{2 p+1},  \label{chap9:eq:98}\\
& \sum_{X}(-1)^{p+q+X}(2 X+1)\sixj{a}{b}{X}{c}{d}{p}\sixj{a}{b}{X}{d}{c}{q}=\sixj{a}{c}{q}{b}{d}{p},  \label{chap9:eq:99}\\
& \sum_{X}(-1)^{2 X}(2 X+1)\sixj{a}{b}{X}{c}{d}{p}\sixj{c}{d}{X}{e}{f}{q}\sixj{e}{f}{X}{a}{b}{r}=\ninej{a}{f}{r}{d}{q}{e}{p}{c}{b},  \label{chap9:eq:100}\\
& \sum_{X}(-1)^{R+X}(2 X+1)\sixj{a}{b}{X}{c}{d}{p}\sixj{c}{d}{X}{e}{f}{q}\sixj{e}{f}{X}{b}{a}{r}=\sixj{p}{q}{r}{e}{a}{d}\sixj{p}{q}{r}{f}{b}{c},  \label{chap9:eq:101}\\
& (R=a+b+c+d+e+f+p+q+r)  \notag\\
& \sum_{X}(2 X+1)\sixj{a}{b}{X}{c}{d}{p}\sixj{c}{d}{X}{e}{f}{q}\sixj{e}{f}{X}{g}{h}{r}\sixj{g}{h}{X}{a}{b}{s}=(-1)^{p-s-q+r}\twelvejII{h,a,s,c,p,b,f,r,g,q,e,d},  \label{chap9:eq:102}\\
& \sum_{X}(-1)^{T-X}(2 X+1)\sixj{a}{b}{X}{c}{d}{p}\sixj{c}{d}{X}{e}{f}{q}\sixj{e}{f}{X}{g}{h}{r}\sixj{g}{h}{X}{b}{a}{s}=\twelvejI{a,d,e,h,p,q,r,s,b,c,f,g},  \notag\\
& (T=a+b+c+d+e+f+g+h+p+q+r+s) . \label{chap9:eq:103}
\end{align}
Many other sums, involving the $6 j$ symbols as well as the $3 j m$ symbols and the $9 j$ symbols, will be given in Chap. 12.

\section{ASYMPTOTICS OF THE $6 j$ SYMBOLS FOR LARGE ANGULAR MOMENTA}
\subsection{Asymptotic Relations Between the 6j Symbols and the Clebsch-Gordan Coefficients}
If $R \gg 1$ and $a, b, c$ etc. are arbitrary, one gets the following asymptotic relation
\begin{equation}
\sixj{a}{b}{c}{d+R}{e+R}{f+R}  \label{chap9:eq:104} \approx \frac{(-1)^{a+b+d+e}}{\sqrt{2 R(2 c+1)}} \clebsch{a}{\alpha}{b}{\beta}{c}{\gamma}
\end{equation}
where $\alpha=f-e, \beta=d-f, \gamma=d-e$.\\
For the $6 j$ symbols and the $3 j m$ symbols this relation assumes the form [47]
\begin{equation}
\sixj{a}{b}{c}{d+R}{e+R}{f+r}  \label{chap9:eq:105} \approx \frac{(-1)^{a+b+c+2(d+e+f)}}{\sqrt{2 R}}\threej{a }{ b }{ c }{e-f }{ f-d }{ d-e} .
\end{equation}
...
a+e-f & b-d+f & c+d-e \\
a-e+f & b+d-f & c-d+e
\end{array}\right\| . \label{chap9:eq:106}
\end{align}
In particular, when $d=e=f=0$ one obtains [60]
\begin{equation}
\sixj{a}{b}{c}{R}{R}{R}  \label{chap9:eq:107} \approx \frac{(-1)^{c}}{\sqrt{2 R(2 c+1)}} C_{a 060}^{c 0}
\end{equation}
\subsection{Asymptotic Expressions for the $6 j$ Symbols}
...
\begin{figure}[tbh!]
\begin{center}
  \includegraphics[alt={},max width=0.5\textwidth]{402d9a1b-ee97-49cb-ae14-75458391be12-319_450_551_1897_737}
...
\begin{equation}
\sixj{a}{b}{c}{d}{e}{f}  \label{chap9:eq:108} \approx \frac{1}{\sqrt{12 \pi V}} \cos \left(\sum_{i, k=1}^{4} j_{i k} \Theta_{i k}+\frac{\pi}{4}\right), \quad\left(V^{2}>0\right)
\end{equation}
Here
\begin{gather}
j_{12}=a+\frac{1}{2}, \quad j_{13}=b+\frac{1}{2}, \quad j_{14}=c+\frac{1}{2},  \notag\\
j_{23}=f+\frac{1}{2}, \quad j_{24}=e+\frac{1}{2}, \quad j_{34}=d+\frac{1}{2},  \label{chap9:eq:109}\\
...
0 & j_{34}^{2} & j_{24}^{2} & j_{23}^{2} & 1  \label{chap9:eq:110}\\
...
0 & j_{12}^{2} & j_{13}^{2} & 1  \label{chap9:eq:112}\\
j_{12}^{2} & 0 & j_{14}^{2} & 1 \\
j_{13}^{2} & j_{14}^{2} & 0 & 1 \\
1 & 1 & 1 & 0
\end{array}\right| .
\end{equation}
The asymptotic expressions \eqref{chap9:eq:108} are valid only if $V^{2}>0$ (classically allowed domain). If $V^{2}<0$ (classically forbidden domain, when an associated tetrahedron does not exist), the asymptotic expression becomes
\begin{equation}
\sixj{a}{b}{c}{d}{e}{f}  \label{chap9:eq:113} \approx \frac{1}{2 \sqrt{12 \pi|V|}} \cos \Phi \exp \left\{-\left|\sum_{i, k=1}^{4} j_{i k} \operatorname{Im} \Theta_{i k}\right|\right\}, \quad\left(V^{2}<0\right)
\end{equation}
where
\begin{equation}
\Phi=\sum_{i, k=1}^{4}\left(j_{i k}-\frac{1}{2}\right) \operatorname{Re} \Theta_{i k} \label{chap9:eq:114}
\end{equation}
In this case the $6 j$ symbols are exponentially small even if the triangular condition is satisfied.\\
Near the classical domain boundary, where $V^{2} \approx 0$, Eqs. \eqref{chap9:eq:108}, \eqref{chap9:eq:113} are of little use, although one may use the improved expressions [89]
\begin{equation}
\sixj{a}{b}{c}{d}{e}{f}  \label{chap9:eq:115} \approx 2^{-\frac{4}{3}}\left(\prod_{i=1}^{4} S_{i}\right)^{-\frac{1}{6}}\{\cos \Phi \mathrm{Ai}(z)+\sin \Phi \mathrm{Bi}(z)\}
\end{equation}
$\mathrm{Ai}(z)$ and $\mathrm{Bi}(z)$ being the Airy functions [27],
\begin{equation}
z= \begin{cases}-(3 V)^{2}\left(4 \prod_{i=1}^{4} S_{i}\right)^{-\frac{2}{3}} & \text { if } V^{2}>0,  \label{chap9:eq:116}\\ (3|V|)^{2}\left(4 \prod_{i=1}^{4} S_{i}\right)^{-\frac{2}{3}} & \text { if } V^{2}<0 .\end{cases}
\end{equation}
Note that the Ponzano-Regge approximation is sufficiently accurate even at comparatively small angular momenta $a, b, c$ etc. Asymptotic expressions similar to \eqref{chap9:eq:115} but extended over the entire domain of angular momenta are obtained in Ref. [140].\\[0pt]
\subsubsection{The Edmonds' Formula [16]}
If $f, m, n$ are arbitrary integers or half-integers and $a, b, c \gg f, m, n$, then
\begin{equation}
\sixj{a}{b}{c}{b+m}{a+n}{f}  \label{chap9:eq:117} \approx \frac{(-1)^{a+b+c+f+m}}{\sqrt{(2 a+1)(2 b+1)}} d_{m n}^{f}(\theta),
\end{equation}
...
\begin{equation}
\cos \theta=\frac{a(a+1)+b(b+1)-c(c+1)}{2 \sqrt{a(a+1) b(b+1)}} . \label{chap9:eq:118}
\end{equation}
\begin{figure}[tbh!]
\begin{center}
  \includegraphics[alt={},max width=0.5\textwidth]{402d9a1b-ee97-49cb-ae14-75458391be12-321_325_518_1161_770}
\caption{The angle $\Theta$ which enters Eq. 9.9(14).}
\label{chap9:fig:2}
\end{center}
\end{figure}

In particular, if $m=n=0, a, b, c \gg f$ and $f$ is an arbitrary integer, then \eqref{chap9:eq:117} turns into the Racah formula [93],
\begin{equation}
\sixj{a}{b}{c}{b}{a}{f}  \label{chap9:eq:119} \approx \frac{(-1)^{a+b+c+f}}{\sqrt{(2 a+1)(2 b+1)}} P_{f}(\cos \theta),
\end{equation}
where $P_{f}$ is the Legendre polynomial. If, in addition, $f$ is large ( $a, b, c \gg f \gg 1$ ), one can substitute into \eqref{chap9:eq:119} asymptotic expressions for the Legendre polynomials to obtain
\begin{equation}
\sixj{a}{b}{c}{b}{a}{f}  \label{chap9:eq:120} \approx(-1)^{a+b+c+s}\left[\frac{4}{\pi(2 a+1)(2 b+1)(2 f+1) \sin \theta}\right]^{\frac{1}{3}} \cos \left[\left(f+\frac{1}{2}\right) \theta-\frac{\pi}{4}\right] .
\end{equation}
This expression may also be written in the form (cf. Eq. \eqref{chap9:eq:108})
\begin{equation}
\sixj{a}{b}{c}{b}{a}{f}  \label{chap9:eq:121} \approx \frac{(-1)^{a+b+c+f}}{\sqrt{12 \pi V}} \cos \left[\left(f+\frac{1}{2}\right) \Theta-\frac{\pi}{4}\right],
\end{equation}
where the tetrahedron volume is given by
\begin{equation}
V=\frac{1}{6}\left(a+\frac{1}{2}\right)\left(b+\frac{1}{2}\right)\left(f+\frac{1}{2}\right) \sin \Theta . \label{chap9:eq:122}
\end{equation}
\subsubsection{$a, b, c, d, e, f \gg 1, m, n, p$}In this case,  one has
\begin{equation}
\sixj{a}{b}{c}{d}{e}{f}  \label{chap9:eq:123}\sixj{a}{b}{c}{d+m}{e+n}{f+p} \approx \frac{\Theta\left(V^{2}\right)}{24 \pi V} \cos \left(m \Theta_{1}+n \Theta_{2}+p \Theta_{3}\right) .
\end{equation}
where $V$ is the tetrahedron volume \eqref{chap9:eq:110}
\begin{equation}
\Theta\left(V^{2}\right)= \begin{cases}1, & \text { if } V^{2}>0,  \label{chap9:eq:124}\\ 0, & \text { if } V^{2}<0,\end{cases}
\end{equation}
...
\begin{equation}
\cos \theta_{i}=\frac{\cos \varphi_{i k} \cos \varphi_{i l}-\cos \varphi_{k l}}{\sin \varphi_{i k} \sin \varphi_{i l}} \label{chap9:eq:125}
\end{equation}
where combinations $i, k, l$ are obtained by cyclic permutations of $1,2,3$.

\begin{figure}[tbh!]
\begin{center}
  \includegraphics[alt={},max width=0.5\textwidth]{402d9a1b-ee97-49cb-ae14-75458391be12-322_528_823_968_618}
\caption{Geometrical interpretation of the angles in Eqs. 9.9(20)-9.9(23).}
\label{chap9:fig:3}
\end{center}
\end{figure}

In Eq. \eqref{chap9:eq:125} $\varphi_{i k} \equiv \varphi_{k i}$ is the angle between the edges $l_{i}+\frac{1}{2}$ and $l_{k}+\frac{1}{2}$ of the tetrahedron (Fig.~\ref{chap9:fig:3})
\begin{equation}
\cos \varphi_{i k}=\frac{l_{i}\left(l_{i}+1\right)+l_{k}\left(l_{k}+1\right)-j(j+1)}{2 \sqrt{l_{i}\left(l_{i}+1\right) l_{k}\left(l_{k}+1\right)}} \label{chap9:eq:126}
\end{equation}
with $i \neq k \neq l$ and $j_{1} \equiv a, j_{2} \equiv b, j_{3} \equiv c$.\\
\subsubsection{$m=n=p=0$}In particular, for $m=n=p=0$ Eq. \protect\eqref{chap9:eq:123} yields the Wigner formula [43]
\begin{equation}
\sixj{a}{b}{c}{d}{e}{f}^{2}  \label{chap9:eq:127} \approx \frac{\Theta\left(V^{2}\right)}{24 \pi V}, \quad(a, b, c, d, e, f \gg 1)
\end{equation}
...
& \times \frac{(2 R)^{-1-|b+e-c-f|}}{|b+e-c-f|!}\left[1+0\left(\frac{1}{R^{2}}\right)\right] . \label{chap9:eq:128}
\end{align}
In this case
\begin{gather}
\varphi=a+d+\min \{b+c, c+f\},  \notag\\
\operatorname{sign} x= \begin{cases}1, & \text { if } x \geq 0 \\
-1, & \text { if } x<0\end{cases} \label{chap9:eq:129}
\end{gather}
\section{RELATIONS BETWEEN THE WIGNER $6 j$ SYMBOLS AND ANALOGOUS FUNCTIONS OF OTHER AUTHORS}
Racah [91]:
\[
...
\]
\section{TABLES OF ALGEBRAIC EXPRESSIONS FOR THE $6 j$ SYMBOLS}
