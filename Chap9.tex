...
\begin{equation}
\sixj{a}{b}{c}{R}{R}{R}  \label{eq:9:9:4} \approx \frac{(-1)^{c}}{\sqrt{2 R(2 c+1)}} C_{a 060}^{c 0}
\end{equation}
...
\begin{equation}
\sixj{a}{b}{c}{b}{a}{f}  \label{eq:9:9:17} \approx(-1)^{a+b+c+s}\left[\frac{4}{\pi(2 a+1)(2 b+1)(2 f+1) \sin \theta}\right]^{\frac{1}{3}} \cos \left[\left(f+\frac{1}{2}\right) \theta-\frac{\pi}{4}\right] .
\end{equation}
...
\begin{equation}
\cos \theta_{i}=\frac{\cos \varphi_{i k} \cos \varphi_{i l}-\cos \varphi_{k l}}{\sin \varphi_{i k} \sin \varphi_{i l}} \label{eq:9:9:22}
\end{equation}
...
\begin{equation}
\cos \varphi_{i k}=\frac{l_{i}\left(l_{i}+1\right)+l_{k}\left(l_{k}+1\right)-j(j+1)}{2 \sqrt{l_{i}\left(l_{i}+1\right) l_{k}\left(l_{k}+1\right)}} \label{eq:9:9:23}
\end{equation}
...
& \times \frac{(2 R)^{-1-|b+e-c-f|}}{|b+e-c-f|!}\left[1+0\left(\frac{1}{R^{2}}\right)\right] . \label{eq:9:9:25}
\end{align}
In this case
\begin{gather}
