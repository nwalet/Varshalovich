...
j_{1} & j_{2} & j_{12} \\
j_{3} & j & j_{23}
\end{array}\right\} . \label{chap9:eq:5}
\end{align}
...
j_{2} & j_{1} & j_{12} \\
j_{3} & j & j_{13}
\end{array}\right\}  \label{chap9:eq:6}\\
...
j_{1} & j_{3} & j_{13} \\
j_{2} & j & j_{23}
\end{array}\right\} . \label{chap9:eq:7}
\end{gather}
...
j_{1} & j_{2} & j_{12} \\
j_{3} & j & j_{23}
\end{array}\right\} . \label{chap9:eq:8}
\end{gather}
...
j_{1} & j_{2} & j_{12} \\
j_{3} & j & j_{23}^{\prime}
\end{array}\right\}=\delta_{j_{23} j_{23}^{\prime}}  \label{chap9:eq:9}\\
...
j_{3} & j & j_{23}
\end{array}\right\}=\delta_{j_{12} j_{23}^{\prime}} \label{chap9:eq:10}
\end{align}
...
a & b & c \\
a & b & f
\end{array}\right\}=\frac{(-1)^{2 c}}{\left(8 \pi^{2}\right)^{2}} \int d R_{1} d R_{2} \chi^{c}\left(R_{1}\right) \chi^{f}\left(R_{2}\right) \chi^{a}\left(R_{2} R_{1}\right) \chi^{b}\left(R_{2}^{-1} R_{1}\right),  \label{chap9:eq:45}\\
\left\{\begin{array}{lll}
a & b & g \\
d & b & c
\end{array}\right\}\left\{\begin{array}{lll}
...
c & e & d \\
f & b & a
\end{array}\right\}  \label{chap9:eq:49}\\
& =\left\{\begin{array}{lll}
d & b & f \\
a & e & c
\end{array}\right\}=\left\{\begin{array}{lll}
...
s_{1}-b s_{2}-c
\end{array}\right\}, \label{chap9:eq:50}
\end{gather}
where
\begin{equation}
...
a & b & \bar{c} \\
d & \bar{e} & \bar{f}
\end{array}\right\} . \label{chap9:eq:55}
\end{align}
Here
\begin{gather}
...
a & b & c \\
d & e & 0
\end{array}\right\}=(-1)^{a+b+c} \frac{\delta_{a e} \delta_{b d}}{\sqrt{(2 a+1)(2 b+1)}} . \label{chap9:eq:59}
\end{array}
\end{equation}
...
a & b & a+b \\
d & e & a+e
\end{array}\right\}=(-1)^{a+b+d+e}\left[\frac{(2 b)!(2 e)!(a+b+d-e)!(a-b+d+e)!}{(2 a+2 b+1)!(2 a+2 e+1)!(-a-b+d+e)!(-a+b+d-e)!}\right]^{\frac{1}{2}}  \label{chap9:eq:61}\\
...
a & e \\
a+b-1
\end{array}\right\}=(-1)^{2 a+b+e} \frac{(2 a-1)!(b+e-1)!}{(2 a+2 b)!(-b+e)!}\left[\frac{2 a \cdot 2 b(b+e)(2 a+b-e)(2 a+b+e+1)}{(2 a+2 b+1)(-b+e+1)}\right]^{\frac{1}{2}}  \label{chap9:eq:62}\\
&\left\{\begin{array}{lll}
a & b & a+b \\
a & b & f
\end{array}\right\}=(-1)^{2 a+2 b} \frac{(2 a)!(2 b)!}{(a+b-f)!(a+b+f+1)!},  \label{chap9:eq:63}\\
&\left\{\begin{array}{lll}
a & b & a+b \\
b & a & f
\end{array}\right\}=(-1)^{2 a+2 b} \frac{(2 a)!(2 b)!}{[(2 a-f)!(2 a+f+1)!(2 b-f)!(2 b+f+1)!]^{\frac{1}{2}}},  \label{chap9:eq:64}\\
&\left\{\begin{array}{lll}
a & b & a+b \\
a & b & a+b
\end{array}\right\}=(-1)^{2 a+2 b} \frac{(2 a)!(2 b)!}{(2 a+2 b+1)!}, \label{chap9:eq:65}
\end{align}
\[
\left.\begin{array}{l}
\left\{\begin{array}{ll}
...
a & b & a+b-1 \\
a & e & a+b-1
\end{array}\right\}=(-1)^{2 a+b+e} 2\left\{b(2 a+b-1)(2 a+b)-b e(e+1)-2 a^{2}\right\} \frac{(2 a-1)!(b+e-1)!}{(2 a+2 b)!(-b+e+1)!},  \label{chap9:eq:68}\\
& \left\{\begin{array}{ccc}
a & b & a+b-1 \\
a & b & f
...
a & b & a+b-1 \\
b & a & f
\end{array}\right\}=(-1)^{2 a+2 b} 2\{(a+b) f(f+1)-2 a b\} \frac{(2 a-1)!(2 b-1)!}{[(2 a-f)!(2 a+f+1)!(2 b-f)!(2 b+f+1)!]^{\frac{1}{2}}} ;  \label{chap9:eq:70}\\
& \left\{\begin{array}{ccc}
a & b & a+b-1 \\
a+b+e-1 & e & a+e-1
\end{array}\right\}=(-1)^{2(a+b+e)}\left[\frac{2 b \cdot 2 e}{(2 a+2 b)(2 a+2 b-1)(2 a+2 e)(2 a+2 e-1)}\right]^{\frac{1}{2}} . \label{chap9:eq:71}
\end{align}
...
a & b & c-1 \\
d & e & f
\end{array}\right\},  \label{chap9:eq:87}\\
...
a & b-\frac{1}{2} \\
d-\frac{1}{2} & e
\end{array}\right\},  \label{chap9:eq:88}\\
...
a+\frac{1}{2} & b-\frac{1}{2} \\
c & f-\frac{1}{2}
\end{array}\right\}, \label{chap9:eq:89}
\end{gather}
\begin{align}
...
a-\frac{1}{2} & b & c-\frac{1}{2} \\
d+\frac{1}{2} & e & f+\frac{1}{2}
\end{array}\right\} . \label{chap9:eq:90}
\end{align}
...
a & b & c-1 \\
d & e & f
\end{array}\right\} \label{chap9:eq:91}
\end{gather}
In particular
\begin{align}
...
a & a & c-1 \\
b & b & f
\end{array}\right\} \label{chap9:eq:92}
\end{align}
\begin{gather}
...
a & b & c-1 \\
a & b & f
\end{array}\right\} \label{chap9:eq:93}
\end{gather}
...
a & b & X \\
a & b & c
\end{array}\right\}=(-1)^{2 c}\{a b c\},  \label{chap9:eq:96}\\
& \sum_{X}(-1)^{a+b+X}(2 X+1)\left\{\begin{array}{lll}
a & b & X \\
b & a & c
\end{array}\right\}=\delta_{c 0} \sqrt{(2 a+1)(2 b+1)},  \label{chap9:eq:97}\\
& \sum_{X}(2 X+1)\left\{\begin{array}{lll}
a & b & X \\
c & d & p
\end{array}\right\}\left\{\begin{array}{lll}
a & b & X \\
c & d & q
\end{array}\right\}=\delta_{p q} \frac{\{a d p\}\{b c p\}}{2 p+1},  \label{chap9:eq:98}\\
...
a & c & q \\
b & d & p
\end{array}\right\},  \label{chap9:eq:99}\\
...
d & q & e \\
p & c & b
\end{array}\right\},  \label{chap9:eq:100}\\
...
p & q & r \\
f & b & c
\end{array}\right\},  \label{chap9:eq:101}\\
& (R=a+b+c+d+e+f+p+q+r)  \notag\\
& \sum_{X}(2 X+1)\left\{\begin{array}{lll}
a & b & X \\
c & d & p
...
f & r & - & g \\
q & e & d & -
\end{array}\right\},  \label{chap9:eq:102}\\
...
\begin{equation}
\left\{\begin{array}{ccc}
a & b & c  \label{chap9:eq:104}\\
d+R & e+R & f+R
\end{array}\right\} \approx \frac{(-1)^{a+b+d+e}}{\sqrt{2 R(2 c+1)}} \clebsch{a}{\alpha}{b}{\beta}{c}{\gamma}
\end{equation}
where $\alpha=f-e, \beta=d-f, \gamma=d-e$.\\
For the $6 j$ symbols and the $3 j m$ symbols this relation assumes the form [47]
\begin{equation}
\left\{\begin{array}{ccc}
a & b & c  \label{chap9:eq:105}\\
d+R & e+R & f+r
...
\begin{equation}
\left\{\begin{array}{lll}
a & b & c  \label{chap9:eq:107}\\
R & R & R
\end{array}\right\} \approx \frac{(-1)^{c}}{\sqrt{2 R(2 c+1)}} C_{a 060}^{c 0}
\end{equation}
\subsection{Asymptotic Expressions for the $6 j$ Symbols}
The asymptotic behaviour of the $6 j$ symbols $\left\{\begin{array}{lll}a & b & c \\ d & e & f\end{array}\right\}$ for large angular momenta is closely associated with geometric properties of the tetrahedron whose edges are $a+\frac{1}{2}, b+\frac{1}{2}$, etc. (Fig.~\ref{chap9:fig:1}).
